...
return cc.join("");
},refreshRow1:function(_505,_506){
...
},refreshRow:function(_50b,_50c){
var rows=$(_50b).datagrid("getRows");
this.updateRow.call(this,_50b,_50c,rows[_50c]);
},updateRow:function(_50d,_50e,row){
var opts=$.data(_50d,"datagrid").options;
var _50f=$(_50d).datagrid("getPanel");
var rows=$(_50d).datagrid("getRows");
var tr=_50f.find("div.datagrid-body tr[datagrid-row-index="+_50e+"]");
for(var _510 in row){
rows[_50e][_510]=row[_510];
var td=tr.children("td[field="+_510+"]");
var cell=td.find("div.datagrid-cell");
var col=$(_50d).datagrid("getColumnOption",_510);
if(col){
var _511=col.styler?col.styler(rows[_50e][_510],rows[_50e],_50e):"";
td.attr("style",_511||"");
if(col.hidden){
td.hide();
}
if(col.formatter){
cell.html(col.formatter(rows[_50e][_510],rows[_50e],_50e));
}else{
cell.html(rows[_50e][_510]);
}
}
}
var _511=opts.rowStyler?opts.rowStyler.call(_50d,_50e,rows[_50e]):"";
tr.attr("style",_511||"");
$(_50d).datagrid("fixRowHeight",_50e);
},insertRow:function(_512,_513,row){
...
if(_513==undefined||_513==null){
_513=data.rows.length;
}
if(_513>data.rows.length){
_513=data.rows.length;
}
for(var i=data.rows.length-1;i>=_513;i--){
...
var _516=$(_512).datagrid("getColumnFields",true);
var _517=$(_512).datagrid("getColumnFields",false);
var tr1="<tr datagrid-row-index=\""+_513+"\">"+this.renderRow.call(this,_512,_516,true,_513,row)+"</tr>";
var tr2="<tr datagrid-row-index=\""+_513+"\">"+this.renderRow.call(this,_512,_517,false,_513,row)+"</tr>";
if(_513>=data.rows.length){
var _518=_514.children("div.datagrid-body").children("div.datagrid-body-inner");
var _519=_515.children("div.datagrid-body");
if(data.rows.length){
_518.find("tr:last[datagrid-row-index]").after(tr1);
_519.find("tr:last[datagrid-row-index]").after(tr2);
}else{
_518.html("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"+tr1+"</tbody></table>");
_519.html("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"+tr2+"</tbody></table>");
}
}else{
_514.children("div.datagrid-body").find("tr[datagrid-row-index="+(_513+1)+"]").before(tr1);
_515.children("div.datagrid-body").find("tr[datagrid-row-index="+(_513+1)+"]").before(tr2);
}
data.total+=1;
data.rows.splice(_513,0,row);
this.refreshRow.call(this,_512,_513);
},deleteRow:function(_51a,_51b){
var opts=$.data(_51a,"datagrid").options;
var data=$.data(_51a,"datagrid").data;
var view=$(_51a).datagrid("getPanel").children("div.datagrid-view");
var _51c=view.children("div.datagrid-view1");
var _51d=view.children("div.datagrid-view2");
_51c.children("div.datagrid-body").find("tr[datagrid-row-index="+_51b+"]").remove();
_51d.children("div.datagrid-body").find("tr[datagrid-row-index="+_51b+"]").remove();
for(var i=_51b+1;i<data.rows.length;i++){
_51d.children("div.datagrid-body").find("tr[datagrid-row-index="+i+"]").attr("datagrid-row-index",i-1);
var tr=_51c.children("div.datagrid-body").find("tr[datagrid-row-index="+i+"]").attr("datagrid-row-index",i-1);
if(opts.rownumbers){
tr.find("div.datagrid-cell-rownumber").html(i);
}
}
data.total-=1;
data.rows.splice(_51b,1);
},onBeforeRender:function(_51e,rows){
},onAfterRender:function(_51f){
var opts=$.data(_51f,"datagrid").options;
if(opts.showFooter){
var _520=$(_51f).datagrid("getPanel").find("div.datagrid-footer");
_520.find("div.datagrid-cell-rownumber,div.datagrid-cell-check").css("visibility","hidden");
}
}};
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{frozenColumns:null,columns:null,fitColumns:false,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,loadMsg:"Processing, please wait ...",rownumbers:false,singleSelect:false,pagination:false,pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowStyler:function(_521,_522){
...
},editors:_485,editConfig:{getTr:function(_523,_524){
return $(_523).datagrid("getPanel").find("div.datagrid-body tr[datagrid-row-index="+_524+"]");
},getRow:function(_525,_526){
return $.data(_525,"datagrid").data.rows[_526];
}},view:_4ef,onBeforeLoad:function(_527){
},onLoadSuccess:function(){
},onLoadError:function(){
},onClickRow:function(_528,_529){
},onDblClickRow:function(_52a,_52b){
},onClickCell:function(_52c,_52d,_52e){
},onDblClickCell:function(_52f,_530,_531){
},onSortColumn:function(sort,_532){
},onResizeColumn:function(_533,_534){
},onSelect:function(_535,_536){
},onUnselect:function(_537,_538){
},onSelectAll:function(rows){
},onUnselectAll:function(rows){
},onBeforeEdit:function(_539,_53a){
},onAfterEdit:function(_53b,_53c,_53d){
},onCancelEdit:function(_53e,_53f){
},onHeaderContextMenu:function(e,_540){
},onRowContextMenu:function(e,_541,_542){
}});
})(jQuery);
(function($){
function _543(_544){
var opts=$.data(_544,"propertygrid").options;
$(_544).datagrid($.extend({},opts,{view:(opts.showGroup?_545:undefined),onClickRow:function(_546,row){
if(opts.editIndex!=_546){
var col=$(this).datagrid("getColumnOption","value");
col.editor=row.editor;
_547(opts.editIndex);
$(this).datagrid("beginEdit",_546);
$(this).datagrid("getEditors",_546)[0].target.focus();
opts.editIndex=_546;
}
opts.onClickRow.call(_544,_546,row);
}}));
$(_544).datagrid("getPanel").panel("panel").addClass("propertygrid");
$(_544).datagrid("getPanel").find("div.datagrid-body").unbind(".propertygrid").bind("mousedown.propertygrid",function(e){
e.stopPropagation();
});
...
var t=$(_544);
if(t.datagrid("validateRow",_548)){
t.datagrid("endEdit",_548);
}else{
t.datagrid("cancelEdit",_548);
}
};
};
$.fn.propertygrid=function(_549,_54a){
if(typeof _549=="string"){
var _54b=$.fn.propertygrid.methods[_549];
if(_54b){
return _54b(this,_54a);
}else{
return this.datagrid(_549,_54a);
}
}
_549=_549||{};
return this.each(function(){
var _54c=$.data(this,"propertygrid");
if(_54c){
$.extend(_54c.options,_549);
}else{
$.data(this,"propertygrid",{options:$.extend({},$.fn.propertygrid.defaults,$.fn.propertygrid.parseOptions(this),_549)});
}
_543(this);
});
};
$.fn.propertygrid.methods={};
$.fn.propertygrid.parseOptions=function(_54d){
var t=$(_54d);
return $.extend({},$.fn.datagrid.parseOptions(_54d),{showGroup:(t.attr("showGroup")?t.attr("showGroup")=="true":undefined)});
};
var _545=$.extend({},$.fn.datagrid.defaults.view,{render:function(_54e,_54f,_550){
var opts=$.data(_54e,"datagrid").options;
var rows=$.data(_54e,"datagrid").data.rows;
var _551=$(_54e).datagrid("getColumnFields",_550);
var _552=[];
var _553=0;
var _554=this.groups;
for(var i=0;i<_554.length;i++){
var _555=_554[i];
_552.push("<div class=\"datagrid-group\" group-index="+i+">");
_552.push("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" style=\"height:100%\"><tbody>");
_552.push("<tr>");
_552.push("<td style=\"border:0;\">");
if(!_550){
_552.push("<span>");
_552.push(opts.groupFormatter.call(_54e,_555.fvalue,_555.rows));
_552.push("</span>");
}
_552.push("</td>");
_552.push("</tr>");
_552.push("</tbody></table>");
_552.push("</div>");
_552.push("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>");
for(var j=0;j<_555.rows.length;j++){
var cls=(_553%2&&opts.striped)?"class=\"datagrid-row-alt\"":"";
var _556=opts.rowStyler?opts.rowStyler.call(_54e,_553,_555.rows[j]):"";
var _557=_556?"style=\""+_556+"\"":"";
_552.push("<tr datagrid-row-index=\""+_553+"\" "+cls+" "+_557+">");
_552.push(this.renderRow.call(this,_54e,_551,_550,_553,_555.rows[j]));
_552.push("</tr>");
_553++;
}
_552.push("</tbody></table>");
...
$(_54f).html(_552.join(""));
},onAfterRender:function(_558){
var opts=$.data(_558,"datagrid").options;
var view=$(_558).datagrid("getPanel").find("div.datagrid-view");
var _559=view.children("div.datagrid-view1");
var _55a=view.children("div.datagrid-view2");
$.fn.datagrid.defaults.view.onAfterRender.call(this,_558);
if(opts.rownumbers||opts.frozenColumns.length){
var _55b=_559.find("div.datagrid-group");
}else{
var _55b=_55a.find("div.datagrid-group");
}
$("<td style=\"border:0\"><div class=\"datagrid-row-expander datagrid-row-collapse\" style=\"width:25px;height:16px;cursor:pointer\"></div></td>").insertBefore(_55b.find("td"));
view.find("div.datagrid-group").each(function(){
var _55c=$(this).attr("group-index");
$(this).find("div.datagrid-row-expander").bind("click",{groupIndex:_55c},function(e){
var _55d=view.find("div.datagrid-group[group-index="+e.data.groupIndex+"]");
if($(this).hasClass("datagrid-row-collapse")){
$(this).removeClass("datagrid-row-collapse").addClass("datagrid-row-expand");
_55d.next("table").hide();
}else{
$(this).removeClass("datagrid-row-expand").addClass("datagrid-row-collapse");
_55d.next("table").show();
}
$(_558).datagrid("fixRowHeight");
});
});
},onBeforeRender:function(_55e,rows){
var opts=$.data(_55e,"datagrid").options;
var _55f=[];
for(var i=0;i<rows.length;i++){
var row=rows[i];
var _560=_561(row[opts.groupField]);
if(!_560){
_560={fvalue:row[opts.groupField],rows:[row],startRow:i};
_55f.push(_560);
}else{
_560.rows.push(row);
}
...
for(var i=0;i<_55f.length;i++){
var _560=_55f[i];
for(var j=0;j<_560.rows.length;j++){
_564.push(_560.rows[j]);
}
}
$.data(_55e,"datagrid").data.rows=_564;
}});
$.fn.propertygrid.defaults=$.extend({},$.fn.datagrid.defaults,{singleSelect:true,remoteSort:false,fitColumns:true,loadMsg:"",frozenColumns:[[{field:"f",width:16,resizable:false}]],columns:[[{field:"name",title:"Name",width:100,sortable:true},{field:"value",title:"Value",width:100,resizable:false}]],showGroup:false,groupField:"group",groupFormatter:function(_565){
return _565;
}});
})(jQuery);
(function($){
function _566(_567){
var opts=$.data(_567,"treegrid").options;
$(_567).datagrid($.extend({},opts,{url:null,onLoadSuccess:function(){
},onResizeColumn:function(_568,_569){
_572(_567);
opts.onResizeColumn.call(_567,_568,_569);
},onBeforeEdit:function(_56a,row){
if(opts.onBeforeEdit.call(_567,row)==false){
return false;
}
},onAfterEdit:function(_56b,row,_56c){
_583(_567);
opts.onAfterEdit.call(_567,row,_56c);
},onCancelEdit:function(_56d,row){
_583(_567);
opts.onCancelEdit.call(_567,row);
}}));
if(opts.pagination){
var _56e=$(_567).datagrid("getPager");
_56e.pagination({pageNumber:opts.pageNumber,pageSize:opts.pageSize,pageList:opts.pageList,onSelectPage:function(_56f,_570){
opts.pageNumber=_56f;
opts.pageSize=_570;
_571(_567);
}});
opts.pageSize=_56e.pagination("options").pageSize;
}
};
function _572(_573,_574){
var opts=$.data(_573,"datagrid").options;
var _575=$.data(_573,"datagrid").panel;
var view=_575.children("div.datagrid-view");
var _576=view.children("div.datagrid-view1");
var _577=view.children("div.datagrid-view2");
if(opts.rownumbers||(opts.frozenColumns&&opts.frozenColumns.length>0)){
if(_574){
_578(_574);
_577.find("tr[node-id="+_574+"]").next("tr.treegrid-tr-tree").find("tr[node-id]").each(function(){
_578($(this).attr("node-id"));
});
}else{
_577.find("tr[node-id]").each(function(){
_578($(this).attr("node-id"));
});
if(opts.showFooter){
var _579=$.data(_573,"datagrid").footer||[];
for(var i=0;i<_579.length;i++){
_578(_579[i][opts.idField]);
}
$(_573).datagrid("resize");
}
}
}
if(opts.height=="auto"){
var _57a=_576.children("div.datagrid-body");
var _57b=_577.children("div.datagrid-body");
var _57c=0;
var _57d=0;
_57b.children().each(function(){
var c=$(this);
if(c.is(":visible")){
_57c+=c.outerHeight();
if(_57d<c.outerWidth()){
_57d=c.outerWidth();
}
}
});
...
_57a.height(_57c);
_57b.height(_57c);
view.height(_577.height());
}
_577.children("div.datagrid-body").triggerHandler("scroll");
function _578(_57e){
var tr1=_576.find("tr[node-id="+_57e+"]");
var tr2=_577.find("tr[node-id="+_57e+"]");
tr1.css("height","");
tr2.css("height","");
var _57f=Math.max(tr1.height(),tr2.height());
tr1.css("height",_57f);
tr2.css("height",_57f);
};
};
...
$(_581).datagrid("getPanel").find("div.datagrid-view1 div.datagrid-body div.datagrid-cell-rownumber").each(function(i){
var _582=i+1;
$(this).html(_582);
});
};
...
var _585=$(_584).datagrid("getPanel");
var body=_585.find("div.datagrid-body");
...
opts.onClickRow.call(_584,find(_584,id));
}).bind("dblclick.treegrid",function(){
var id=$(this).attr("node-id");
opts.onDblClickRow.call(_584,find(_584,id));
}).bind("contextmenu.treegrid",function(e){
var id=$(this).attr("node-id");
opts.onContextMenu.call(_584,e,find(_584,id));
});
...
var _586=_585.find("div.datagrid-header");
_586.find("input[type=checkbox]").unbind().bind("click.treegrid",function(){
if(opts.singleSelect){
return false;
}
if($(this).attr("checked")){
...
var view=$(_58a).datagrid("getPanel").children("div.datagrid-view");
var _58c=view.children("div.datagrid-view1");
var _58d=view.children("div.datagrid-view2");
var tr1=_58c.children("div.datagrid-body").find("tr[node-id="+_58b+"]");
var tr2=_58d.children("div.datagrid-body").find("tr[node-id="+_58b+"]");
var _58e=$(_58a).datagrid("getColumnFields",true).length+(opts.rownumbers?1:0);
var _58f=$(_58a).datagrid("getColumnFields",false).length;
_590(tr1,_58e);
_590(tr2,_58f);
function _590(tr,_591){
$("<tr class=\"treegrid-tr-tree\">"+"<td style=\"border:0px\" colspan=\""+_591+"\">"+"<div></div>"+"</td>"+"</tr>").insertAfter(tr);
};
};
function _592(_593,_594,data,_595){
var opts=$.data(_593,"treegrid").options;
var wrap=$.data(_593,"datagrid").panel;
var view=wrap.children("div.datagrid-view");
var _596=view.children("div.datagrid-view1");
var _597=view.children("div.datagrid-view2");
var node=find(_593,_594);
if(node){
var _598=_596.children("div.datagrid-body").find("tr[node-id="+_594+"]");
var _599=_597.children("div.datagrid-body").find("tr[node-id="+_594+"]");
var cc1=_598.next("tr.treegrid-tr-tree").children("td").children("div");
var cc2=_599.next("tr.treegrid-tr-tree").children("td").children("div");
}else{
var cc1=_596.children("div.datagrid-body").children("div.datagrid-body-inner");
var cc2=_597.children("div.datagrid-body");
}
if(!_595){
$.data(_593,"treegrid").data=[];
cc1.empty();
cc2.empty();
}
if(opts.view.onBeforeRender){
opts.view.onBeforeRender.call(opts.view,_593,_594,data);
}
opts.view.render.call(opts.view,_593,cc1,true);
opts.view.render.call(opts.view,_593,cc2,false);
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,_593,_596.find("div.datagrid-footer-inner"),true);
opts.view.renderFooter.call(opts.view,_593,_597.find("div.datagrid-footer-inner"),false);
}
if(opts.view.onAfterRender){
opts.view.onAfterRender.call(opts.view,_593);
}
opts.onLoadSuccess.call(_593,node,data);
if(!_594&&opts.pagination){
var _59a=$(_593).datagrid("getPager");
if(_59a.pagination("options").total!=data.total){
_59a.pagination({total:data.total});
}
}
_572(_593);
_580(_593);
...
_583(_593);
function _59b(){
var _59c=view.find("div.datagrid-header");
var body=view.find("div.datagrid-body");
var _59d=_59c.find("div.datagrid-header-check");
if(_59d.length){
var ck=body.find("div.datagrid-cell-check");
if($.boxModel){
ck.width(_59d.width());
ck.height(_59d.height());
}else{
ck.width(_59d.outerWidth());
ck.height(_59d.outerHeight());
}
}
};
};
function _571(_59e,_59f,_5a0,_5a1,_5a2){
var opts=$.data(_59e,"treegrid").options;
var body=$(_59e).datagrid("getPanel").find("div.datagrid-body");
if(_5a0){
opts.queryParams=_5a0;
}
var _5a3=$.extend({},opts.queryParams);
var row=find(_59e,_59f);
if(opts.onBeforeLoad.call(_59e,row,_5a3)==false){
return;
}
if(!opts.url){
return;
}
var _5a4=body.find("tr[node-id="+_59f+"] span.tree-folder");
_5a4.addClass("tree-loading");
$(_59e).treegrid("loading");
$.ajax({type:opts.method,url:opts.url,data:_5a3,dataType:"json",success:function(data){
_5a4.removeClass("tree-loading");
$(_59e).treegrid("loaded");
_592(_59e,_59f,data,_5a1);
if(_5a2){
_5a2();
}
},error:function(){
_5a4.removeClass("tree-loading");
$(_59e).treegrid("loaded");
opts.onLoadError.apply(_59e,arguments);
if(_5a2){
_5a2();
}
}});
...
function _5a7(_5a8){
return $.data(_5a8,"treegrid").data;
};
function _5a9(_5aa,_5ab){
var row=find(_5aa,_5ab);
if(row._parentId){
return find(_5aa,row._parentId);
}else{
return null;
}
};
...
var body=$(_5ad).datagrid("getPanel").find("div.datagrid-view2 div.datagrid-body");
var _5af=[];
if(_5ae){
_5b0(_5ae);
}else{
...
_5af.push(_5b1[i]);
_5b0(_5b1[i][opts.idField]);
}
}
function _5b0(_5b2){
var _5b3=find(_5ad,_5b2);
if(_5b3&&_5b3.children){
for(var i=0,len=_5b3.children.length;i<len;i++){
var _5b4=_5b3.children[i];
_5af.push(_5b4);
_5b0(_5b4[opts.idField]);
}
}
};
return _5af;
...
function _5b7(_5b8){
var rows=[];
var _5b9=$(_5b8).datagrid("getPanel");
_5b9.find("div.datagrid-view2 div.datagrid-body tr.datagrid-row-selected").each(function(){
var id=$(this).attr("node-id");
rows.push(find(_5b8,id));
});
return rows;
};
...
var view=$(_5bb).datagrid("getPanel").children("div.datagrid-view");
var node=view.find("div.datagrid-body tr[node-id="+_5bc+"]").children("td[field="+opts.treeField+"]");
return node.find("span.tree-indent,span.tree-hit").length;
};
function find(_5bd,_5be){
var opts=$.data(_5bd,"treegrid").options;
var data=$.data(_5bd,"treegrid").data;
var cc=[data];
while(cc.length){
var c=cc.shift();
for(var i=0;i<c.length;i++){
var node=c[i];
if(node[opts.idField]==_5be){
return node;
}else{
if(node["children"]){
...
function _587(_5c5){
var tr=$(_5c5).datagrid("getPanel").find("div.datagrid-body tr[node-id]");
tr.addClass("datagrid-row-selected");
tr.find("div.datagrid-cell-check input[type=checkbox]").attr("checked",true);
};
function _588(_5c6){
var tr=$(_5c6).datagrid("getPanel").find("div.datagrid-body tr[node-id]");
tr.removeClass("datagrid-row-selected");
tr.find("div.datagrid-cell-check input[type=checkbox]").attr("checked",false);
};
...
if(opts.onBeforeCollapse.call(_5c8,row)==false){
return;
}
hit.removeClass("tree-expanded tree-expanded-hover").addClass("tree-collapsed");
hit.next().removeClass("tree-folder-open");
...
var body=$(_5cb).datagrid("getPanel").find("div.datagrid-body");
var tr=body.find("tr[node-id="+_5cc+"]");
var hit=tr.find("span.tree-hit");
var row=find(_5cb,_5cc);
if(hit.length==0){
return;
}
if(hit.hasClass("tree-expanded")){
...
if(opts.onBeforeExpand.call(_5cb,row)==false){
return;
}
hit.removeClass("tree-collapsed tree-collapsed-hover").addClass("tree-expanded");
hit.next().addClass("tree-folder-open");
var _5cd=tr.next("tr.treegrid-tr-tree");
if(_5cd.length){
var cc=_5cd.children("td").children("div");
_5ce(cc);
}else{
_589(_5cb,row[opts.idField]);
var _5cd=tr.next("tr.treegrid-tr-tree");
var cc=_5cd.children("td").children("div");
cc.hide();
_571(_5cb,row[opts.idField],{id:row[opts.idField]},true,function(){
_5ce(cc);
});
}
function _5ce(cc){
...
var body=$(_5d0).datagrid("getPanel").find("div.datagrid-body");
var tr=body.find("tr[node-id="+_5d1+"]");
var hit=tr.find("span.tree-hit");
if(hit.hasClass("tree-expanded")){
_5c7(_5d0,_5d1);
}else{
...
var _5d5=_5ac(_5d3,_5d4);
if(_5d4){
_5d5.unshift(find(_5d3,_5d4));
}
for(var i=0;i<_5d5.length;i++){
_5c7(_5d3,_5d5[i][opts.idField]);
}
};
function _5d6(_5d7,_5d8){
var opts=$.data(_5d7,"treegrid").options;
var _5d9=_5ac(_5d7,_5d8);
if(_5d8){
_5d9.unshift(find(_5d7,_5d8));
}
for(var i=0;i<_5d9.length;i++){
_5ca(_5d7,_5d9[i][opts.idField]);
}
};
function _5da(_5db,_5dc){
var opts=$.data(_5db,"treegrid").options;
var ids=[];
var p=_5a9(_5db,_5dc);
while(p){
...
var tr=body.find("tr[node-id="+_5df.parent+"]");
if(tr.next("tr.treegrid-tr-tree").length==0){
_589(_5de,_5df.parent);
}
var cell=tr.children("td[field="+opts.treeField+"]").children("div.datagrid-cell");
var _5e0=cell.children("span.tree-icon");
if(_5e0.hasClass("tree-file")){
_5e0.removeClass("tree-file").addClass("tree-folder");
var hit=$("<span class=\"tree-hit tree-expanded\"></span>").insertBefore(_5e0);
if(hit.prev().length){
hit.prev().remove();
}
}
}
_592(_5de,_5df.parent,_5df.data,true);
};
function _5e1(_5e2,_5e3){
var opts=$.data(_5e2,"treegrid").options;
var body=$(_5e2).datagrid("getPanel").find("div.datagrid-body");
var tr=body.find("tr[node-id="+_5e3+"]");
tr.next("tr.treegrid-tr-tree").remove();
tr.remove();
var _5e4=del(_5e3);
if(_5e4){
if(_5e4.children.length==0){
tr=body.find("tr[node-id="+_5e4[opts.treeField]+"]");
var cell=tr.children("td[field="+opts.treeField+"]").children("div.datagrid-cell");
...
function del(id){
var cc;
var _5e5=_5a9(_5e2,_5e3);
if(_5e5){
cc=_5e5.children;
}else{
cc=$(_5e2).treegrid("getData");
}
for(var i=0;i<cc.length;i++){
...
$.fn.treegrid=function(_5e6,_5e7){
if(typeof _5e6=="string"){
var _5e8=$.fn.treegrid.methods[_5e6];
if(_5e8){
return _5e8(this,_5e7);
}else{
return this.datagrid(_5e6,_5e7);
}
}
_5e6=_5e6||{};
return this.each(function(){
var _5e9=$.data(this,"treegrid");
if(_5e9){
$.extend(_5e9.options,_5e6);
}else{
$.data(this,"treegrid",{options:$.extend({},$.fn.treegrid.defaults,$.fn.treegrid.parseOptions(this),_5e6),data:[]});
}
_566(this);
_571(this);
});
...
return jq.each(function(){
$(this).datagrid("resize",_5ea);
});
},fixRowHeight:function(jq,_5eb){
return jq.each(function(){
_572(this,_5eb);
});
},loadData:function(jq,data){
...
},reloadFooter:function(jq,_5ec){
return jq.each(function(){
var opts=$.data(this,"treegrid").options;
var view=$(this).datagrid("getPanel").children("div.datagrid-view");
var _5ed=view.children("div.datagrid-view1");
var _5ee=view.children("div.datagrid-view2");
if(_5ec){
$.data(this,"treegrid").footer=_5ec;
}
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,this,_5ed.find("div.datagrid-footer-inner"),true);
opts.view.renderFooter.call(opts.view,this,_5ee.find("div.datagrid-footer-inner"),false);
if(opts.view.onAfterRender){
opts.view.onAfterRender.call(opts.view,this);
}
...
$.fn.treegrid.parseOptions=function(_5f0){
var t=$(_5f0);
return $.extend({},$.fn.datagrid.parseOptions(_5f0),{treeField:t.attr("treeField"),animate:(t.attr("animate")?t.attr("animate")=="true":undefined)});
};
var _5f1=$.extend({},$.fn.datagrid.defaults.view,{render:function(_5f2,_5f3,_5f4){
var opts=$.data(_5f2,"treegrid").options;
var _5f5=$(_5f2).datagrid("getColumnFields",_5f4);
var view=this;
var _5f6=_5f7(_5f4,this.treeLevel,this.treeNodes);
$(_5f3).append(_5f6.join(""));
function _5f7(_5f8,_5f9,_5fa){
var _5fb=["<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<_5fa.length;i++){
var row=_5fa[i];
if(row.state!="open"&&row.state!="closed"){
row.state="open";
}
var _5fc=opts.rowStyler?opts.rowStyler.call(_5f2,row):"";
var _5fd=_5fc?"style=\""+_5fc+"\"":"";
_5fb.push("<tr node-id="+row[opts.idField]+" "+_5fd+">");
_5fb=_5fb.concat(view.renderRow.call(view,_5f2,_5f5,_5f8,_5f9,row));
_5fb.push("</tr>");
if(row.children&&row.children.length){
var tt=_5f7(_5f8,_5f9+1,row.children);
var v=row.state=="closed"?"none":"block";
_5fb.push("<tr class=\"treegrid-tr-tree\"><td style=\"border:0px\" colspan="+(_5f5.length+(opts.rownumbers?1:0))+"><div style=\"display:"+v+"\">");
_5fb=_5fb.concat(tt);
_5fb.push("</div></td></tr>");
}
}
_5fb.push("</tbody></table>");
return _5fb;
};
},renderFooter:function(_5fe,_5ff,_600){
var opts=$.data(_5fe,"treegrid").options;
var rows=$.data(_5fe,"treegrid").footer||[];
var _601=$(_5fe).datagrid("getColumnFields",_600);
var _602=["<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<rows.length;i++){
var row=rows[i];
row[opts.idField]=row[opts.idField]||("foot-row-id"+i);
_602.push("<tr node-id="+row[opts.idField]+">");
_602.push(this.renderRow.call(this,_5fe,_601,_600,0,row));
_602.push("</tr>");
}
_602.push("</tbody></table>");
$(_5ff).html(_602.join(""));
},renderRow:function(_603,_604,_605,_606,row){
var opts=$.data(_603,"treegrid").options;
var cc=[];
if(_605&&opts.rownumbers){
cc.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\">0</div></td>");
}
for(var i=0;i<_604.length;i++){
var _607=_604[i];
var col=$(_603).datagrid("getColumnOption",_607);
if(col){
var _608=col.styler?(col.styler(row[_607],row)||""):"";
var _609=col.hidden?"style=\"display:none;"+_608+"\"":(_608?"style=\""+_608+"\"":"");
cc.push("<td field=\""+_607+"\" "+_609+">");
var _609="width:"+(col.boxWidth)+"px;";
_609+="text-align:"+(col.align||"left")+";";
_609+=opts.nowrap==false?"white-space:normal;":"";
cc.push("<div style=\""+_609+"\" ");
if(col.checkbox){
cc.push("class=\"datagrid-cell-check ");
}else{
cc.push("class=\"datagrid-cell ");
...
return cc.join("");
},refreshRow:function(_60a,id){
var row=$(_60a).treegrid("find",id);
var opts=$.data(_60a,"treegrid").options;
var body=$(_60a).datagrid("getPanel").find("div.datagrid-body");
var _60b=opts.rowStyler?opts.rowStyler.call(_60a,row):"";
var _60c=_60b?"style=\""+_60b+"\"":"";
var tr=body.find("tr[node-id="+id+"]");
tr.attr("style",_60c);
tr.children("td").each(function(){
var cell=$(this).find("div.datagrid-cell");
var _60d=$(this).attr("field");
var col=$(_60a).datagrid("getColumnOption",_60d);
if(col){
var _60e=col.styler?(col.styler(row[_60d],row)||""):"";
var _60f=col.hidden?"style=\"display:none;"+_60e+"\"":(_60e?"style=\""+_60e+"\"":"");
$(this).attr("style",_60f);
var val=null;
if(col.formatter){
val=col.formatter(row[_60d],row);
}else{
val=row[_60d]||"&nbsp;";
}
if(_60d==opts.treeField){
...
$(_60a).treegrid("fixRowHeight",id);
},onBeforeRender:function(_610,_611,data){
var opts=$.data(_610,"treegrid").options;
if(data.length==undefined){
if(data.footer){
$.data(_610,"treegrid").footer=data.footer;
}
data=this.transfer(_610,_611,data.rows);
}else{
...
row._parentId=_614;
if(row.children&&row.children.length){
_612(row.children,row[opts.idField]);
}
}
};
_612(data,_611);
}
var node=find(_610,_611);
if(node){
if(node.children){
...
$.data(_610,"treegrid").data=$.data(_610,"treegrid").data.concat(data);
}
this.treeNodes=data;
this.treeLevel=$(_610).treegrid("getLevel",_611);
},transfer:function(_615,_616,data){
...
$.fn.treegrid.defaults=$.extend({},$.fn.datagrid.defaults,{treeField:null,animate:false,singleSelect:true,view:_5f1,editConfig:{getTr:function(_618,id){
return $(_618).datagrid("getPanel").find("div.datagrid-body tr[node-id="+id+"]");
},getRow:function(_619,id){
return $(_619).treegrid("find",id);
}},onBeforeLoad:function(row,_61a){
...
var _61f=$.data(_61d,"combo").combo;
var _620=$.data(_61d,"combo").panel;
if(_61e){
opts.width=_61e;
}
_61f.appendTo("body");
if(isNaN(opts.width)){
opts.width=_61f.find("input.combo-text").outerWidth();
}
var _621=0;
if(opts.hasDownArrow){
_621=_61f.find(".combo-arrow").outerWidth();
}
var _61e=opts.width-_621;
if($.boxModel==true){
_61e-=_61f.outerWidth()-_61f.width();
}
_61f.find("input.combo-text").width(_61e);
_620.panel("resize",{width:(opts.panelWidth?opts.panelWidth:_61f.outerWidth()),height:opts.panelHeight});
_61f.insertAfter(_61d);
};
function _622(_623){
var opts=$.data(_623,"combo").options;
var _624=$.data(_623,"combo").combo;
if(opts.hasDownArrow){
_624.find(".combo-arrow").show();
}else{
_624.find(".combo-arrow").hide();
}
};
function init(_625){
$(_625).addClass("combo-f").hide();
var span=$("<span class=\"combo\"></span>").insertAfter(_625);
var _626=$("<input type=\"text\" class=\"combo-text\">").appendTo(span);
$("<span><span class=\"combo-arrow\"></span></span>").appendTo(span);
$("<input type=\"hidden\" class=\"combo-value\">").appendTo(span);
var _627=$("<div class=\"combo-panel\"></div>").appendTo("body");
_627.panel({doSize:false,closed:true,style:{position:"absolute",zIndex:10},onOpen:function(){
$(this).panel("resize");
}});
var name=$(_625).attr("name");
if(name){
span.find("input.combo-value").attr("name",name);
$(_625).removeAttr("name").attr("comboName",name);
}
_626.attr("autocomplete","off");
return {combo:span,panel:_627};
};
function _628(_629){
var _62a=$.data(_629,"combo").combo.find("input.combo-text");
_62a.validatebox("destroy");
$.data(_629,"combo").panel.panel("destroy");
$.data(_629,"combo").combo.remove();
$(_629).remove();
};
function _62b(_62c){
...
var _62f=_62d.find(".combo-text");
var _630=_62d.find(".combo-arrow");
...
_630.unbind(".combo");
if(!opts.disabled){
_62e.bind("mousedown.combo",function(e){
return false;
});
_62f.bind("mousedown.combo",function(e){
e.stopPropagation();
}).bind("keydown.combo",function(e){
switch(e.keyCode){
case 38:
opts.keyHandler.up.call(_62c);
break;
case 40:
opts.keyHandler.down.call(_62c);
break;
case 13:
e.preventDefault();
opts.keyHandler.enter.call(_62c);
return false;
case 9:
case 27:
_636(_62c);
...
setTimeout(function(){
var q=_62f.val();
if($.data(_62c,"combo").previousValue!=q){
$.data(_62c,"combo").previousValue=q;
_631(_62c);
opts.keyHandler.query.call(_62c,_62f.val());
_639(_62c,true);
}
},10);
}
...
_630.bind("click.combo",function(){
_62f.focus();
_631(_62c);
...
var _634=$.data(_632,"combo").panel;
if($.fn.window){
_634.panel("panel").css("z-index",$.fn.window.defaults.zIndex++);
}
_634.panel("move",{left:_633.offset().left,top:_635()});
_634.panel("open");
opts.onShowPanel.call(_632);
(function(){
if(_634.is(":visible")){
_634.panel("move",{left:_633.offset().left,top:_635()});
setTimeout(arguments.callee,200);
...
function _635(){
var top=_633.offset().top+_633.outerHeight();
if(top+_634.outerHeight()>$(window).height()+$(document).scrollTop()){
top=_633.offset().top-_634.outerHeight();
}
if(top<$(document).scrollTop()){
top=_633.offset().top+_633.outerHeight();
}
return top;
};
};
...
var _638=$.data(_637,"combo").panel;
_638.panel("close");
opts.onHidePanel.call(_637);
};
function _639(_63a,doit){
var opts=$.data(_63a,"combo").options;
var _63b=$.data(_63a,"combo").combo.find("input.combo-text");
_63b.validatebox(opts);
if(doit){
_63b.validatebox("validate");
_63b.trigger("mouseleave");
}
};
function _63c(_63d,_63e){
var opts=$.data(_63d,"combo").options;
var _63f=$.data(_63d,"combo").combo;
if(_63e){
opts.disabled=true;
$(_63d).attr("disabled",true);
_63f.find(".combo-value").attr("disabled",true);
_63f.find(".combo-text").attr("disabled",true);
}else{
opts.disabled=false;
$(_63d).removeAttr("disabled");
_63f.find(".combo-value").removeAttr("disabled");
_63f.find(".combo-text").removeAttr("disabled");
}
};
function _640(_641){
...
if(opts.multiple){
_642.find("input.combo-value").remove();
}else{
_642.find("input.combo-value").val("");
}
_642.find("input.combo-text").val("");
};
function _643(_644){
var _645=$.data(_644,"combo").combo;
return _645.find("input.combo-text").val();
};
function _646(_647,text){
var _648=$.data(_647,"combo").combo;
_648.find("input.combo-text").val(text);
_639(_647,true);
$.data(_647,"combo").previousValue=text;
};
function _649(_64a){
var _64b=[];
var _64c=$.data(_64a,"combo").combo;
_64c.find("input.combo-value").each(function(){
_64b.push($(this).val());
});
return _64b;
};
function _64d(_64e,_64f){
var opts=$.data(_64e,"combo").options;
var _650=_649(_64e);
var _651=$.data(_64e,"combo").combo;
_651.find("input.combo-value").remove();
var name=$(_64e).attr("comboName");
for(var i=0;i<_64f.length;i++){
var _652=$("<input type=\"hidden\" class=\"combo-value\">").appendTo(_651);
if(name){
_652.attr("name",name);
}
_652.val(_64f[i]);
...
if(aa.length!=_64f.length||_64f.length!=_650.length){
if(opts.multiple){
opts.onChange.call(_64e,_64f,_650);
}else{
opts.onChange.call(_64e,_64f[0],_650[0]);
}
}
};
function _653(_654){
...
_64d(_65a,opts.value);
}else{
_656(_65a,opts.value);
}
}else{
_64d(_65a,[]);
}
...
$.fn.combo=function(_65b,_65c){
if(typeof _65b=="string"){
return $.fn.combo.methods[_65b](this,_65c);
}
_65b=_65b||{};
return this.each(function(){
var _65d=$.data(this,"combo");
if(_65d){
$.extend(_65d.options,_65b);
}else{
var r=init(this);
_65d=$.data(this,"combo",{options:$.extend({},$.fn.combo.defaults,$.fn.combo.parseOptions(this),_65b),combo:r.combo,panel:r.panel,previousValue:null});
$(this).removeAttr("disabled");
}
$("input.combo-text",_65d.combo).attr("readonly",!_65d.options.editable);
_622(this);
_63c(this,_65d.options.disabled);
_61c(this);
_62b(this);
_639(this);
_659(this);
...
var _65f=$.data(jq[0],"combo").combo.find("input.combo-text");
return _65f.validatebox("isValid");
},clear:function(jq){
return jq.each(function(){
_640(this);
});
...
},onChange:function(_663,_664){
}});
})(jQuery);
(function($){
function _665(_666,_667){
var _668=$(_666).combo("panel");
var item=_668.find("div.combobox-item[value="+_667+"]");
if(item.length){
if(item.position().top<=0){
var h=_668.scrollTop()+item.position().top;
_668.scrollTop(h);
}else{
if(item.position().top+item.outerHeight()>_668.height()){
var h=_668.scrollTop()+item.position().top+item.outerHeight()-_668.height();
_668.scrollTop(h);
}
}
}
...
item=_66b.find("div.combobox-item:visible:last");
}
...
var _672=$(_670).combo("getValues");
var item=_671.find("div.combobox-item[value="+_672.pop()+"]");
if(item.length){
...
item=_671.find("div.combobox-item:visible:first");
}
var _673=item.attr("value");
_66e(_670,[_673]);
_665(_670,_673);
};
function _674(_675,_676){
var opts=$.data(_675,"combobox").options;
var data=$.data(_675,"combobox").data;
if(opts.multiple){
var _677=$(_675).combo("getValues");
...
for(var i=0;i<data.length;i++){
if(data[i][opts.valueField]==_676){
opts.onSelect.call(_675,data[i]);
return;
}
}
};
...
var data=$.data(_679,"combobox").data;
var _67b=$(_679).combo("getValues");
...
for(var i=0;i<data.length;i++){
if(data[i][opts.valueField]==_67a){
opts.onUnselect.call(_679,data[i]);
return;
}
}
};
function _66e(_67c,_67d,_67e){
var opts=$.data(_67c,"combobox").options;
var data=$.data(_67c,"combobox").data;
var _67f=$(_67c).combo("panel");
_67f.find("div.combobox-item-selected").removeClass("combobox-item-selected");
var vv=[],ss=[];
...
vv.push(v);
ss.push(s);
_67f.find("div.combobox-item[value="+v+"]").addClass("combobox-item-selected");
}
$(_67c).combo("setValues",vv);
if(!_67e){
$(_67c).combo("setText",ss.join(opts.separator));
}
};
function _680(_681){
var opts=$.data(_681,"combobox").options;
var data=[];
$(">option",_681).each(function(){
var item={};
...
function _682(_683,data,_684){
var opts=$.data(_683,"combobox").options;
var _685=$(_683).combo("panel");
$.data(_683,"combobox").data=data;
var _686=$(_683).combobox("getValues");
_685.empty();
for(var i=0;i<data.length;i++){
var v=data[i][opts.valueField];
var s=data[i][opts.textField];
var item=$("<div class=\"combobox-item\"></div>").appendTo(_685);
item.attr("value",v);
if(opts.formatter){
item.html(opts.formatter.call(_683,data[i]));
}else{
item.html(s);
}
if(data[i]["selected"]){
...
if(_686.length){
_66e(_683,[_686[_686.length-1]],_684);
}else{
_66e(_683,[],_684);
}
}
opts.onLoadSuccess.call(_683,data);
$(".combobox-item",_685).hover(function(){
...
_678(_683,item.attr("value"));
}else{
_674(_683,item.attr("value"));
}
}else{
_674(_683,item.attr("value"));
$(_683).combo("hidePanel");
}
});
};
function _687(_688,url,_689,_68a){
var opts=$.data(_688,"combobox").options;
if(url){
opts.url=url;
}
if(!opts.url){
...
_689=_689||{};
$.ajax({type:opts.method,url:opts.url,dataType:"json",data:_689,success:function(data){
_682(_688,data,_68a);
},error:function(){
opts.onLoadError.apply(this,arguments);
}});
};
function _68b(_68c,q){
var opts=$.data(_68c,"combobox").options;
if(opts.multiple&&!q){
_66e(_68c,[],true);
}else{
_66e(_68c,[q],true);
...
if(opts.mode=="remote"){
_687(_68c,null,{q:q},true);
}else{
var _68d=$(_68c).combo("panel");
_68d.find("div.combobox-item").hide();
var data=$.data(_68c,"combobox").data;
for(var i=0;i<data.length;i++){
if(opts.filter.call(_68c,q,data[i])){
var v=data[i][opts.valueField];
var s=data[i][opts.textField];
var item=_68d.find("div.combobox-item[value="+v+"]");
item.show();
if(s==q){
_66e(_68c,[v],true);
...
$(_68f).addClass("combobox-f");
$(_68f).combo($.extend({},opts,{onShowPanel:function(){
$(_68f).combo("panel").find("div.combobox-item").show();
_665(_68f,$(_68f).combobox("getValue"));
opts.onShowPanel.call(_68f);
}}));
};
$.fn.combobox=function(_690,_691){
if(typeof _690=="string"){
var _692=$.fn.combobox.methods[_690];
if(_692){
...
_690=_690||{};
return this.each(function(){
var _693=$.data(this,"combobox");
if(_693){
$.extend(_693.options,_690);
_68e(this);
}else{
_693=$.data(this,"combobox",{options:$.extend({},$.fn.combobox.defaults,$.fn.combobox.parseOptions(this),_690)});
_68e(this);
_682(this,_680(this));
}
if(_693.options.data){
_682(this,_693.options.data);
}
_687(this);
});
};
...
return jq.each(function(){
$(this).combo("clear");
var _696=$(this).combo("panel");
_696.find("div.combobox-item-selected").removeClass("combobox-item-selected");
});
},loadData:function(jq,data){
return jq.each(function(){
_682(this,data);
...
},select:function(jq,_697){
return jq.each(function(){
_674(this,_697);
});
},unselect:function(jq,_698){
return jq.each(function(){
_678(this,_698);
});
}};
$.fn.combobox.parseOptions=function(_699){
var t=$(_699);
return $.extend({},$.fn.combo.parseOptions(_699),{valueField:t.attr("valueField"),textField:t.attr("textField"),mode:t.attr("mode"),method:(t.attr("method")?t.attr("method"):undefined),url:t.attr("url")});
};
...
var _69a=$(this).combobox("getValues");
$(this).combobox("setValues",_69a);
...
},onSelect:function(_69b){
},onUnselect:function(_69c){
}});
})(jQuery);
(function($){
function _69d(_69e){
...
$(_69e).addClass("combotree-f");
$(_69e).combo(opts);
var _69f=$(_69e).combo("panel");
if(!tree){
tree=$("<ul></ul>").appendTo(_69f);
$.data(_69e,"combotree").tree=tree;
}
tree.tree($.extend({},opts,{checkbox:opts.multiple,onLoadSuccess:function(node,data){
var _6a0=$(_69e).combotree("getValues");
if(opts.multiple){
var _6a1=tree.tree("getChecked");
...
$(_69e).combotree("setValues",_6a0);
opts.onLoadSuccess.call(this,node,data);
},onClick:function(node){
_6a3(_69e);
$(_69e).combo("hidePanel");
opts.onClick.call(this,node);
},onCheck:function(node,_6a2){
_6a3(_69e);
opts.onCheck.call(this,node,_6a2);
}}));
};
function _6a3(_6a4){
var opts=$.data(_6a4,"combotree").options;
var tree=$.data(_6a4,"combotree").tree;
var vv=[],ss=[];
if(opts.multiple){
var _6a5=tree.tree("getChecked");
...
$(_6a4).combo("setValues",vv).combo("setText",ss.join(opts.separator));
};
function _6a6(_6a7,_6a8){
var opts=$.data(_6a7,"combotree").options;
var tree=$.data(_6a7,"combotree").tree;
...
$(_6a7).combo("setValues",vv).combo("setText",ss.join(opts.separator));
};
$.fn.combotree=function(_6a9,_6aa){
if(typeof _6a9=="string"){
var _6ab=$.fn.combotree.methods[_6a9];
if(_6ab){
return _6ab(this,_6aa);
}else{
return this.combo(_6a9,_6aa);
}
}
_6a9=_6a9||{};
return this.each(function(){
var _6ac=$.data(this,"combotree");
if(_6ac){
$.extend(_6ac.options,_6a9);
}else{
$.data(this,"combotree",{options:$.extend({},$.fn.combotree.defaults,$.fn.combotree.parseOptions(this),_6a9)});
}
_69d(this);
});
};
...
},setValues:function(jq,_6ad){
return jq.each(function(){
_6a6(this,_6ad);
});
},setValue:function(jq,_6ae){
return jq.each(function(){
_6a6(this,[_6ae]);
});
},clear:function(jq){
...
$.fn.combotree.parseOptions=function(_6af){
return $.extend({},$.fn.combo.parseOptions(_6af),$.fn.tree.parseOptions(_6af));
};
...
$(_6b1).addClass("combogrid-f");
$(_6b1).combo(opts);
var _6b2=$(_6b1).combo("panel");
if(!grid){
grid=$("<table></table>").appendTo(_6b2);
$.data(_6b1,"combogrid").grid=grid;
}
grid.datagrid($.extend({},opts,{border:false,fit:true,singleSelect:(!opts.multiple),onLoadSuccess:function(data){
var _6b3=$.data(_6b1,"combogrid").remainText;
var _6b4=$(_6b1).combo("getValues");
_6c0(_6b1,_6b4,_6b3);
opts.onLoadSuccess.apply(_6b1,arguments);
},onClickRow:_6b5,onSelect:function(_6b6,row){
_6b7();
opts.onSelect.call(this,_6b6,row);
},onUnselect:function(_6b8,row){
_6b7();
opts.onUnselect.call(this,_6b8,row);
},onSelectAll:function(rows){
_6b7();
...
function _6b5(_6b9,row){
$.data(_6b1,"combogrid").remainText=false;
_6b7();
if(!opts.multiple){
$(_6b1).combo("hidePanel");
}
opts.onClickRow.call(this,_6b9,row);
};
function _6b7(){
var _6ba=$.data(_6b1,"combogrid").remainText;
...
if(!opts.multiple){
$(_6b1).combo("setValues",(vv.length?vv:[""]));
}else{
$(_6b1).combo("setValues",vv);
}
if(!_6ba){
$(_6b1).combo("setText",ss.join(opts.separator));
}
};
};
function _6bb(_6bc,step){
var opts=$.data(_6bc,"combogrid").options;
var grid=$.data(_6bc,"combogrid").grid;
var _6bd=grid.datagrid("getRows").length;
$.data(_6bc,"combogrid").remainText=false;
var _6be;
var _6bf=grid.datagrid("getSelections");
if(_6bf.length){
_6be=grid.datagrid("getRowIndex",_6bf[_6bf.length-1][opts.idField]);
_6be+=step;
if(_6be<0){
_6be=0;
}
...
var opts=$.data(_6c1,"combogrid").options;
var grid=$.data(_6c1,"combogrid").grid;
var rows=grid.datagrid("getRows");
var ss=[];
for(var i=0;i<_6c2.length;i++){
var _6c4=grid.datagrid("getRowIndex",_6c2[i]);
if(_6c4>=0){
grid.datagrid("selectRow",_6c4);
ss.push(rows[_6c4][opts.textField]);
}else{
ss.push(_6c2[i]);
}
}
if($(_6c1).combo("getValues").join(",")==_6c2.join(",")){
return;
}
$(_6c1).combo("setValues",_6c2);
if(!_6c3){
$(_6c1).combo("setText",ss.join(opts.separator));
}
};
function _6c5(_6c6,q){
var opts=$.data(_6c6,"combogrid").options;
var grid=$.data(_6c6,"combogrid").grid;
$.data(_6c6,"combogrid").remainText=true;
if(opts.multiple&&!q){
_6c0(_6c6,[],true);
}else{
_6c0(_6c6,[q],true);
...
var rows=grid.datagrid("getRows");
for(var i=0;i<rows.length;i++){
if(opts.filter.call(_6c6,q,rows[i])){
grid.datagrid("clearSelections");
...
$.fn.combogrid=function(_6c7,_6c8){
if(typeof _6c7=="string"){
var _6c9=$.fn.combogrid.methods[_6c7];
if(_6c9){
return _6c9(this,_6c8);
}else{
return $.fn.combo.methods[_6c7](this,_6c8);
}
}
_6c7=_6c7||{};
return this.each(function(){
var _6ca=$.data(this,"combogrid");
if(_6ca){
$.extend(_6ca.options,_6c7);
}else{
_6ca=$.data(this,"combogrid",{options:$.extend({},$.fn.combogrid.defaults,$.fn.combogrid.parseOptions(this),_6c7)});
}
_6b0(this);
});
};
...
},setValues:function(jq,_6cb){
return jq.each(function(){
_6c0(this,_6cb);
});
},setValue:function(jq,_6cc){
return jq.each(function(){
_6c0(this,[_6cc]);
});
},clear:function(jq){
...
$.fn.combogrid.parseOptions=function(_6cd){
var t=$(_6cd);
return $.extend({},$.fn.combo.parseOptions(_6cd),$.fn.datagrid.parseOptions(_6cd),{idField:(t.attr("idField")||undefined),textField:(t.attr("textField")||undefined),mode:t.attr("mode")});
};
...
(function($){
function _6ce(_6cf){
var _6d0=$.data(_6cf,"datebox");
var opts=_6d0.options;
$(_6cf).addClass("datebox-f");
$(_6cf).combo($.extend({},opts,{onShowPanel:function(){
_6d0.calendar.calendar("resize");
opts.onShowPanel.call(_6cf);
}}));
$(_6cf).combo("textbox").parent().addClass("datebox");
if(!_6d0.calendar){
_6d1();
}
function _6d1(){
var _6d2=$(_6cf).combo("panel");
_6d0.calendar=$("<div></div>").appendTo(_6d2).wrap("<div class=\"datebox-calendar-inner\"></div>");
_6d0.calendar.calendar({fit:true,border:false,onSelect:function(date){
var _6d3=opts.formatter(date);
_6d7(_6cf,_6d3);
$(_6cf).combo("hidePanel");
opts.onSelect.call(_6cf,date);
}});
_6d7(_6cf,opts.value);
var _6d4=$("<div class=\"datebox-button\"></div>").appendTo(_6d2);
$("<a href=\"javascript:void(0)\" class=\"datebox-current\"></a>").html(opts.currentText).appendTo(_6d4);
$("<a href=\"javascript:void(0)\" class=\"datebox-close\"></a>").html(opts.closeText).appendTo(_6d4);
_6d4.find(".datebox-current,.datebox-close").hover(function(){
$(this).addClass("datebox-button-hover");
},function(){
$(this).removeClass("datebox-button-hover");
});
_6d4.find(".datebox-current").click(function(){
_6d0.calendar.calendar({year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date()});
});
_6d4.find(".datebox-close").click(function(){
$(_6cf).combo("hidePanel");
});
};
};
function _6d5(_6d6,q){
_6d7(_6d6,q);
};
function _6d8(_6d9){
var opts=$.data(_6d9,"datebox").options;
var c=$.data(_6d9,"datebox").calendar;
var _6da=opts.formatter(c.calendar("options").current);
_6d7(_6d9,_6da);
$(_6d9).combo("hidePanel");
};
function _6d7(_6db,_6dc){
var _6dd=$.data(_6db,"datebox");
var opts=_6dd.options;
$(_6db).combo("setValue",_6dc).combo("setText",_6dc);
_6dd.calendar.calendar("moveTo",opts.parser(_6dc));
};
$.fn.datebox=function(_6de,_6df){
if(typeof _6de=="string"){
var _6e0=$.fn.datebox.methods[_6de];
if(_6e0){
return _6e0(this,_6df);
}else{
return this.combo(_6de,_6df);
}
}
_6de=_6de||{};
return this.each(function(){
var _6e1=$.data(this,"datebox");
if(_6e1){
$.extend(_6e1.options,_6de);
}else{
$.data(this,"datebox",{options:$.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_6de)});
}
_6ce(this);
});
};
...
$.fn.datebox.parseOptions=function(_6e3){
var t=$(_6e3);
return $.extend({},$.fn.combo.parseOptions(_6e3),{});
};
...
(function($){
function _6e4(_6e5){
var _6e6=$.data(_6e5,"datetimebox");
var opts=_6e6.options;
$(_6e5).datebox($.extend({},opts,{onShowPanel:function(){
var _6e7=$(_6e5).datetimebox("getValue");
_6ef(_6e5,_6e7,true);
opts.onShowPanel.call(_6e5);
}}));
$(_6e5).removeClass("datebox-f").addClass("datetimebox-f");
$(_6e5).datebox("calendar").calendar({onSelect:function(date){
opts.onSelect.call(_6e5,date);
}});
var _6e8=$(_6e5).datebox("panel");
if(!_6e6.spinner){
var p=$("<div style=\"padding:2px\"><input style=\"width:80px\"></div>").insertAfter(_6e8.children("div.datebox-calendar-inner"));
_6e6.spinner=p.children("input");
_6e6.spinner.timespinner({showSeconds:true}).bind("mousedown",function(e){
e.stopPropagation();
});
_6ef(_6e5,opts.value);
var _6e9=_6e8.children("div.datebox-button");
var ok=$("<a href=\"javascript:void(0)\" class=\"datebox-ok\"></a>").html(opts.okText).appendTo(_6e9);
ok.hover(function(){
$(this).addClass("datebox-button-hover");
},function(){
$(this).removeClass("datebox-button-hover");
...
function _6eb(_6ec){
var c=$(_6ec).datetimebox("calendar");
var t=$(_6ec).datetimebox("spinner");
var date=c.calendar("options").current;
return new Date(date.getFullYear(),date.getMonth(),date.getDate(),t.timespinner("getHours"),t.timespinner("getMinutes"),t.timespinner("getSeconds"));
};
function _6ed(_6ee,q){
_6ef(_6ee,q,true);
};
function _6ea(_6f0){
var opts=$.data(_6f0,"datetimebox").options;
var date=_6eb(_6f0);
_6ef(_6f0,opts.formatter(date));
$(_6f0).combo("hidePanel");
};
function _6ef(_6f1,_6f2,_6f3){
var opts=$.data(_6f1,"datetimebox").options;
$(_6f1).combo("setValue",_6f2);
if(!_6f3){
if(_6f2){
var date=opts.parser(_6f2);
$(_6f1).combo("setValue",opts.formatter(date));
$(_6f1).combo("setText",opts.formatter(date));
}else{
$(_6f1).combo("setText",_6f2);
}
}
var date=opts.parser(_6f2);
$(_6f1).datetimebox("calendar").calendar("moveTo",opts.parser(_6f2));
$(_6f1).datetimebox("spinner").timespinner("setValue",_6f4(date));
function _6f4(date){
function _6f5(_6f6){
return (_6f6<10?"0":"")+_6f6;
};
var tt=[_6f5(date.getHours()),_6f5(date.getMinutes())];
if(opts.showSeconds){
tt.push(_6f5(date.getSeconds()));
}
return tt.join($(_6f1).datetimebox("spinner").timespinner("options").separator);
};
};
$.fn.datetimebox=function(_6f7,_6f8){
if(typeof _6f7=="string"){
var _6f9=$.fn.datetimebox.methods[_6f7];
if(_6f9){
return _6f9(this,_6f8);
}else{
return this.datebox(_6f7,_6f8);
}
}
_6f7=_6f7||{};
return this.each(function(){
var _6fa=$.data(this,"datetimebox");
if(_6fa){
$.extend(_6fa.options,_6f7);
}else{
$.data(this,"datetimebox",{options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_6f7)});
}
_6e4(this);
});
};
...
$.fn.datetimebox.parseOptions=function(_6fc){
var t=$(_6fc);
return $.extend({},$.fn.datebox.parseOptions(_6fc),{});
};
...
function _6fd(_6fe){
return (_6fe<10?"0":"")+_6fe;
};
return $.fn.datebox.defaults.formatter(date)+" "+_6fd(h)+":"+_6fd(M)+":"+_6fd(s);
},parser:function(s){
if($.trim(s)==""){
return new Date();
}
...
var _6ff=parseInt(tt[1],10);
var _700=parseInt(tt[2],10);
return new Date(d.getFullYear(),d.getMonth(),d.getDate(),hour,_6ff,_700);
}});
})(jQuery);
