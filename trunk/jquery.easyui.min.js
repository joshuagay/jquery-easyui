...
if(_383){
if(_383.width){
opts.width=_383.width;
}
if(_383.height){
opts.height=_383.height;
}
}
if(opts.fit==true){
var p=_384.panel("panel").parent();
opts.width=p.width();
opts.height=p.height();
}
_384.panel("resize",{width:opts.width,height:opts.height});
};
function _385(_386){
var opts=$.data(_386,"datagrid").options;
var wrap=$.data(_386,"datagrid").panel;
var _387=wrap.width();
var _388=wrap.height();
var view=wrap.children("div.datagrid-view");
var _389=view.children("div.datagrid-view1");
var _38a=view.children("div.datagrid-view2");
...
view.width(_387);
var _38f=_38b.children("div.datagrid-header-inner").show();
_389.width(_38f.find("table").width());
if(!opts.showHeader){
_38f.hide();
}
_38a.width(_387-_389.outerWidth());
...
_38d.css("height","");
_38e.css("height","");
hh=Math.max(_38d.height(),_38e.height());
_38d.height(hh);
_38e.height(hh);
if($.boxModel==true){
...
if(opts.height!="auto"){
var _390=_388-_38a.children("div.datagrid-header").outerHeight(true)-_38a.children("div.datagrid-footer").outerHeight(true)-wrap.children("div.datagrid-toolbar").outerHeight(true)-wrap.children("div.datagrid-pager").outerHeight(true);
_389.children("div.datagrid-body").height(_390);
_38a.children("div.datagrid-body").height(_390);
}
view.height(_38a.height());
_38a.css("left",_389.outerWidth());
};
function _391(_392,_393){
var rows=$.data(_392,"datagrid").data.rows;
var opts=$.data(_392,"datagrid").options;
var _394=$.data(_392,"datagrid").panel;
var view=_394.children("div.datagrid-view");
var _395=view.children("div.datagrid-view1");
var _396=view.children("div.datagrid-view2");
if(!_395.find("div.datagrid-body-inner").is(":empty")){
if(_393>=0){
_397(_393);
}else{
...
if(opts.showFooter){
var _398=$(_392).datagrid("getFooterRows");
var c1=_395.children("div.datagrid-footer");
var c2=_396.children("div.datagrid-footer");
...
if(opts.height=="auto"){
var _399=_395.children("div.datagrid-body");
var _39a=_396.children("div.datagrid-body");
var _39b=0;
var _39c=0;
_39a.children().each(function(){
var c=$(this);
if(c.is(":visible")){
_39b+=c.outerHeight();
if(_39c<c.outerWidth()){
_39c=c.outerWidth();
}
}
});
...
_399.height(_39b);
_39a.height(_39b);
view.height(_396.height());
}
_396.children("div.datagrid-body").triggerHandler("scroll");
function _397(_39d,c1,c2){
c1=c1||_395;
c2=c2||_396;
var tr1=c1.find("tr[datagrid-row-index="+_39d+"]");
var tr2=c2.find("tr[datagrid-row-index="+_39d+"]");
tr1.css("height","");
tr2.css("height","");
var _39e=Math.max(tr1.height(),tr2.height());
tr1.css("height",_39e);
tr2.css("height",_39e);
};
};
...
var _3a5=$("<div class=\"datagrid-wrap\">"+"<div class=\"datagrid-view\">"+"<div class=\"datagrid-view1\">"+"<div class=\"datagrid-header\">"+"<div class=\"datagrid-header-inner\"></div>"+"</div>"+"<div class=\"datagrid-body\">"+"<div class=\"datagrid-body-inner\"></div>"+"</div>"+"<div class=\"datagrid-footer\">"+"<div class=\"datagrid-footer-inner\"></div>"+"</div>"+"</div>"+"<div class=\"datagrid-view2\">"+"<div class=\"datagrid-header\">"+"<div class=\"datagrid-header-inner\"></div>"+"</div>"+"<div class=\"datagrid-body\"></div>"+"<div class=\"datagrid-footer\">"+"<div class=\"datagrid-footer-inner\"></div>"+"</div>"+"</div>"+"<div class=\"datagrid-resize-proxy\"></div>"+"</div>"+"</div>").insertAfter(_3a0);
_3a5.panel({doSize:false});
_3a5.panel("panel").addClass("datagrid").bind("_resize",function(e,_3a6){
var opts=$.data(_3a0,"datagrid").options;
if(opts.fit==true||_3a6){
_381(_3a0);
setTimeout(function(){
_3a7(_3a0);
},0);
...
$(_3a0).hide().appendTo(_3a5.children("div.datagrid-view"));
var _3a8=_3a2($("thead[frozen=true]",_3a0));
var _3a9=_3a2($("thead[frozen!=true]",_3a0));
return {panel:_3a5,frozenColumns:_3a8,columns:_3a9};
};
function _3aa(_3ab){
var data={total:0,rows:[]};
var _3ac=_3ad(_3ab,true).concat(_3ad(_3ab,false));
$(_3ab).find("tbody tr").each(function(){
data.total++;
var col={};
for(var i=0;i<_3ac.length;i++){
col[_3ac[i]]=$("td:eq("+i+")",this).html();
}
data.rows.push(col);
});
return data;
...
_3b0.panel($.extend({},opts,{doSize:false,onResize:function(_3b1,_3b2){
setTimeout(function(){
_385(_3af);
_3d9(_3af);
opts.onResize.call(_3b0,_3b1,_3b2);
},0);
},onExpand:function(){
_385(_3af);
_391(_3af);
opts.onExpand.call(_3b0);
}}));
var view=_3b0.children("div.datagrid-view");
var _3b3=view.children("div.datagrid-view1");
var _3b4=view.children("div.datagrid-view2");
var _3b5=_3b3.children("div.datagrid-header").children("div.datagrid-header-inner");
var _3b6=_3b4.children("div.datagrid-header").children("div.datagrid-header-inner");
_3b7(_3b5,opts.frozenColumns,true);
_3b7(_3b6,opts.columns,false);
_3b5.css("display",opts.showHeader?"block":"none");
_3b6.css("display",opts.showHeader?"block":"none");
_3b3.find("div.datagrid-footer-inner").css("display",opts.showFooter?"block":"none");
_3b4.find("div.datagrid-footer-inner").css("display",opts.showFooter?"block":"none");
$("div.datagrid-toolbar",_3b0).remove();
if(opts.toolbar){
var tb=$("<div class=\"datagrid-toolbar\"></div>").prependTo(_3b0);
for(var i=0;i<opts.toolbar.length;i++){
...
$("div.datagrid-pager",_3b0).remove();
if(opts.pagination){
var _3b8=$("<div class=\"datagrid-pager\"></div>").appendTo(_3b0);
_3b8.pagination({pageNumber:opts.pageNumber,pageSize:opts.pageSize,pageList:opts.pageList,onSelectPage:function(_3b9,_3ba){
opts.pageNumber=_3b9;
opts.pageSize=_3ba;
_477(_3af);
}});
opts.pageSize=_3b8.pagination("options").pageSize;
}
function _3b7(_3bb,_3bc,_3bd){
if(!_3bc){
return;
}
$(_3bb).show();
$(_3bb).empty();
var t=$("<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\"><tbody></tbody></table>").appendTo(_3bb);
...
function _3be(_3bf){
var _3c0=$.data(_3bf,"datagrid").panel;
var opts=$.data(_3bf,"datagrid").options;
var data=$.data(_3bf,"datagrid").data;
var body=_3c0.find("div.datagrid-body");
body.find("tr[datagrid-row-index]").unbind(".datagrid").bind("mouseenter.datagrid",function(){
var _3c1=$(this).attr("datagrid-row-index");
body.find("tr[datagrid-row-index="+_3c1+"]").addClass("datagrid-row-over");
}).bind("mouseleave.datagrid",function(){
var _3c2=$(this).attr("datagrid-row-index");
body.find("tr[datagrid-row-index="+_3c2+"]").removeClass("datagrid-row-over");
...
if(opts.onClickRow){
opts.onClickRow.call(_3bf,_3c3,data.rows[_3c3]);
}
}).bind("dblclick.datagrid",function(){
var _3c4=$(this).attr("datagrid-row-index");
if(opts.onDblClickRow){
opts.onDblClickRow.call(_3bf,_3c4,data.rows[_3c4]);
}
}).bind("contextmenu.datagrid",function(e){
var _3c5=$(this).attr("datagrid-row-index");
if(opts.onRowContextMenu){
opts.onRowContextMenu.call(_3bf,e,_3c5,data.rows[_3c5]);
}
});
body.find("div.datagrid-cell-check input[type=checkbox]").unbind(".datagrid").bind("click.datagrid",function(e){
var _3c6=$(this).parent().parent().parent().attr("datagrid-row-index");
...
function _3ca(_3cb){
var _3cc=$.data(_3cb,"datagrid").panel;
var opts=$.data(_3cb,"datagrid").options;
var _3cd=_3cc.find("div.datagrid-header");
_3cd.find("td:has(div.datagrid-cell)").unbind(".datagrid").bind("mouseenter.datagrid",function(){
$(this).addClass("datagrid-header-over");
}).bind("mouseleave.datagrid",function(){
$(this).removeClass("datagrid-header-over");
}).bind("contextmenu.datagrid",function(e){
var _3ce=$(this).attr("field");
opts.onHeaderContextMenu.call(_3cb,e,_3ce);
});
_3cd.find("div.datagrid-cell").unbind(".datagrid").bind("click.datagrid",function(){
var _3cf=$(this).parent().attr("field");
var opt=_3d7(_3cb,_3cf);
if(!opt.sortable){
return;
}
opts.sortName=_3cf;
...
_3cd.find("div.datagrid-cell").removeClass("datagrid-sort-asc datagrid-sort-desc");
$(this).addClass(c);
if(opts.onSortColumn){
opts.onSortColumn.call(_3cb,opts.sortName,opts.sortOrder);
}
if(opts.remoteSort){
_477(_3cb);
}else{
var data=$.data(_3cb,"datagrid").data;
_3fb(_3cb,data);
}
});
_3cd.find("input[type=checkbox]").unbind(".datagrid").bind("click.datagrid",function(){
if(opts.singleSelect){
return false;
}
if($(this).attr("checked")){
...
_3d1.children("div.datagrid-body").unbind(".datagrid").bind("scroll.datagrid",function(){
_3d0.children("div.datagrid-body").scrollTop($(this).scrollTop());
_3d1.children("div.datagrid-header").scrollLeft($(this).scrollLeft());
_3d1.children("div.datagrid-footer").scrollLeft($(this).scrollLeft());
});
_3cd.find("div.datagrid-cell").resizable({handles:"e",minWidth:25,onStartResize:function(e){
var _3d2=view.children("div.datagrid-resize-proxy");
_3d2.css({left:e.pageX-$(_3cc).offset().left-1});
_3d2.css("display","block");
},onResize:function(e){
var _3d3=view.children("div.datagrid-resize-proxy");
_3d3.css({display:"block",left:e.pageX-$(_3cc).offset().left-1});
return false;
},onStopResize:function(e){
var _3d4=$(this).parent().attr("field");
var col=_3d7(_3cb,_3d4);
col.width=$(this).outerWidth();
col.boxWidth=$.boxModel==true?$(this).width():$(this).outerWidth();
_3a7(_3cb,_3d4);
_3d9(_3cb);
var _3d5=_3cc.find("div.datagrid-view2");
_3d5.find("div.datagrid-header").scrollLeft(_3d5.find("div.datagrid-body").scrollLeft());
view.children("div.datagrid-resize-proxy").css("display","none");
opts.onResizeColumn.call(_3cb,_3d4,col.width);
}});
$("div.datagrid-header div.datagrid-cell",_3d0).resizable({onStopResize:function(e){
var _3d6=$(this).parent().attr("field");
var col=_3d7(_3cb,_3d6);
col.width=$(this).outerWidth();
col.boxWidth=$.boxModel==true?$(this).width():$(this).outerWidth();
_3a7(_3cb,_3d6);
var _3d8=_3cc.find("div.datagrid-view2");
_3d8.find("div.datagrid-header").scrollLeft(_3d8.find("div.datagrid-body").scrollLeft());
view.children("div.datagrid-resize-proxy").css("display","none");
_385(_3cb);
opts.onResizeColumn.call(_3cb,_3d6,col.width);
}});
};
function _3d9(_3da){
...
var _3dc=_3db.find("div.datagrid-view2 div.datagrid-header");
var _3dd=0;
var _3de=_3ad(_3da,false);
for(var i=0;i<_3de.length;i++){
var col=_3d7(_3da,_3de[i]);
if(!col.hidden&&!col.checkbox){
_3dd+=col.width;
}
}
var _3df=_3dc.children("div.datagrid-header-inner").show();
var rate=(_3dc.width()-_3dc.find("table").width()-18)/_3dd;
if(!opts.showHeader){
_3df.hide();
}
for(var i=0;i<_3de.length;i++){
var col=_3d7(_3da,_3de[i]);
var _3e0=col.width-col.boxWidth;
var _3e1=Math.floor(col.width+col.width*rate);
col.width=_3e1;
col.boxWidth=_3e1-_3e0;
_3dc.find("td[field="+col.field+"] div.datagrid-cell").width(col.boxWidth);
}
_3a7(_3da);
};
function _3a7(_3e2,_3e3){
var _3e4=$.data(_3e2,"datagrid").panel;
var bf=_3e4.find("div.datagrid-body,div.datagrid-footer");
if(_3e3){
fix(_3e3);
}else{
_3e4.find("div.datagrid-header td[field]").each(function(){
fix($(this).attr("field"));
});
}
_3e7(_3e2);
...
function fix(_3e5){
var col=_3d7(_3e2,_3e5);
bf.find("td[field="+_3e5+"]").each(function(){
var td=$(this);
...
function _3e7(_3e8){
var _3e9=$.data(_3e8,"datagrid").panel;
var _3ea=_3e9.find("div.datagrid-header");
_3e9.find("div.datagrid-body td.datagrid-td-merged").each(function(){
var td=$(this);
var _3eb=td.attr("colspan")||1;
var _3ec=td.attr("field");
var _3ed=_3ea.find("td[field="+_3ec+"]");
var _3ee=_3ed.width();
for(var i=1;i<_3eb;i++){
_3ed=_3ed.next();
_3ee+=_3ed.outerWidth();
}
var cell=td.children("div.datagrid-cell");
if($.boxModel==true){
cell.width(_3ee-(cell.outerWidth()-cell.width()));
}else{
cell.width(_3ee);
}
});
...
_3f1.find("div.datagrid-editable").each(function(){
...
function _3ad(_3f4,_3f5){
var opts=$.data(_3f4,"datagrid").options;
var _3f6=(_3f5==true)?(opts.frozenColumns||[[]]):opts.columns;
if(_3f6.length==0){
return [];
}
var _3f7=[];
...
function _3fb(_3fc,data){
var opts=$.data(_3fc,"datagrid").options;
var wrap=$.data(_3fc,"datagrid").panel;
var _3fd=$.data(_3fc,"datagrid").selectedRows;
var rows=data.rows;
$.data(_3fc,"datagrid").data=data;
if(data.footer){
$.data(_3fc,"datagrid").footer=data.footer;
}
if(!opts.remoteSort){
var opt=_3d7(_3fc,opts.sortName);
if(opt){
var _3fe=opt.sorter||function(a,b){
return (a>b?1:-1);
};
data.rows.sort(function(r1,r2){
return _3fe(r1[opts.sortName],r2[opts.sortName])*(opts.sortOrder=="asc"?1:-1);
});
}
}
var view=wrap.children("div.datagrid-view");
var _3ff=view.children("div.datagrid-view1");
var _400=view.children("div.datagrid-view2");
if(opts.view.onBeforeRender){
opts.view.onBeforeRender.call(opts.view,_3fc,rows);
}
opts.view.render.call(opts.view,_3fc,_400.children("div.datagrid-body"),false);
opts.view.render.call(opts.view,_3fc,_3ff.children("div.datagrid-body").children("div.datagrid-body-inner"),true);
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,_3fc,_400.find("div.datagrid-footer-inner"),false);
opts.view.renderFooter.call(opts.view,_3fc,_3ff.find("div.datagrid-footer-inner"),true);
}
if(opts.view.onAfterRender){
opts.view.onAfterRender.call(opts.view,_3fc);
}
opts.onLoadSuccess.call(_3fc,data);
var _401=wrap.children("div.datagrid-pager");
if(_401.length){
if(_401.pagination("options").total!=data.total){
_401.pagination({total:data.total});
}
}
_391(_3fc);
_3be(_3fc);
_400.children("div.datagrid-body").triggerHandler("scroll");
if(opts.idField){
for(var i=0;i<rows.length;i++){
if(_402(rows[i])){
_41c(_3fc,rows[i][opts.idField]);
}
}
}
function _402(row){
...
function _403(_404,row){
var opts=$.data(_404,"datagrid").options;
var rows=$.data(_404,"datagrid").data.rows;
...
var _407=$.data(_406,"datagrid").panel;
var data=$.data(_406,"datagrid").data;
if(opts.idField){
return $.data(_406,"datagrid").selectedRows;
}else{
var rows=[];
$("div.datagrid-view2 div.datagrid-body tr.datagrid-row-selected",_407).each(function(){
var _408=parseInt($(this).attr("datagrid-row-index"));
rows.push(data.rows[_408]);
});
return rows;
}
};
...
for(var _410=0;_410<rows.length;_410++){
if(opts.idField){
(function(){
var row=rows[_410];
for(var i=0;i<_40f.length;i++){
if(_40f[i][opts.idField]==row[opts.idField]){
return;
}
}
_40f.push(row);
...
opts.onSelectAll.call(_40d,rows);
};
function _40a(_411){
var opts=$.data(_411,"datagrid").options;
var _412=$.data(_411,"datagrid").panel;
var data=$.data(_411,"datagrid").data;
var _413=$.data(_411,"datagrid").selectedRows;
$("div.datagrid-body tr.datagrid-row-selected",_412).removeClass("datagrid-row-selected");
$("div.datagrid-body div.datagrid-cell-check input[type=checkbox]",_412).attr("checked",false);
if(opts.idField){
for(var _414=0;_414<data.rows.length;_414++){
_413.removeById(opts.idField,data.rows[_414][opts.idField]);
}
}
opts.onUnselectAll.call(_411,data.rows);
};
function _3c8(_415,_416){
var _417=$.data(_415,"datagrid").panel;
var opts=$.data(_415,"datagrid").options;
var data=$.data(_415,"datagrid").data;
var _418=$.data(_415,"datagrid").selectedRows;
if(_416<0||_416>=data.rows.length){
return;
}
if(opts.singleSelect==true){
_3c7(_415);
}
var tr=$("div.datagrid-body tr[datagrid-row-index="+_416+"]",_417);
if(!tr.hasClass("datagrid-row-selected")){
tr.addClass("datagrid-row-selected");
var ck=$("div.datagrid-cell-check input[type=checkbox]",tr);
ck.attr("checked",true);
if(opts.idField){
var row=data.rows[_416];
(function(){
for(var i=0;i<_418.length;i++){
if(_418[i][opts.idField]==row[opts.idField]){
return;
}
}
_418.push(row);
...
opts.onSelect.call(_415,_416,data.rows[_416]);
var _419=_417.find("div.datagrid-view2");
var _41a=_419.find("div.datagrid-header").outerHeight();
var _41b=_419.find("div.datagrid-body");
var top=tr.position().top-_41a;
if(top<=0){
_41b.scrollTop(_41b.scrollTop()+top);
}else{
if(top+tr.outerHeight()>_41b.height()-18){
_41b.scrollTop(_41b.scrollTop()+top+tr.outerHeight()-_41b.height()+18);
}
}
};
...
if(data.rows[i][opts.idField]==_41e){
_41f=i;
break;
}
}
...
var body=_422.find("div.datagrid-body");
var tr=$("tr[datagrid-row-index="+_421+"]",body);
var ck=$("tr[datagrid-row-index="+_421+"] div.datagrid-cell-check input[type=checkbox]",body);
tr.removeClass("datagrid-row-selected");
ck.attr("checked",false);
var row=data.rows[_421];
if(opts.idField){
_423.removeById(opts.idField,row[opts.idField]);
}
opts.onUnselect.call(_420,_421,row);
};
...
if(opts.onBeforeEdit.call(_425,_426,data.rows[_426])==false){
return;
}
tr.addClass("datagrid-row-editing");
_428(_425,_426);
_3ef(_425);
_429(_425,_426,data.rows[_426]);
_42a(_425,_426);
};
function _42b(_42c,_42d,_42e){
var opts=$.data(_42c,"datagrid").options;
var _42f=$.data(_42c,"datagrid").panel;
var data=$.data(_42c,"datagrid").data;
var _430=$.data(_42c,"datagrid").updatedRows;
var _431=$.data(_42c,"datagrid").insertedRows;
var row=data.rows[_42d];
var tr=$("div.datagrid-body tr[datagrid-row-index="+_42d+"]",_42f);
if(!tr.hasClass("datagrid-row-editing")){
return;
}
if(!_42e){
...
_436(_42c,_42d);
$(_42c).datagrid("refreshRow",_42d);
if(!_42e){
opts.onAfterEdit.call(_42c,_42d,row,_433);
}else{
opts.onCancelEdit.call(_42c,_42d,row);
}
};
function _429(_437,_438,data){
...
var _43a=$(this).parent().attr("field");
var ed=$.data(this,"datagrid.editor");
ed.actions.setValue(ed.target,data[_43a]);
});
};
function _434(_43b,_43c){
var _43d=$.data(_43b,"datagrid").panel;
var tr=$("div.datagrid-body tr[datagrid-row-index="+_43c+"]",_43d);
if(!tr.hasClass("datagrid-row-editing")){
return {};
}
var data={};
tr.find("div.datagrid-editable").each(function(){
var _43e=$(this).parent().attr("field");
var ed=$.data(this,"datagrid.editor");
data[_43e]=ed.actions.getValue(ed.target);
});
return data;
};
function _43f(_440,_441){
var _442=[];
var _443=$.data(_440,"datagrid").panel;
var tr=$("div.datagrid-body tr[datagrid-row-index="+_441+"]",_443);
...
var _447=_43f(_445,_446.index);
for(var i=0;i<_447.length;i++){
if(_447[i].field==_446.field){
return _447[i];
}
}
return null;
};
function _428(_448,_449){
var opts=$.data(_448,"datagrid").options;
var _44a=$.data(_448,"datagrid").panel;
var tr=$("div.datagrid-body tr[datagrid-row-index="+_449+"]",_44a);
tr.children("td").each(function(){
var cell=$(this).find("div.datagrid-cell");
var _44b=$(this).attr("field");
var col=_3d7(_448,_44b);
if(col&&col.editor){
var _44c,_44d;
...
if(_44e){
var _44f=cell.outerWidth();
cell.addClass("datagrid-editable");
if($.boxModel==true){
cell.width(_44f-(cell.outerWidth()-cell.width()));
}
cell.html("<table border=\"0\" cellspacing=\"0\" cellpadding=\"1\"><tr><td></td></tr></table>");
cell.find("table").attr("align",col.align);
$.data(cell[0],"datagrid.editor",{actions:_44e,target:_44e.init(cell.find("td"),_44d),field:_44b,type:_44c});
}
}
});
_391(_448,_449);
};
function _436(_450,_451){
var _452=$.data(_450,"datagrid").panel;
var tr=$("div.datagrid-body tr[datagrid-row-index="+_451+"]",_452);
tr.children("td").each(function(){
var cell=$(this).find("div.datagrid-editable");
if(cell.length){
var ed=$.data(cell[0],"datagrid.editor");
...
function _42a(_454,_455){
var _456=$.data(_454,"datagrid").panel;
var tr=$("div.datagrid-body tr[datagrid-row-index="+_455+"]",_456);
if(!tr.hasClass("datagrid-row-editing")){
return true;
}
...
var _457=tr.find(".validatebox-invalid");
return _457.length==0;
};
function _458(_459,_45a){
var _45b=$.data(_459,"datagrid").insertedRows;
var _45c=$.data(_459,"datagrid").deletedRows;
var _45d=$.data(_459,"datagrid").updatedRows;
if(!_45a){
var rows=[];
rows=rows.concat(_45b);
rows=rows.concat(_45c);
rows=rows.concat(_45d);
return rows;
}else{
if(_45a=="inserted"){
return _45b;
...
var _463=$.data(_45f,"datagrid").selectedRows;
$(_45f).datagrid("cancelEdit",_460);
var row=data.rows[_460];
if(_461.indexOf(row)>=0){
_461.remove(row);
}else{
_462.push(row);
}
_463.removeById(opts.idField,data.rows[_460][opts.idField]);
opts.view.deleteRow.call(opts.view,_45f,_460);
if(opts.height=="auto"){
_391(_45f);
}
};
function _464(_465,_466){
var view=$.data(_465,"datagrid").options.view;
var _467=$.data(_465,"datagrid").insertedRows;
view.insertRow.call(view,_465,_466.index,_466.row);
_3be(_465);
_467.push(_466.row);
};
function _468(_469,row){
var view=$.data(_469,"datagrid").options.view;
var _46a=$.data(_469,"datagrid").insertedRows;
view.insertRow.call(view,_469,null,row);
_3be(_469);
_46a.push(row);
};
function _46b(_46c){
var data=$.data(_46c,"datagrid").data;
var rows=data.rows;
var _46d=[];
for(var i=0;i<rows.length;i++){
_46d.push($.extend({},rows[i]));
}
$.data(_46c,"datagrid").originalRows=_46d;
$.data(_46c,"datagrid").updatedRows=[];
$.data(_46c,"datagrid").insertedRows=[];
$.data(_46c,"datagrid").deletedRows=[];
};
function _46e(_46f){
...
var _472=$.data(_471,"datagrid").originalRows;
var _473=$.data(_471,"datagrid").insertedRows;
var _474=$.data(_471,"datagrid").deletedRows;
var _475=$.data(_471,"datagrid").selectedRows;
...
_476.push(_475[i][opts.idField]);
}
_475.splice(0,_475.length);
data.total+=_474.length-_473.length;
data.rows=_472;
_3fb(_471,data);
...
var _47a=$.data(_478,"datagrid").panel;
var opts=$.data(_478,"datagrid").options;
if(_479){
opts.queryParams=_479;
}
if(!opts.url){
return;
}
var _47b=$.extend({},opts.queryParams);
if(opts.pagination){
$.extend(_47b,{page:opts.pageNumber,rows:opts.pageSize});
}
if(opts.sortName){
$.extend(_47b,{sort:opts.sortName,order:opts.sortOrder});
}
if(opts.onBeforeLoad.call(_478,_47b)==false){
return;
}
_47c();
setTimeout(function(){
...
function _47d(){
$.ajax({type:opts.method,url:opts.url,data:_47b,dataType:"json",success:function(data){
setTimeout(function(){
_47e();
},0);
_3fb(_478,data);
...
if(opts.onLoadError){
opts.onLoadError.apply(_478,arguments);
}
}});
};
function _47c(){
_47a.children("div.datagrid-pager").pagination("loading");
if(opts.loadMsg){
var wrap=_47a;
...
function _47e(){
_47a.find("div.datagrid-pager").pagination("loaded");
_47a.find("div.datagrid-mask-msg").remove();
_47a.find("div.datagrid-mask").remove();
};
};
function _47f(_480,_481){
var rows=$.data(_480,"datagrid").data.rows;
var _482=$.data(_480,"datagrid").panel;
_481.rowspan=_481.rowspan||1;
_481.colspan=_481.colspan||1;
if(_481.index<0||_481.index>=rows.length){
return;
}
if(_481.rowspan==1&&_481.colspan==1){
return;
}
var _483=rows[_481.index][_481.field];
var tr=_482.find("div.datagrid-body tr[datagrid-row-index="+_481.index+"]");
var td=tr.find("td[field="+_481.field+"]");
td.attr("rowspan",_481.rowspan).attr("colspan",_481.colspan);
td.addClass("datagrid-td-merged");
for(var i=1;i<_481.colspan;i++){
td=td.next();
td.hide();
rows[_481.index][td.attr("field")]=_483;
}
for(var i=1;i<_481.rowspan;i++){
tr=tr.next();
var td=tr.find("td[field="+_481.field+"]").hide();
rows[_481.index+i][td.attr("field")]=_483;
for(var j=1;j<_481.colspan;j++){
td=td.next();
td.hide();
rows[_481.index+i][td.attr("field")]=_483;
}
...
$.fn.datagrid=function(_484,_485){
if(typeof _484=="string"){
return $.fn.datagrid.methods[_484](this,_485);
}
_484=_484||{};
return this.each(function(){
var _486=$.data(this,"datagrid");
var opts;
if(_486){
opts=$.extend(_486.options,_484);
_486.options=opts;
}else{
opts=$.extend({},$.fn.datagrid.defaults,$.fn.datagrid.parseOptions(this),_484);
$(this).css("width","").css("height","");
var _487=_39f(this,opts.rownumbers);
if(!opts.columns){
opts.columns=_487.columns;
}
if(!opts.frozenColumns){
opts.frozenColumns=_487.frozenColumns;
}
$.data(this,"datagrid",{options:opts,panel:_487.panel,selectedRows:[],data:{total:0,rows:[]},originalRows:[],updatedRows:[],insertedRows:[],deletedRows:[]});
}
_3ae(this);
if(!_486){
var data=_3aa(this);
...
var _488={text:{init:function(_489,_48a){
var _48b=$("<input type=\"text\" class=\"datagrid-editable-input\">").appendTo(_489);
return _48b;
...
}},textarea:{init:function(_492,_493){
var _494=$("<textarea class=\"datagrid-editable-input\"></textarea>").appendTo(_492);
return _494;
},getValue:function(_495){
return $(_495).val();
},setValue:function(_496,_497){
$(_496).val(_497);
},resize:function(_498,_499){
var _49a=$(_498);
if($.boxModel==true){
_49a.width(_499-(_49a.outerWidth()-_49a.width()));
}else{
_49a.width(_499);
}
}},checkbox:{init:function(_49b,_49c){
var _49d=$("<input type=\"checkbox\">").appendTo(_49b);
_49d.val(_49c.on);
_49d.attr("offval",_49c.off);
return _49d;
},getValue:function(_49e){
if($(_49e).attr("checked")){
return $(_49e).val();
}else{
return $(_49e).attr("offval");
}
},setValue:function(_49f,_4a0){
if($(_49f).val()==_4a0){
$(_49f).attr("checked",true);
}else{
$(_49f).attr("checked",false);
}
}},numberbox:{init:function(_4a1,_4a2){
...
}},datebox:{init:function(_4b4,_4b5){
var _4b6=$("<input type=\"text\">").appendTo(_4b4);
_4b6.datebox(_4b5);
return _4b6;
},destroy:function(_4b7){
$(_4b7).datebox("destroy");
},getValue:function(_4b8){
return $(_4b8).datebox("getValue");
},setValue:function(_4b9,_4ba){
$(_4b9).datebox("setValue",_4ba);
},resize:function(_4bb,_4bc){
$(_4bb).datebox("resize",_4bc);
}},combobox:{init:function(_4bd,_4be){
var _4bf=$("<input type=\"text\">").appendTo(_4bd);
_4bf.combobox(_4be||{});
return _4bf;
},destroy:function(_4c0){
$(_4c0).combobox("destroy");
},getValue:function(_4c1){
return $(_4c1).combobox("getValue");
},setValue:function(_4c2,_4c3){
$(_4c2).combobox("setValue",_4c3);
},resize:function(_4c4,_4c5){
$(_4c4).combobox("resize",_4c5);
}},combotree:{init:function(_4c6,_4c7){
var _4c8=$("<input type=\"text\">").appendTo(_4c6);
_4c8.combotree(_4c7);
return _4c8;
},destroy:function(_4c9){
$(_4c9).combotree("destroy");
},getValue:function(_4ca){
return $(_4ca).combotree("getValue");
},setValue:function(_4cb,_4cc){
$(_4cb).combotree("setValue",_4cc);
},resize:function(_4cd,_4ce){
$(_4cd).combotree("resize",_4ce);
}}};
$.fn.datagrid.methods={options:function(jq){
var _4cf=$.data(jq[0],"datagrid").options;
var _4d0=$.data(jq[0],"datagrid").panel.panel("options");
var opts=$.extend(_4cf,{width:_4d0.width,height:_4d0.height,closed:_4d0.closed,collapsed:_4d0.collapsed,minimized:_4d0.minimized,maximized:_4d0.maximized});
var _4d1=jq.datagrid("getPager");
if(_4d1.length){
var _4d2=_4d1.pagination("options");
$.extend(opts,{pageNumber:_4d2.pageNumber,pageSize:_4d2.pageSize});
}
return opts;
...
},getColumnFields:function(jq,_4d3){
return _3ad(jq[0],_4d3);
},getColumnOption:function(jq,_4d4){
return _3d7(jq[0],_4d4);
},resize:function(jq,_4d5){
return jq.each(function(){
_381(this,_4d5);
});
},load:function(jq,_4d6){
return jq.each(function(){
var opts=$(this).datagrid("options");
opts.pageNumber=1;
var _4d7=$(this).datagrid("getPager");
_4d7.pagination({pageNumber:1});
_477(this,_4d6);
});
},reload:function(jq,_4d8){
return jq.each(function(){
_477(this,_4d8);
});
},reloadFooter:function(jq,_4d9){
return jq.each(function(){
...
if(_4d9){
$.data(this,"datagrid").footer=_4d9;
}
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,this,_4db.find("div.datagrid-footer-inner"),false);
opts.view.renderFooter.call(opts.view,this,_4da.find("div.datagrid-footer-inner"),true);
if(opts.view.onAfterRender){
...
},unselectRow:function(jq,_4de){
return jq.each(function(){
_3c9(this,_4de);
});
},beginEdit:function(jq,_4df){
return jq.each(function(){
_424(this,_4df);
});
},endEdit:function(jq,_4e0){
return jq.each(function(){
_42b(this,_4e0,false);
});
},cancelEdit:function(jq,_4e1){
return jq.each(function(){
_42b(this,_4e1,true);
});
},getEditors:function(jq,_4e2){
return _43f(jq[0],_4e2);
},getEditor:function(jq,_4e3){
return _444(jq[0],_4e3);
},refreshRow:function(jq,_4e4){
return jq.each(function(){
var opts=$.data(this,"datagrid").options;
opts.view.refreshRow.call(opts.view,this,_4e4);
});
},validateRow:function(jq,_4e5){
return _42a(jq[0],_4e5);
...
},insertRow:function(_50b,_50c,row){
var opts=$.data(_50b,"datagrid").options;
var data=$.data(_50b,"datagrid").data;
var view=$(_50b).datagrid("getPanel").children("div.datagrid-view");
var _50d=view.children("div.datagrid-view1");
var _50e=view.children("div.datagrid-view2");
if(_50c==undefined||_50c==null){
_50c=data.rows.length;
}
if(_50c>data.rows.length){
_50c=data.rows.length;
}
for(var i=data.rows.length-1;i>=_50c;i--){
_50e.children("div.datagrid-body").find("tr[datagrid-row-index="+i+"]").attr("datagrid-row-index",i+1);
var tr=_50d.children("div.datagrid-body").find("tr[datagrid-row-index="+i+"]").attr("datagrid-row-index",i+1);
if(opts.rownumbers){
tr.find("div.datagrid-cell-rownumber").html(i+2);
}
}
var _50f=$(_50b).datagrid("getColumnFields",true);
var _510=$(_50b).datagrid("getColumnFields",false);
var tr1="<tr datagrid-row-index=\""+_50c+"\">"+this.renderRow.call(this,_50b,_50f,true,_50c,row)+"</tr>";
var tr2="<tr datagrid-row-index=\""+_50c+"\">"+this.renderRow.call(this,_50b,_510,false,_50c,row)+"</tr>";
if(_50c>=data.rows.length){
var _511=_50d.children("div.datagrid-body").children("div.datagrid-body-inner");
var _512=_50e.children("div.datagrid-body");
if(data.rows.length){
_511.find("tr:last[datagrid-row-index]").after(tr1);
_512.find("tr:last[datagrid-row-index]").after(tr2);
}else{
_511.html("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"+tr1+"</tbody></table>");
_512.html("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"+tr2+"</tbody></table>");
}
}else{
_50d.children("div.datagrid-body").find("tr[datagrid-row-index="+(_50c+1)+"]").before(tr1);
_50e.children("div.datagrid-body").find("tr[datagrid-row-index="+(_50c+1)+"]").before(tr2);
}
data.total+=1;
data.rows.splice(_50c,0,row);
this.refreshRow.call(this,_50b,_50c);
},deleteRow:function(_513,_514){
var opts=$.data(_513,"datagrid").options;
var data=$.data(_513,"datagrid").data;
var view=$(_513).datagrid("getPanel").children("div.datagrid-view");
var _515=view.children("div.datagrid-view1");
var _516=view.children("div.datagrid-view2");
_515.children("div.datagrid-body").find("tr[datagrid-row-index="+_514+"]").remove();
_516.children("div.datagrid-body").find("tr[datagrid-row-index="+_514+"]").remove();
for(var i=_514+1;i<data.rows.length;i++){
_516.children("div.datagrid-body").find("tr[datagrid-row-index="+i+"]").attr("datagrid-row-index",i-1);
var tr=_515.children("div.datagrid-body").find("tr[datagrid-row-index="+i+"]").attr("datagrid-row-index",i-1);
if(opts.rownumbers){
tr.find("div.datagrid-cell-rownumber").html(i);
}
}
data.total-=1;
data.rows.splice(_514,1);
},onBeforeRender:function(_517,rows){
},onAfterRender:function(_518){
var opts=$.data(_518,"datagrid").options;
if(opts.showFooter){
var _519=$(_518).datagrid("getPanel").find("div.datagrid-footer");
_519.find("div.datagrid-cell-rownumber,div.datagrid-cell-check").css("visibility","hidden");
}
}};
...
},editors:_488,view:_4ef,onBeforeLoad:function(_51c){
},onLoadSuccess:function(){
},onLoadError:function(){
},onClickRow:function(_51d,_51e){
},onDblClickRow:function(_51f,_520){
},onSortColumn:function(sort,_521){
},onResizeColumn:function(_522,_523){
},onSelect:function(_524,_525){
},onUnselect:function(_526,_527){
},onSelectAll:function(rows){
},onUnselectAll:function(rows){
},onBeforeEdit:function(_528,_529){
},onAfterEdit:function(_52a,_52b,_52c){
},onCancelEdit:function(_52d,_52e){
},onHeaderContextMenu:function(e,_52f){
},onRowContextMenu:function(e,_530,_531){
}});
})(jQuery);
(function($){
function _532(_533){
var opts=$.data(_533,"treegrid").options;
$(_533).datagrid($.extend({},opts,{url:null,onLoadSuccess:function(){
},onResizeColumn:function(_534,_535){
_536(_533);
opts.onResizeColumn.call(_533,_534,_535);
}}));
};
function _536(_537,_538){
var opts=$.data(_537,"datagrid").options;
var _539=$.data(_537,"datagrid").panel;
var view=_539.children("div.datagrid-view");
var _53a=view.children("div.datagrid-view1");
var _53b=view.children("div.datagrid-view2");
if(opts.rownumbers||(opts.frozenColumns&&opts.frozenColumns.length>0)){
if(_538){
_53c(_538);
_53b.find("tr[node-id="+_538+"]").next("tr.treegrid-tr-tree").find("tr[node-id]").each(function(){
_53c($(this).attr("node-id"));
});
}else{
_53b.find("tr[node-id]").each(function(){
_53c($(this).attr("node-id"));
});
if(opts.showFooter){
var _53d=$.data(_537,"datagrid").footer||[];
for(var i=0;i<_53d.length;i++){
_53c(_53d[i][opts.idField]);
}
$(_537).datagrid("resize");
}
}
}
if(opts.height=="auto"){
var _53e=_53a.children("div.datagrid-body");
var _53f=_53b.children("div.datagrid-body");
var _540=0;
var _541=0;
_53f.children().each(function(){
var c=$(this);
if(c.is(":visible")){
_540+=c.outerHeight();
if(_541<c.outerWidth()){
_541=c.outerWidth();
}
}
});
...
_53e.height(_540);
_53f.height(_540);
view.height(_53b.height());
}
_53b.children("div.datagrid-body").triggerHandler("scroll");
function _53c(_542){
var tr1=_53a.find("tr[node-id="+_542+"]");
var tr2=_53b.find("tr[node-id="+_542+"]");
tr1.css("height","");
tr2.css("height","");
var _543=Math.max(tr1.height(),tr2.height());
tr1.css("height",_543);
tr2.css("height",_543);
};
};
...
$(_545).datagrid("getPanel").find("div.datagrid-view1 div.datagrid-body div.datagrid-cell-rownumber").each(function(i){
$(this).html(i+1);
});
};
function _546(_547){
var opts=$.data(_547,"treegrid").options;
var _548=$(_547).datagrid("getPanel");
var body=_548.find("div.datagrid-body");
...
opts.onClickRow.call(_547,find(_547,id));
}).bind("dblclick.treegrid",function(){
var id=$(this).attr("node-id");
opts.onDblClickRow.call(_547,find(_547,id));
}).bind("contextmenu.treegrid",function(e){
var id=$(this).attr("node-id");
opts.onContextMenu.call(_547,e,find(_547,id));
});
...
var _549=_548.find("div.datagrid-header");
_549.find("input[type=checkbox]").unbind().bind("click.treegrid",function(){
if(opts.singleSelect){
return false;
}
if($(this).attr("checked")){
...
var opts=$.data(_54d,"treegrid").options;
var view=$(_54d).datagrid("getPanel").children("div.datagrid-view");
var _54f=view.children("div.datagrid-view1");
var _550=view.children("div.datagrid-view2");
var tr1=_54f.children("div.datagrid-body").find("tr[node-id="+_54e+"]");
var tr2=_550.children("div.datagrid-body").find("tr[node-id="+_54e+"]");
var _551=$(_54d).datagrid("getColumnFields",true).length+(opts.rownumbers?1:0);
var _552=$(_54d).datagrid("getColumnFields",false).length;
_553(tr1,_551);
_553(tr2,_552);
function _553(tr,_554){
$("<tr class=\"treegrid-tr-tree\">"+"<td style=\"border:0px\" colspan=\""+_554+"\">"+"<div></div>"+"</td>"+"</tr>").insertAfter(tr);
};
};
function _555(_556,_557,data,_558){
var opts=$.data(_556,"treegrid").options;
var wrap=$.data(_556,"datagrid").panel;
var view=wrap.children("div.datagrid-view");
var _559=view.children("div.datagrid-view1");
var _55a=view.children("div.datagrid-view2");
var node=find(_556,_557);
if(node){
var _55b=_559.children("div.datagrid-body").find("tr[node-id="+_557+"]");
var _55c=_55a.children("div.datagrid-body").find("tr[node-id="+_557+"]");
var cc1=_55b.next("tr.treegrid-tr-tree").children("td").children("div");
var cc2=_55c.next("tr.treegrid-tr-tree").children("td").children("div");
}else{
var cc1=_559.children("div.datagrid-body").children("div.datagrid-body-inner");
var cc2=_55a.children("div.datagrid-body");
}
if(!_558){
$.data(_556,"treegrid").data=[];
cc1.empty();
cc2.empty();
}
if(opts.view.onBeforeRender){
opts.view.onBeforeRender.call(opts.view,_556,_557,data);
}
opts.view.render.call(opts.view,_556,cc1,true);
opts.view.render.call(opts.view,_556,cc2,false);
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,_556,_559.find("div.datagrid-footer-inner"),true);
opts.view.renderFooter.call(opts.view,_556,_55a.find("div.datagrid-footer-inner"),false);
}
if(opts.view.onAfterRender){
opts.view.onAfterRender.call(opts.view,_556);
}
opts.onLoadSuccess.call(_556,node,data);
_536(_556);
_544(_556);
_55d();
_546(_556);
function _55d(){
var _55e=view.find("div.datagrid-header");
var body=view.find("div.datagrid-body");
var _55f=_55e.find("div.datagrid-header-check");
if(_55f.length){
var ck=body.find("div.datagrid-cell-check");
if($.boxModel){
ck.width(_55f.width());
ck.height(_55f.height());
}else{
ck.width(_55f.outerWidth());
ck.height(_55f.outerHeight());
}
}
};
};
function _560(_561,_562,_563,_564,_565){
var opts=$.data(_561,"treegrid").options;
var body=$(_561).datagrid("getPanel").find("div.datagrid-body");
if(_563){
opts.queryParams=_563;
}
var _566=$.extend({},opts.queryParams);
var row=find(_561,_562);
if(opts.onBeforeLoad.call(_561,row,_566)==false){
return;
}
if(!opts.url){
return;
}
var _567=body.find("tr[node-id="+_562+"] span.tree-folder");
_567.addClass("tree-loading");
$.ajax({type:opts.method,url:opts.url,data:_566,dataType:"json",success:function(data){
_567.removeClass("tree-loading");
_555(_561,_562,data,_564);
if(_565){
_565();
}
},error:function(){
_567.removeClass("tree-loading");
opts.onLoadError.apply(_561,arguments);
if(_565){
_565();
}
}});
...
function _56a(_56b){
return $.data(_56b,"treegrid").data;
};
function _56c(_56d,_56e){
var row=find(_56d,_56e);
if(row._parentId){
return find(_56d,row._parentId);
}else{
return null;
}
};
...
var body=$(_570).datagrid("getPanel").find("div.datagrid-view2 div.datagrid-body");
var _572=[];
if(_571){
_573(_571);
}else{
...
_572.push(_574[i]);
_573(_574[i][opts.idField]);
}
}
function _573(_575){
var _576=find(_570,_575);
if(_576&&_576.children){
for(var i=0,len=_576.children.length;i<len;i++){
var _577=_576.children[i];
_572.push(_577);
_573(_577[opts.idField]);
}
}
};
return _572;
...
function _57a(_57b){
var rows=[];
var _57c=$(_57b).datagrid("getPanel");
_57c.find("div.datagrid-view2 div.datagrid-body tr.datagrid-row-selected").each(function(){
var id=$(this).attr("node-id");
rows.push(find(_57b,id));
});
return rows;
};
...
var view=$(_57e).datagrid("getPanel").children("div.datagrid-view");
var node=view.find("div.datagrid-body tr[node-id="+_57f+"]").children("td[field="+opts.treeField+"]");
return node.find("span.tree-indent,span.tree-hit").length;
};
function find(_580,_581){
var opts=$.data(_580,"treegrid").options;
var data=$.data(_580,"treegrid").data;
var cc=[data];
while(cc.length){
var c=cc.shift();
for(var i=0;i<c.length;i++){
var node=c[i];
if(node[opts.idField]==_581){
return node;
}else{
if(node["children"]){
...
var tr=body.find("tr[node-id="+_584+"]");
tr.addClass("datagrid-row-selected");
...
function _54a(_588){
var tr=$(_588).datagrid("getPanel").find("div.datagrid-body tr[node-id]");
tr.addClass("datagrid-row-selected");
tr.find("div.datagrid-cell-check input[type=checkbox]").attr("checked",true);
};
function _54b(_589){
var tr=$(_589).datagrid("getPanel").find("div.datagrid-body tr[node-id]");
tr.removeClass("datagrid-row-selected");
tr.find("div.datagrid-cell-check input[type=checkbox]").attr("checked",false);
};
...
if(opts.onBeforeCollapse.call(_58b,row)==false){
return;
}
hit.removeClass("tree-expanded tree-expanded-hover").addClass("tree-collapsed");
hit.next().removeClass("tree-folder-open");
...
if(opts.onBeforeExpand.call(_58e,row)==false){
return;
}
hit.removeClass("tree-collapsed tree-collapsed-hover").addClass("tree-expanded");
hit.next().addClass("tree-folder-open");
var _590=tr.next("tr.treegrid-tr-tree");
if(_590.length){
var cc=_590.children("td").children("div");
_591(cc);
}else{
_54c(_58e,row[opts.idField]);
var _590=tr.next("tr.treegrid-tr-tree");
var cc=_590.children("td").children("div");
cc.hide();
_560(_58e,row[opts.idField],{id:row[opts.idField]},true,function(){
_591(cc);
});
}
function _591(cc){
...
var _598=_56f(_596,_597);
if(_597){
_598.unshift(find(_596,_597));
}
for(var i=0;i<_598.length;i++){
_58a(_596,_598[i][opts.idField]);
}
};
function _599(_59a,_59b){
var opts=$.data(_59a,"treegrid").options;
var _59c=_56f(_59a,_59b);
if(_59b){
_59c.unshift(find(_59a,_59b));
}
for(var i=0;i<_59c.length;i++){
_58d(_59a,_59c[i][opts.idField]);
}
};
function _59d(_59e,_59f){
var opts=$.data(_59e,"treegrid").options;
var ids=[];
var p=_56c(_59e,_59f);
while(p){
...
var opts=$.data(_5a1,"treegrid").options;
if(_5a2.parent){
var body=$(_5a1).datagrid("getPanel").find("div.datagrid-body");
var tr=body.find("tr[node-id="+_5a2.parent+"]");
if(tr.next("tr.treegrid-tr-tree").length==0){
_54c(_5a1,_5a2.parent);
}
var cell=tr.children("td[field="+opts.treeField+"]").children("div.datagrid-cell");
var _5a3=cell.children("span.tree-icon");
if(_5a3.hasClass("tree-file")){
_5a3.removeClass("tree-file").addClass("tree-folder");
var hit=$("<span class=\"tree-hit tree-expanded\"></span>").insertBefore(_5a3);
if(hit.prev().length){
hit.prev().remove();
}
}
}
_555(_5a1,_5a2.parent,_5a2.data,true);
};
...
var _5a7=del(_5a6);
if(_5a7){
if(_5a7.children.length==0){
tr=body.find("tr[node-id="+_5a7[opts.treeField]+"]");
var cell=tr.children("td[field="+opts.treeField+"]").children("div.datagrid-cell");
...
function del(id){
var cc;
var _5a8=_56c(_5a5,_5a6);
if(_5a8){
cc=_5a8.children;
}else{
cc=$(_5a5).treegrid("getData");
}
for(var i=0;i<cc.length;i++){
...
$.fn.treegrid=function(_5a9,_5aa){
if(typeof _5a9=="string"){
return $.fn.treegrid.methods[_5a9](this,_5aa);
}
_5a9=_5a9||{};
return this.each(function(){
var _5ab=$.data(this,"treegrid");
if(_5ab){
$.extend(_5ab.options,_5a9);
}else{
$.data(this,"treegrid",{options:$.extend({},$.fn.treegrid.defaults,$.fn.treegrid.parseOptions(this),_5a9),data:[]});
}
_532(this);
_560(this);
});
...
},resize:function(jq,_5ac){
return jq.each(function(){
$(this).datagrid("resize",_5ac);
});
},fixRowHeight:function(jq,_5ad){
return jq.each(function(){
_536(this,_5ad);
});
},loadData:function(jq,data){
...
if(_5ae){
$.data(this,"treegrid").footer=_5ae;
}
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,this,_5af.find("div.datagrid-footer-inner"),true);
opts.view.renderFooter.call(opts.view,this,_5b0.find("div.datagrid-footer-inner"),false);
if(opts.view.onAfterRender){
opts.view.onAfterRender.call(opts.view,this);
}
...
$.fn.treegrid.parseOptions=function(_5b2){
var t=$(_5b2);
return $.extend({},$.fn.datagrid.parseOptions(_5b2),{treeField:t.attr("treeField"),animate:(t.attr("animate")?t.attr("animate")=="true":undefined)});
};
var _5b3=$.extend({},$.fn.datagrid.defaults.view,{render:function(_5b4,_5b5,_5b6){
var opts=$.data(_5b4,"treegrid").options;
var _5b7=$(_5b4).datagrid("getColumnFields",_5b6);
var view=this;
var _5b8=_5b9(_5b6,this.treeLevel,this.treeNodes);
$(_5b5).append(_5b8.join(""));
function _5b9(_5ba,_5bb,_5bc){
var _5bd=["<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<_5bc.length;i++){
var row=_5bc[i];
if(row.state!="open"&&row.state!="closed"){
row.state="open";
}
var _5be=opts.rowStyler?opts.rowStyler.call(_5b4,row):"";
var _5bf=_5be?"style=\""+_5be+"\"":"";
_5bd.push("<tr node-id="+row[opts.idField]+" "+_5bf+">");
_5bd=_5bd.concat(view.renderRow.call(view,_5b4,_5b7,_5ba,_5bb,row));
_5bd.push("</tr>");
if(row.children&&row.children.length){
var tt=_5b9(_5ba,_5bb+1,row.children);
var v=row.state=="closed"?"none":"block";
_5bd.push("<tr class=\"treegrid-tr-tree\"><td style=\"border:0px\" colspan="+(_5b7.length+(opts.rownumbers?1:0))+"><div style=\"display:"+v+"\">");
_5bd=_5bd.concat(tt);
_5bd.push("</div></td></tr>");
}
}
...
},renderFooter:function(_5c0,_5c1,_5c2){
var opts=$.data(_5c0,"treegrid").options;
var rows=$.data(_5c0,"treegrid").footer||[];
var _5c3=$(_5c0).datagrid("getColumnFields",_5c2);
var _5c4=["<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<rows.length;i++){
var row=rows[i];
row[opts.idField]=row[opts.idField]||("foot-row-id"+i);
_5c4.push("<tr node-id="+row[opts.idField]+">");
_5c4.push(this.renderRow.call(this,_5c0,_5c3,_5c2,0,row));
_5c4.push("</tr>");
}
_5c4.push("</tbody></table>");
$(_5c1).html(_5c4.join(""));
},renderRow:function(_5c5,_5c6,_5c7,_5c8,row){
var opts=$.data(_5c5,"treegrid").options;
var cc=[];
if(_5c7&&opts.rownumbers){
cc.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\">0</div></td>");
}
for(var i=0;i<_5c6.length;i++){
var _5c9=_5c6[i];
var col=$(_5c5).datagrid("getColumnOption",_5c9);
if(col){
var _5ca=col.styler?(col.styler(row[_5c9],row)||""):"";
var _5cb=col.hidden?"style=\"display:none;"+_5ca+"\"":(_5ca?"style=\""+_5ca+"\"":"");
cc.push("<td field=\""+_5c9+"\" "+_5cb+">");
var _5cb="width:"+(col.boxWidth)+"px;";
_5cb+="text-align:"+(col.align||"left")+";";
_5cb+=opts.nowrap==false?"white-space:normal;":"";
cc.push("<div style=\""+_5cb+"\" ");
if(col.checkbox){
cc.push("class=\"datagrid-cell-check ");
}else{
cc.push("class=\"datagrid-cell ");
...
var val=null;
if(col.formatter){
val=col.formatter(row[_5c9],row);
}else{
val=row[_5c9]||"&nbsp;";
}
if(_5c9==opts.treeField){
for(var j=0;j<_5c8;j++){
...
return cc.join("");
},refreshRow:function(_5cc,id){
var row=$(_5cc).treegrid("find",id);
var opts=$.data(_5cc,"treegrid").options;
var body=$(_5cc).datagrid("getPanel").find("div.datagrid-body");
var _5cd=opts.rowStyler?opts.rowStyler.call(_5cc,row):"";
var _5ce=_5cd?"style=\""+_5cd+"\"":"";
var tr=body.find("tr[node-id="+id+"]");
tr.attr("style",_5ce);
tr.children("td").each(function(){
var cell=$(this).find("div.datagrid-cell");
var _5cf=$(this).attr("field");
var col=$(_5cc).datagrid("getColumnOption",_5cf);
if(col){
var _5d0=col.styler?(col.styler(row[_5cf],row)||""):"";
var _5d1=col.hidden?"style=\"display:none;"+_5d0+"\"":(_5d0?"style=\""+_5d0+"\"":"");
$(this).attr("style",_5d1);
var val=null;
if(col.formatter){
val=col.formatter(row[_5cf],row);
}else{
val=row[_5cf]||"&nbsp;";
}
if(_5cf==opts.treeField){
...
$(_5cc).treegrid("fixRowHeight",id);
},onBeforeRender:function(_5d2,_5d3,data){
var opts=$.data(_5d2,"treegrid").options;
if(data.length==undefined){
if(data.footer){
$.data(_5d2,"treegrid").footer=data.footer;
}
data=this.transfer(_5d2,_5d3,data.rows);
}else{
...
row._parentId=_5d6;
if(row.children&&row.children.length){
_5d4(row.children,row[opts.idField]);
}
}
};
_5d4(data,_5d3);
}
var node=find(_5d2,_5d3);
if(node){
if(node.children){
...
$.data(_5d2,"treegrid").data=$.data(_5d2,"treegrid").data.concat(data);
}
this.treeNodes=data;
this.treeLevel=$(_5d2).treegrid("getLevel",_5d3);
},transfer:function(_5d7,_5d8,data){
...
$.fn.treegrid.defaults=$.extend({},$.fn.datagrid.defaults,{treeField:null,animate:false,singleSelect:true,view:_5b3,onBeforeLoad:function(row,_5da){
...
var _5de=$.data(_5dc,"combo").combo;
var _5df=$.data(_5dc,"combo").panel;
if(_5dd){
opts.width=_5dd;
}
_5de.appendTo("body");
if(isNaN(opts.width)){
opts.width=_5de.find("input.combo-text").outerWidth();
}
var _5e0=0;
if(opts.hasDownArrow){
_5e0=_5de.find(".combo-arrow").outerWidth();
}
var _5dd=opts.width-_5e0;
if($.boxModel==true){
_5dd-=_5de.outerWidth()-_5de.width();
}
_5de.find("input.combo-text").width(_5dd);
_5df.panel("resize",{width:(opts.panelWidth?opts.panelWidth:_5de.outerWidth()),height:opts.panelHeight});
_5de.insertAfter(_5dc);
};
function _5e1(_5e2){
var opts=$.data(_5e2,"combo").options;
var _5e3=$.data(_5e2,"combo").combo;
if(opts.hasDownArrow){
_5e3.find(".combo-arrow").show();
}else{
_5e3.find(".combo-arrow").hide();
}
};
function init(_5e4){
$(_5e4).addClass("combo-f").hide();
var span=$("<span class=\"combo\"></span>").insertAfter(_5e4);
var _5e5=$("<input type=\"text\" class=\"combo-text\">").appendTo(span);
$("<span><span class=\"combo-arrow\"></span></span>").appendTo(span);
$("<input type=\"hidden\" class=\"combo-value\">").appendTo(span);
var _5e6=$("<div class=\"combo-panel\"></div>").appendTo("body");
_5e6.panel({doSize:false,closed:true,style:{position:"absolute",zIndex:10},onOpen:function(){
$(this).panel("resize");
}});
var name=$(_5e4).attr("name");
if(name){
span.find("input.combo-value").attr("name",name);
$(_5e4).removeAttr("name").attr("comboName",name);
}
_5e5.attr("autocomplete","off");
return {combo:span,panel:_5e6};
};
function _5e7(_5e8){
var _5e9=$.data(_5e8,"combo").combo.find("input.combo-text");
_5e9.validatebox("destroy");
$.data(_5e8,"combo").panel.panel("destroy");
$.data(_5e8,"combo").combo.remove();
$(_5e8).remove();
};
function _5ea(_5eb){
var opts=$.data(_5eb,"combo").options;
var _5ec=$.data(_5eb,"combo").combo;
var _5ed=$.data(_5eb,"combo").panel;
var _5ee=_5ec.find(".combo-text");
var _5ef=_5ec.find(".combo-arrow");
...
_5ed.bind("mousedown.combo",function(e){
return false;
});
_5ee.bind("mousedown.combo",function(e){
e.stopPropagation();
}).bind("keydown.combo",function(e){
switch(e.keyCode){
case 38:
opts.keyHandler.up.call(_5eb);
break;
case 40:
opts.keyHandler.down.call(_5eb);
break;
case 13:
e.preventDefault();
opts.keyHandler.enter.call(_5eb);
return false;
case 9:
case 27:
_5f5(_5eb);
...
setTimeout(function(){
var q=_5ee.val();
if($.data(_5eb,"combo").previousValue!=q){
$.data(_5eb,"combo").previousValue=q;
_5f0(_5eb);
opts.keyHandler.query.call(_5eb,_5ee.val());
_5f8(_5eb,true);
}
},10);
}
...
_5ef.bind("click.combo",function(){
_5ee.focus();
_5f0(_5eb);
...
function _5f0(_5f1){
var opts=$.data(_5f1,"combo").options;
var _5f2=$.data(_5f1,"combo").combo;
var _5f3=$.data(_5f1,"combo").panel;
if($.fn.window){
_5f3.panel("panel").css("z-index",$.fn.window.defaults.zIndex++);
}
_5f3.panel("move",{left:_5f2.offset().left,top:_5f4()});
_5f3.panel("open");
opts.onShowPanel.call(_5f1);
(function(){
if(_5f3.is(":visible")){
_5f3.panel("move",{left:_5f2.offset().left,top:_5f4()});
setTimeout(arguments.callee,200);
...
function _5f4(){
var top=_5f2.offset().top+_5f2.outerHeight();
if(top+_5f3.outerHeight()>$(window).height()+$(document).scrollTop()){
top=_5f2.offset().top-_5f3.outerHeight();
}
if(top<$(document).scrollTop()){
top=_5f2.offset().top+_5f2.outerHeight();
}
return top;
};
};
function _5f5(_5f6){
var opts=$.data(_5f6,"combo").options;
var _5f7=$.data(_5f6,"combo").panel;
_5f7.panel("close");
opts.onHidePanel.call(_5f6);
};
function _5f8(_5f9,doit){
var opts=$.data(_5f9,"combo").options;
var _5fa=$.data(_5f9,"combo").combo.find("input.combo-text");
_5fa.validatebox(opts);
if(doit){
_5fa.validatebox("validate");
_5fa.trigger("mouseleave");
}
};
function _5fb(_5fc,_5fd){
var opts=$.data(_5fc,"combo").options;
var _5fe=$.data(_5fc,"combo").combo;
if(_5fd){
opts.disabled=true;
$(_5fc).attr("disabled",true);
_5fe.find(".combo-value").attr("disabled",true);
_5fe.find(".combo-text").attr("disabled",true);
}else{
opts.disabled=false;
$(_5fc).removeAttr("disabled");
_5fe.find(".combo-value").removeAttr("disabled");
_5fe.find(".combo-text").removeAttr("disabled");
}
};
function _5ff(_600){
var opts=$.data(_600,"combo").options;
var _601=$.data(_600,"combo").combo;
if(opts.multiple){
_601.find("input.combo-value").remove();
}else{
_601.find("input.combo-value").val("");
}
_601.find("input.combo-text").val("");
};
function _602(_603){
var _604=$.data(_603,"combo").combo;
return _604.find("input.combo-text").val();
};
function _605(_606,text){
var _607=$.data(_606,"combo").combo;
_607.find("input.combo-text").val(text);
_5f8(_606,true);
$.data(_606,"combo").previousValue=text;
};
function _608(_609){
var _60a=[];
var _60b=$.data(_609,"combo").combo;
_60b.find("input.combo-value").each(function(){
_60a.push($(this).val());
});
return _60a;
};
function _60c(_60d,_60e){
var opts=$.data(_60d,"combo").options;
var _60f=_608(_60d);
var _610=$.data(_60d,"combo").combo;
_610.find("input.combo-value").remove();
var name=$(_60d).attr("comboName");
for(var i=0;i<_60e.length;i++){
var _611=$("<input type=\"hidden\" class=\"combo-value\">").appendTo(_610);
if(name){
_611.attr("name",name);
}
_611.val(_60e[i]);
...
if(aa.length!=_60e.length||_60e.length!=_60f.length){
if(opts.multiple){
opts.onChange.call(_60d,_60e,_60f);
}else{
opts.onChange.call(_60d,_60e[0],_60f[0]);
}
}
};
function _612(_613){
...
_60c(_619,opts.value);
}else{
_615(_619,opts.value);
}
}else{
_60c(_619,[]);
}
...
$.fn.combo=function(_61a,_61b){
if(typeof _61a=="string"){
return $.fn.combo.methods[_61a](this,_61b);
}
_61a=_61a||{};
return this.each(function(){
var _61c=$.data(this,"combo");
if(_61c){
$.extend(_61c.options,_61a);
}else{
var r=init(this);
_61c=$.data(this,"combo",{options:$.extend({},$.fn.combo.defaults,$.fn.combo.parseOptions(this),_61a),combo:r.combo,panel:r.panel,previousValue:null});
$(this).removeAttr("disabled");
}
$("input.combo-text",_61c.combo).attr("readonly",!_61c.options.editable);
_5e1(this);
_5fb(this,_61c.options.disabled);
_5db(this);
_5ea(this);
_5f8(this);
_618(this);
...
var _61e=$.data(jq[0],"combo").combo.find("input.combo-text");
return _61e.validatebox("isValid");
},clear:function(jq){
return jq.each(function(){
_5ff(this);
});
...
},onChange:function(_622,_623){
}});
})(jQuery);
(function($){
function _624(_625,_626){
var _627=$(_625).combo("panel");
var item=_627.find("div.combobox-item[value="+_626+"]");
if(item.length){
if(item.position().top<=0){
var h=_627.scrollTop()+item.position().top;
_627.scrollTop(h);
}else{
if(item.position().top+item.outerHeight()>_627.height()){
var h=_627.scrollTop()+item.position().top+item.outerHeight()-_627.height();
_627.scrollTop(h);
}
}
}
...
var _62b=$(_629).combo("getValues");
var item=_62a.find("div.combobox-item[value="+_62b.pop()+"]");
if(item.length){
...
item=_62a.find("div.combobox-item:visible:last");
}
var _62c=item.attr("value");
_62d(_629,[_62c]);
_624(_629,_62c);
};
function _62e(_62f){
var _630=$(_62f).combo("panel");
var _631=$(_62f).combo("getValues");
var item=_630.find("div.combobox-item[value="+_631.pop()+"]");
if(item.length){
...
item=_630.find("div.combobox-item:visible:first");
}
var _632=item.attr("value");
_62d(_62f,[_632]);
_624(_62f,_632);
};
function _633(_634,_635){
var opts=$.data(_634,"combobox").options;
var data=$.data(_634,"combobox").data;
if(opts.multiple){
var _636=$(_634).combo("getValues");
...
for(var i=0;i<data.length;i++){
if(data[i][opts.valueField]==_635){
opts.onSelect.call(_634,data[i]);
return;
}
}
};
function _637(_638,_639){
var opts=$.data(_638,"combobox").options;
var data=$.data(_638,"combobox").data;
var _63a=$(_638).combo("getValues");
...
for(var i=0;i<data.length;i++){
if(data[i][opts.valueField]==_639){
opts.onUnselect.call(_638,data[i]);
return;
}
}
};
function _62d(_63b,_63c,_63d){
var opts=$.data(_63b,"combobox").options;
var data=$.data(_63b,"combobox").data;
var _63e=$(_63b).combo("panel");
_63e.find("div.combobox-item-selected").removeClass("combobox-item-selected");
var vv=[],ss=[];
...
vv.push(v);
ss.push(s);
_63e.find("div.combobox-item[value="+v+"]").addClass("combobox-item-selected");
}
$(_63b).combo("setValues",vv);
if(!_63d){
$(_63b).combo("setText",ss.join(opts.separator));
}
};
function _63f(_640){
var opts=$.data(_640,"combobox").options;
var data=[];
$(">option",_640).each(function(){
var item={};
...
function _641(_642,data,_643){
var opts=$.data(_642,"combobox").options;
var _644=$(_642).combo("panel");
$.data(_642,"combobox").data=data;
var _645=$(_642).combobox("getValues");
_644.empty();
for(var i=0;i<data.length;i++){
var v=data[i][opts.valueField];
var s=data[i][opts.textField];
var item=$("<div class=\"combobox-item\"></div>").appendTo(_644);
item.attr("value",v);
if(opts.formatter){
item.html(opts.formatter.call(_642,data[i]));
}else{
item.html(s);
}
if(data[i]["selected"]){
...
if(_645.length){
_62d(_642,[_645[_645.length-1]],_643);
}else{
_62d(_642,[],_643);
}
}
opts.onLoadSuccess.call(_642,data);
$(".combobox-item",_644).hover(function(){
...
_637(_642,item.attr("value"));
}else{
_633(_642,item.attr("value"));
}
}else{
_633(_642,item.attr("value"));
$(_642).combo("hidePanel");
}
});
};
function _646(_647,url,_648,_649){
var opts=$.data(_647,"combobox").options;
if(url){
opts.url=url;
}
if(!opts.url){
...
_648=_648||{};
$.ajax({url:opts.url,dataType:"json",data:_648,success:function(data){
_641(_647,data,_649);
},error:function(){
opts.onLoadError.apply(this,arguments);
}});
};
function _64a(_64b,q){
var opts=$.data(_64b,"combobox").options;
if(opts.multiple&&!q){
_62d(_64b,[],true);
}else{
_62d(_64b,[q],true);
...
if(opts.mode=="remote"){
_646(_64b,null,{q:q},true);
}else{
var _64c=$(_64b).combo("panel");
_64c.find("div.combobox-item").hide();
var data=$.data(_64b,"combobox").data;
for(var i=0;i<data.length;i++){
if(opts.filter.call(_64b,q,data[i])){
var v=data[i][opts.valueField];
var s=data[i][opts.textField];
var item=_64c.find("div.combobox-item[value="+v+"]");
item.show();
if(s==q){
_62d(_64b,[v],true);
...
function _64d(_64e){
var opts=$.data(_64e,"combobox").options;
$(_64e).addClass("combobox-f");
$(_64e).combo($.extend({},opts,{onShowPanel:function(){
$(_64e).combo("panel").find("div.combobox-item").show();
_624(_64e,$(_64e).combobox("getValue"));
opts.onShowPanel.call(_64e);
}}));
};
$.fn.combobox=function(_64f,_650){
if(typeof _64f=="string"){
var _651=$.fn.combobox.methods[_64f];
if(_651){
return _651(this,_650);
}else{
return this.combo(_64f,_650);
}
}
_64f=_64f||{};
return this.each(function(){
var _652=$.data(this,"combobox");
if(_652){
$.extend(_652.options,_64f);
_64d(this);
}else{
_652=$.data(this,"combobox",{options:$.extend({},$.fn.combobox.defaults,$.fn.combobox.parseOptions(this),_64f)});
_64d(this);
_641(this,_63f(this));
}
if(_652.options.data){
_641(this,_652.options.data);
}
_646(this);
});
};
...
},setValues:function(jq,_653){
return jq.each(function(){
_62d(this,_653);
});
},setValue:function(jq,_654){
return jq.each(function(){
_62d(this,[_654]);
});
},clear:function(jq){
return jq.each(function(){
$(this).combo("clear");
var _655=$(this).combo("panel");
_655.find("div.combobox-item-selected").removeClass("combobox-item-selected");
});
},loadData:function(jq,data){
return jq.each(function(){
_641(this,data);
...
},select:function(jq,_656){
return jq.each(function(){
_633(this,_656);
});
},unselect:function(jq,_657){
return jq.each(function(){
_637(this,_657);
});
}};
$.fn.combobox.parseOptions=function(_658){
var t=$(_658);
return $.extend({},$.fn.combo.parseOptions(_658),{valueField:t.attr("valueField"),textField:t.attr("textField"),mode:t.attr("mode"),url:t.attr("url")});
};
...
var _659=$(this).combobox("getValues");
$(this).combobox("setValues",_659);
...
},onSelect:function(_65a){
},onUnselect:function(_65b){
}});
})(jQuery);
(function($){
function _65c(_65d){
var opts=$.data(_65d,"combotree").options;
var tree=$.data(_65d,"combotree").tree;
$(_65d).addClass("combotree-f");
$(_65d).combo(opts);
var _65e=$(_65d).combo("panel");
if(!tree){
tree=$("<ul></ul>").appendTo(_65e);
$.data(_65d,"combotree").tree=tree;
}
tree.tree($.extend({},opts,{checkbox:opts.multiple,onLoadSuccess:function(node,data){
var _65f=$(_65d).combotree("getValues");
if(opts.multiple){
var _660=tree.tree("getChecked");
...
$(_65d).combotree("setValues",_65f);
opts.onLoadSuccess.call(this,node,data);
},onClick:function(node){
_662(_65d);
$(_65d).combo("hidePanel");
opts.onClick.call(this,node);
},onCheck:function(node,_661){
_662(_65d);
opts.onCheck.call(this,node,_661);
}}));
};
function _662(_663){
var opts=$.data(_663,"combotree").options;
var tree=$.data(_663,"combotree").tree;
var vv=[],ss=[];
if(opts.multiple){
var _664=tree.tree("getChecked");
...
$(_663).combo("setValues",vv).combo("setText",ss.join(opts.separator));
};
function _665(_666,_667){
var opts=$.data(_666,"combotree").options;
var tree=$.data(_666,"combotree").tree;
...
$(_666).combo("setValues",vv).combo("setText",ss.join(opts.separator));
};
$.fn.combotree=function(_668,_669){
if(typeof _668=="string"){
var _66a=$.fn.combotree.methods[_668];
if(_66a){
return _66a(this,_669);
}else{
return this.combo(_668,_669);
}
}
_668=_668||{};
return this.each(function(){
var _66b=$.data(this,"combotree");
if(_66b){
$.extend(_66b.options,_668);
}else{
$.data(this,"combotree",{options:$.extend({},$.fn.combotree.defaults,$.fn.combotree.parseOptions(this),_668)});
}
_65c(this);
});
};
...
$.fn.combotree.parseOptions=function(_66e){
return $.extend({},$.fn.combo.parseOptions(_66e),$.fn.tree.parseOptions(_66e));
};
$.fn.combotree.defaults=$.extend({},$.fn.combo.defaults,$.fn.tree.defaults,{editable:false});
})(jQuery);
(function($){
function _66f(_670){
var opts=$.data(_670,"combogrid").options;
var grid=$.data(_670,"combogrid").grid;
$(_670).addClass("combogrid-f");
$(_670).combo(opts);
var _671=$(_670).combo("panel");
if(!grid){
grid=$("<table></table>").appendTo(_671);
$.data(_670,"combogrid").grid=grid;
}
grid.datagrid($.extend({},opts,{border:false,fit:true,singleSelect:(!opts.multiple),onLoadSuccess:function(data){
var _672=$.data(_670,"combogrid").remainText;
var _673=$(_670).combo("getValues");
_67f(_670,_673,_672);
$.data(_670,"combogrid").remainText=false;
opts.onLoadSuccess.apply(this,arguments);
},onClickRow:_674,onSelect:function(_675,row){
_676();
opts.onSelect.call(this,_675,row);
},onUnselect:function(_677,row){
_676();
opts.onUnselect.call(this,_677,row);
},onSelectAll:function(rows){
_676();
...
function _674(_678,row){
$.data(_670,"combogrid").remainText=false;
_676();
if(!opts.multiple){
$(_670).combo("hidePanel");
}
opts.onClickRow.call(this,_678,row);
};
function _676(){
var _679=$.data(_670,"combogrid").remainText;
...
$(_670).combo("setValues",vv);
if(!vv.length&&!opts.multiple){
$(_670).combo("setValues",[""]);
}
if(!_679){
$(_670).combo("setText",ss.join(opts.separator));
}
};
};
function _67a(_67b,step){
var opts=$.data(_67b,"combogrid").options;
var grid=$.data(_67b,"combogrid").grid;
var _67c=grid.datagrid("getRows").length;
$.data(_67b,"combogrid").remainText=false;
var _67d;
var _67e=grid.datagrid("getSelections");
if(_67e.length){
_67d=grid.datagrid("getRowIndex",_67e[_67e.length-1][opts.idField]);
_67d+=step;
if(_67d<0){
_67d=0;
}
...
grid.datagrid("selectRow",_67d);
}
};
function _67f(_680,_681,_682){
var opts=$.data(_680,"combogrid").options;
var grid=$.data(_680,"combogrid").grid;
var rows=grid.datagrid("getRows");
var ss=[];
grid.datagrid("clearSelections");
for(var i=0;i<_681.length;i++){
var _683=grid.datagrid("getRowIndex",_681[i]);
if(_683>=0){
grid.datagrid("selectRow",_683);
ss.push(rows[_683][opts.textField]);
}else{
ss.push(_681[i]);
}
}
$(_680).combo("setValues",_681);
if(!_682){
$(_680).combo("setText",ss.join(opts.separator));
}
};
function _684(_685,q){
var opts=$.data(_685,"combogrid").options;
var grid=$.data(_685,"combogrid").grid;
$.data(_685,"combogrid").remainText=true;
if(opts.multiple&&!q){
_67f(_685,[],true);
}else{
_67f(_685,[q],true);
...
var rows=grid.datagrid("getRows");
for(var i=0;i<rows.length;i++){
if(opts.filter.call(_685,q,rows[i])){
grid.datagrid("clearSelections");
...
$.fn.combogrid=function(_686,_687){
if(typeof _686=="string"){
var _688=$.fn.combogrid.methods[_686];
if(_688){
return _688(this,_687);
}else{
return $.fn.combo.methods[_686](this,_687);
}
}
_686=_686||{};
return this.each(function(){
var _689=$.data(this,"combogrid");
if(_689){
$.extend(_689.options,_686);
}else{
_689=$.data(this,"combogrid",{options:$.extend({},$.fn.combogrid.defaults,$.fn.combogrid.parseOptions(this),_686)});
}
_66f(this);
});
};
...
$.fn.combogrid.parseOptions=function(_68c){
var t=$(_68c);
return $.extend({},$.fn.combo.parseOptions(_68c),$.fn.datagrid.parseOptions(_68c),{idField:(t.attr("idField")||undefined),textField:(t.attr("textField")||undefined),mode:t.attr("mode")});
};
...
(function($){
function _68d(_68e){
var _68f=$.data(_68e,"datebox");
var opts=_68f.options;
$(_68e).addClass("datebox-f");
$(_68e).combo($.extend({},opts,{onShowPanel:function(){
_68f.calendar.calendar("resize");
opts.onShowPanel.call(_68e);
}}));
$(_68e).combo("textbox").parent().addClass("datebox");
if(!_68f.calendar){
_690();
}
function _690(){
var _691=$(_68e).combo("panel");
_68f.calendar=$("<div></div>").appendTo(_691).wrap("<div class=\"datebox-calendar-inner\"></div>");
_68f.calendar.calendar({fit:true,border:false,onSelect:function(date){
var _692=opts.formatter(date);
_696(_68e,_692);
$(_68e).combo("hidePanel");
opts.onSelect.call(_68e,date);
}});
_696(_68e,opts.value);
var _693=$("<div class=\"datebox-button\"></div>").appendTo(_691);
$("<a href=\"javascript:void(0)\" class=\"datebox-current\"></a>").html(opts.currentText).appendTo(_693);
$("<a href=\"javascript:void(0)\" class=\"datebox-close\"></a>").html(opts.closeText).appendTo(_693);
_693.find(".datebox-current,.datebox-close").hover(function(){
$(this).addClass("datebox-button-hover");
},function(){
$(this).removeClass("datebox-button-hover");
});
_693.find(".datebox-current").click(function(){
_68f.calendar.calendar({year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date()});
});
_693.find(".datebox-close").click(function(){
$(_68e).combo("hidePanel");
});
};
};
function _694(_695,q){
_696(_695,q);
};
function _697(_698){
var opts=$.data(_698,"datebox").options;
var c=$.data(_698,"datebox").calendar;
var _699=opts.formatter(c.calendar("options").current);
_696(_698,_699);
$(_698).combo("hidePanel");
};
function _696(_69a,_69b){
var _69c=$.data(_69a,"datebox");
var opts=_69c.options;
$(_69a).combo("setValue",_69b).combo("setText",_69b);
_69c.calendar.calendar("moveTo",opts.parser(_69b));
};
$.fn.datebox=function(_69d,_69e){
if(typeof _69d=="string"){
var _69f=$.fn.datebox.methods[_69d];
if(_69f){
return _69f(this,_69e);
}else{
return this.combo(_69d,_69e);
}
}
_69d=_69d||{};
return this.each(function(){
var _6a0=$.data(this,"datebox");
if(_6a0){
$.extend(_6a0.options,_69d);
}else{
$.data(this,"datebox",{options:$.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_69d)});
}
_68d(this);
});
};
...
$.fn.datebox.parseOptions=function(_6a2){
var t=$(_6a2);
return $.extend({},$.fn.combo.parseOptions(_6a2),{});
};
...
(function($){
function _6a3(_6a4){
var _6a5=$.data(_6a4,"datetimebox");
var opts=_6a5.options;
$(_6a4).datebox($.extend({},opts,{onShowPanel:function(){
var _6a6=$(_6a4).datetimebox("getValue");
_6ae(_6a4,_6a6,true);
opts.onShowPanel.call(_6a4);
}}));
$(_6a4).removeClass("datebox-f").addClass("datetimebox-f");
$(_6a4).datebox("calendar").calendar({onSelect:function(date){
opts.onSelect.call(_6a4,date);
}});
var _6a7=$(_6a4).datebox("panel");
if(!_6a5.spinner){
var p=$("<div style=\"padding:2px\"><input style=\"width:80px\"></div>").insertAfter(_6a7.children("div.datebox-calendar-inner"));
_6a5.spinner=p.children("input");
_6a5.spinner.timespinner({showSeconds:true}).bind("mousedown",function(e){
e.stopPropagation();
});
_6ae(_6a4,opts.value);
var _6a8=_6a7.children("div.datebox-button");
var ok=$("<a href=\"javascript:void(0)\" class=\"datebox-ok\"></a>").html(opts.okText).appendTo(_6a8);
ok.hover(function(){
$(this).addClass("datebox-button-hover");
},function(){
$(this).removeClass("datebox-button-hover");
...
function _6aa(_6ab){
var c=$(_6ab).datetimebox("calendar");
var t=$(_6ab).datetimebox("spinner");
...
function _6a9(_6af){
var opts=$.data(_6af,"datetimebox").options;
var date=_6aa(_6af);
_6ae(_6af,opts.formatter(date));
$(_6af).combo("hidePanel");
};
function _6ae(_6b0,_6b1,_6b2){
var opts=$.data(_6b0,"datetimebox").options;
$(_6b0).combo("setValue",_6b1);
if(!_6b2){
if(_6b1){
var date=opts.parser(_6b1);
$(_6b0).combo("setValue",opts.formatter(date));
$(_6b0).combo("setText",opts.formatter(date));
}else{
$(_6b0).combo("setText",_6b1);
}
}
var date=opts.parser(_6b1);
$(_6b0).datetimebox("calendar").calendar("moveTo",opts.parser(_6b1));
$(_6b0).datetimebox("spinner").timespinner("setValue",_6b3(date));
function _6b3(date){
function _6b4(_6b5){
return (_6b5<10?"0":"")+_6b5;
};
var tt=[_6b4(date.getHours()),_6b4(date.getMinutes())];
if(opts.showSeconds){
tt.push(_6b4(date.getSeconds()));
}
return tt.join($(_6b0).datetimebox("spinner").timespinner("options").separator);
};
};
$.fn.datetimebox=function(_6b6,_6b7){
if(typeof _6b6=="string"){
var _6b8=$.fn.datetimebox.methods[_6b6];
if(_6b8){
return _6b8(this,_6b7);
}else{
return this.datebox(_6b6,_6b7);
}
}
_6b6=_6b6||{};
return this.each(function(){
var _6b9=$.data(this,"datetimebox");
if(_6b9){
$.extend(_6b9.options,_6b6);
}else{
$.data(this,"datetimebox",{options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_6b6)});
}
_6a3(this);
});
};
...
},setValue:function(jq,_6ba){
return jq.each(function(){
_6ae(this,_6ba);
});
}};
$.fn.datetimebox.parseOptions=function(_6bb){
var t=$(_6bb);
return $.extend({},$.fn.datebox.parseOptions(_6bb),{});
};
...
function _6bc(_6bd){
return (_6bd<10?"0":"")+_6bd;
};
return $.fn.datebox.defaults.formatter(date)+" "+_6bc(h)+":"+_6bc(M)+":"+_6bc(s);
},parser:function(s){
if($.trim(s)==""){
return new Date();
}
...
var _6be=parseInt(tt[1],10);
var _6bf=parseInt(tt[2],10);
return new Date(d.getFullYear(),d.getMonth(),d.getDate(),hour,_6be,_6bf);
}});
})(jQuery);
