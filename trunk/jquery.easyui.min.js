...
_8d8();
_8e2(_8d6,$(_8d6).datebox("getText"));
...
_8e2(this.target,opts.formatter(date));
$(this.target).combo("hidePanel");
opts.onSelect.call(_8d6,date);
}});
_8e2(_8d6,opts.value);
var _8db=$("<div class=\"datebox-button\"></div>").appendTo(_8da);
var _8dc=$("<a href=\"javascript:void(0)\" class=\"datebox-current\"></a>").html(opts.currentText).appendTo(_8db);
var _8dd=$("<a href=\"javascript:void(0)\" class=\"datebox-close\"></a>").html(opts.closeText).appendTo(_8db);
_8dc.click(function(){
_8d7.calendar.calendar({year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date()});
});
_8dd.click(function(){
...
function _8d8(){
var _8de=$(_8d6).combo("panel");
var cc=_8de.children("div.datebox-calendar-inner");
_8de.children()._outerWidth(_8de.width());
_8d7.calendar.appendTo(cc);
_8d7.calendar[0].target=_8d6;
if(opts.panelHeight!="auto"){
var _8df=_8de.height();
_8de.children().not(cc).each(function(){
_8df-=$(this).outerHeight();
});
cc._outerHeight(_8df);
}
...
var _8e6=opts.formatter(_8e5.calendar.calendar("options").current);
_8e2(_8e4,_8e6);
$(_8e4).combo("hidePanel");
};
function _8e2(_8e7,_8e8){
var _8e9=$.data(_8e7,"datebox");
var opts=_8e9.options;
$(_8e7).combo("setValue",_8e8).combo("setText",_8e8);
_8e9.calendar.calendar("moveTo",opts.parser(_8e8));
};
$.fn.datebox=function(_8ea,_8eb){
if(typeof _8ea=="string"){
var _8ec=$.fn.datebox.methods[_8ea];
if(_8ec){
return _8ec(this,_8eb);
}else{
return this.combo(_8ea,_8eb);
}
}
_8ea=_8ea||{};
return this.each(function(){
var _8ed=$.data(this,"datebox");
if(_8ed){
$.extend(_8ed.options,_8ea);
}else{
$.data(this,"datebox",{options:$.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_8ea)});
}
_8d5(this);
});
};
$.fn.datebox.methods={options:function(jq){
var _8ee=jq.combo("options");
return $.extend($.data(jq[0],"datebox").options,{originalValue:_8ee.originalValue,disabled:_8ee.disabled,readonly:_8ee.readonly});
},calendar:function(jq){
return $.data(jq[0],"datebox").calendar;
},setValue:function(jq,_8ef){
return jq.each(function(){
_8e2(this,_8ef);
});
},reset:function(jq){
...
$.fn.datebox.parseOptions=function(_8f0){
return $.extend({},$.fn.combo.parseOptions(_8f0),$.parser.parseOptions(_8f0,["sharedCalendar"]));
};
...
(function($){
function _8f1(_8f2){
var _8f3=$.data(_8f2,"datetimebox");
var opts=_8f3.options;
$(_8f2).datebox($.extend({},opts,{onShowPanel:function(){
var _8f4=$(_8f2).datetimebox("getValue");
_8f7(_8f2,_8f4,true);
opts.onShowPanel.call(_8f2);
},formatter:$.fn.datebox.defaults.formatter,parser:$.fn.datebox.defaults.parser}));
$(_8f2).removeClass("datebox-f").addClass("datetimebox-f");
$(_8f2).datebox("calendar").calendar({onSelect:function(date){
opts.onSelect.call(_8f2,date);
}});
var _8f5=$(_8f2).datebox("panel");
if(!_8f3.spinner){
var p=$("<div style=\"padding:2px\"><input style=\"width:80px\"></div>").insertAfter(_8f5.children("div.datebox-calendar-inner"));
_8f3.spinner=p.children("input");
var _8f6=_8f5.children("div.datebox-button");
var ok=$("<a href=\"javascript:void(0)\" class=\"datebox-ok\"></a>").html(opts.okText).appendTo(_8f6);
ok.click(function(){
_8fc(_8f2);
});
}
_8f3.spinner.timespinner({showSeconds:opts.showSeconds,separator:opts.timeSeparator}).unbind(".datetimebox").bind("mousedown.datetimebox",function(e){
e.stopPropagation();
});
_8f7(_8f2,opts.value);
};
function _8f8(_8f9){
var c=$(_8f9).datetimebox("calendar");
var t=$(_8f9).datetimebox("spinner");
...
function _8fc(_8fd){
var opts=$.data(_8fd,"datetimebox").options;
var date=_8f8(_8fd);
_8f7(_8fd,opts.formatter.call(_8fd,date));
$(_8fd).combo("hidePanel");
};
function _8f7(_8fe,_8ff,_900){
var opts=$.data(_8fe,"datetimebox").options;
$(_8fe).combo("setValue",_8ff);
if(!_900){
if(_8ff){
var date=opts.parser.call(_8fe,_8ff);
$(_8fe).combo("setValue",opts.formatter.call(_8fe,date));
$(_8fe).combo("setText",opts.formatter.call(_8fe,date));
}else{
$(_8fe).combo("setText",_8ff);
}
}
var date=opts.parser.call(_8fe,_8ff);
$(_8fe).datetimebox("calendar").calendar("moveTo",date);
$(_8fe).datetimebox("spinner").timespinner("setValue",_901(date));
function _901(date){
function _902(_903){
return (_903<10?"0":"")+_903;
};
var tt=[_902(date.getHours()),_902(date.getMinutes())];
if(opts.showSeconds){
tt.push(_902(date.getSeconds()));
}
return tt.join($(_8fe).datetimebox("spinner").timespinner("options").separator);
};
};
$.fn.datetimebox=function(_904,_905){
if(typeof _904=="string"){
var _906=$.fn.datetimebox.methods[_904];
if(_906){
return _906(this,_905);
}else{
return this.datebox(_904,_905);
}
}
_904=_904||{};
return this.each(function(){
var _907=$.data(this,"datetimebox");
if(_907){
$.extend(_907.options,_904);
}else{
$.data(this,"datetimebox",{options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_904)});
}
_8f1(this);
});
};
$.fn.datetimebox.methods={options:function(jq){
var _908=jq.datebox("options");
return $.extend($.data(jq[0],"datetimebox").options,{originalValue:_908.originalValue,disabled:_908.disabled,readonly:_908.readonly});
},spinner:function(jq){
return $.data(jq[0],"datetimebox").spinner;
},setValue:function(jq,_909){
return jq.each(function(){
_8f7(this,_909);
});
},reset:function(jq){
...
$.fn.datetimebox.parseOptions=function(_90a){
var t=$(_90a);
return $.extend({},$.fn.datebox.parseOptions(_90a),$.parser.parseOptions(_90a,["timeSeparator",{showSeconds:"boolean"}]));
};
...
function _90b(_90c){
return (_90c<10?"0":"")+_90c;
};
var _90d=$(this).datetimebox("spinner").timespinner("options").separator;
var r=$.fn.datebox.defaults.formatter(date)+" "+_90b(h)+_90d+_90b(M);
...
var _90e=$(this).datetimebox("spinner").timespinner("options").separator;
var tt=dt[1].split(_90e);
var hour=parseInt(tt[0],10)||0;
var _90f=parseInt(tt[1],10)||0;
var _910=parseInt(tt[2],10)||0;
return new Date(d.getFullYear(),d.getMonth(),d.getDate(),hour,_90f,_910);
}});
})(jQuery);
(function($){
function init(_911){
var _912=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"javascript:void(0)\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_911);
var t=$(_911);
t.addClass("slider-f").hide();
var name=t.attr("name");
if(name){
_912.find("input.slider-value").attr("name",name);
t.removeAttr("name").attr("sliderName",name);
}
return _912;
};
function _913(_914,_915){
var _916=$.data(_914,"slider");
var opts=_916.options;
var _917=_916.slider;
if(_915){
if(_915.width){
opts.width=_915.width;
}
if(_915.height){
opts.height=_915.height;
}
}
if(opts.mode=="h"){
_917.css("height","");
_917.children("div").css("height","");
if(!isNaN(opts.width)){
_917.width(opts.width);
}
}else{
_917.css("width","");
_917.children("div").css("width","");
if(!isNaN(opts.height)){
_917.height(opts.height);
_917.find("div.slider-rule").height(opts.height);
_917.find("div.slider-rulelabel").height(opts.height);
_917.find("div.slider-inner")._outerHeight(opts.height);
}
}
_918(_914);
};
function _919(_91a){
var _91b=$.data(_91a,"slider");
var opts=_91b.options;
var _91c=_91b.slider;
...
_91d(aa);
function _91d(aa){
var rule=_91c.find("div.slider-rule");
var _91e=_91c.find("div.slider-rulelabel");
rule.empty();
_91e.empty();
for(var i=0;i<aa.length;i++){
var _91f=i*100/(aa.length-1)+"%";
var span=$("<span></span>").appendTo(rule);
span.css((opts.mode=="h"?"left":"top"),_91f);
if(aa[i]!="|"){
span=$("<span></span>").appendTo(_91e);
span.html(aa[i]);
if(opts.mode=="h"){
span.css({left:_91f,marginLeft:-Math.round(span.outerWidth()/2)});
}else{
span.css({top:_91f,marginTop:-Math.round(span.outerHeight()/2)});
}
}
}
};
...
_923.removeClass("slider-h slider-v slider-disabled");
_923.addClass(opts.mode=="h"?"slider-h":"slider-v");
_923.addClass(opts.disabled?"slider-disabled":"");
_923.find("a.slider-handle").draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
...
var _925=_937(_921,left);
_926(_925);
return false;
}
},onBeforeDrag:function(){
_922.isDragging=true;
},onStartDrag:function(){
opts.onSlideStart.call(_921,opts.value);
},onStopDrag:function(e){
var _927=_937(_921,(opts.mode=="h"?e.data.left:e.data.top));
_926(_927);
opts.onSlideEnd.call(_921,opts.value);
opts.onComplete.call(_921,opts.value);
_922.isDragging=false;
}});
_923.find("div.slider-inner").unbind(".slider").bind("mousedown.slider",function(e){
if(_922.isDragging){
return;
}
var pos=$(this).offset();
var _928=_937(_921,(opts.mode=="h"?(e.pageX-pos.left):(e.pageY-pos.top)));
_926(_928);
opts.onComplete.call(_921,opts.value);
});
function _926(_929){
var s=Math.abs(_929%opts.step);
if(s<opts.step/2){
_929-=s;
}else{
_929=_929-s+opts.step;
}
_92a(_921,_929);
};
};
function _92a(_92b,_92c){
var _92d=$.data(_92b,"slider");
var opts=_92d.options;
var _92e=_92d.slider;
var _92f=opts.value;
if(_92c<opts.min){
_92c=opts.min;
}
...
opts.value=_92c;
$(_92b).val(_92c);
_92e.find("input.slider-value").val(_92c);
var pos=_930(_92b,_92c);
var tip=_92e.find(".slider-tip");
if(opts.showTip){
tip.show();
tip.html(opts.tipFormatter.call(_92b,opts.value));
}else{
tip.hide();
}
if(opts.mode=="h"){
var _931="left:"+pos+"px;";
_92e.find(".slider-handle").attr("style",_931);
tip.attr("style",_931+"margin-left:"+(-Math.round(tip.outerWidth()/2))+"px");
}else{
var _931="top:"+pos+"px;";
_92e.find(".slider-handle").attr("style",_931);
tip.attr("style",_931+"margin-left:"+(-Math.round(tip.outerWidth()))+"px");
}
if(_92f!=_92c){
opts.onChange.call(_92b,_92c,_92f);
}
};
function _918(_932){
var opts=$.data(_932,"slider").options;
var fn=opts.onChange;
opts.onChange=function(){
};
_92a(_932,opts.value);
opts.onChange=fn;
};
function _930(_933,_934){
var _935=$.data(_933,"slider");
var opts=_935.options;
var _936=_935.slider;
if(opts.mode=="h"){
var pos=(_934-opts.min)/(opts.max-opts.min)*_936.width();
if(opts.reversed){
pos=_936.width()-pos;
}
}else{
var pos=_936.height()-(_934-opts.min)/(opts.max-opts.min)*_936.height();
if(opts.reversed){
pos=_936.height()-pos;
}
}
...
function _937(_938,pos){
var _939=$.data(_938,"slider");
var opts=_939.options;
var _93a=_939.slider;
if(opts.mode=="h"){
var _93b=opts.min+(opts.max-opts.min)*(pos/_93a.width());
}else{
var _93b=opts.min+(opts.max-opts.min)*((_93a.height()-pos)/_93a.height());
}
return opts.reversed?opts.max-_93b.toFixed(0):_93b.toFixed(0);
};
$.fn.slider=function(_93c,_93d){
if(typeof _93c=="string"){
return $.fn.slider.methods[_93c](this,_93d);
}
_93c=_93c||{};
return this.each(function(){
var _93e=$.data(this,"slider");
if(_93e){
$.extend(_93e.options,_93c);
}else{
_93e=$.data(this,"slider",{options:$.extend({},$.fn.slider.defaults,$.fn.slider.parseOptions(this),_93c),slider:init(this)});
$(this).removeAttr("disabled");
}
...
$.fn.slider.parseOptions=function(_941){
var t=$(_941);
return $.extend({},$.parser.parseOptions(_941,["width","height","mode",{reversed:"boolean",showTip:"boolean",min:"number",max:"number",step:"number"}]),{value:(t.val()||undefined),disabled:(t.attr("disabled")?true:undefined),rule:(t.attr("rule")?eval(t.attr("rule")):undefined)});
};
$.fn.slider.defaults={width:"auto",height:"auto",mode:"h",reversed:false,showTip:false,disabled:false,value:0,min:0,max:100,step:1,rule:[],tipFormatter:function(_942){
return _942;
},onChange:function(_943,_944){
},onSlideStart:function(_945){
},onSlideEnd:function(_946){
},onComplete:function(_947){
}};
})(jQuery);
