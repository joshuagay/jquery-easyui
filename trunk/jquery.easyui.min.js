...
},insertRow:function(jq,_4e5){
return jq.each(function(){
_463(this,_4e5);
});
},deleteRow:function(jq,_4e6){
return jq.each(function(){
_45d(this,_4e6);
});
},getChanges:function(jq,_4e7){
return _457(jq[0],_4e7);
...
},mergeCells:function(jq,_4e8){
return jq.each(function(){
_47c(this,_4e8);
});
},showColumn:function(jq,_4e9){
return jq.each(function(){
var _4ea=$(this).datagrid("getPanel");
_4ea.find("td[field="+_4e9+"]").show();
$(this).datagrid("getColumnOption",_4e9).hidden=false;
$(this).datagrid("fitColumns");
});
},hideColumn:function(jq,_4eb){
return jq.each(function(){
var _4ec=$(this).datagrid("getPanel");
_4ec.find("td[field="+_4eb+"]").hide();
$(this).datagrid("getColumnOption",_4eb).hidden=true;
$(this).datagrid("fitColumns");
});
}};
$.fn.datagrid.parseOptions=function(_4ed){
var t=$(_4ed);
return $.extend({},$.fn.panel.parseOptions(_4ed),{fitColumns:(t.attr("fitColumns")?t.attr("fitColumns")=="true":undefined),striped:(t.attr("striped")?t.attr("striped")=="true":undefined),nowrap:(t.attr("nowrap")?t.attr("nowrap")=="true":undefined),rownumbers:(t.attr("rownumbers")?t.attr("rownumbers")=="true":undefined),singleSelect:(t.attr("singleSelect")?t.attr("singleSelect")=="true":undefined),pagination:(t.attr("pagination")?t.attr("pagination")=="true":undefined),pageSize:(t.attr("pageSize")?parseInt(t.attr("pageSize")):undefined),pageList:(t.attr("pageList")?eval(t.attr("pageList")):undefined),remoteSort:(t.attr("remoteSort")?t.attr("remoteSort")=="true":undefined),showHeader:(t.attr("showHeader")?t.attr("showHeader")=="true":undefined),showFooter:(t.attr("showFooter")?t.attr("showFooter")=="true":undefined),scrollbarSize:(t.attr("scrollbarSize")?parseInt(t.attr("scrollbarSize")):undefined),loadMsg:(t.attr("loadMsg")!=undefined?t.attr("loadMsg"):undefined),idField:t.attr("idField"),toolbar:t.attr("toolbar"),url:t.attr("url")});
};
var _4ee={render:function(_4ef,_4f0,_4f1){
var opts=$.data(_4ef,"datagrid").options;
var rows=$.data(_4ef,"datagrid").data.rows;
var _4f2=$(_4ef).datagrid("getColumnFields",_4f1);
if(_4f1){
if(!(opts.rownumbers||(opts.frozenColumns&&opts.frozenColumns.length))){
return;
}
}
var _4f3=["<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<rows.length;i++){
var cls=(i%2&&opts.striped)?"class=\"datagrid-row-alt\"":"";
var _4f4=opts.rowStyler?opts.rowStyler.call(_4ef,i,rows[i]):"";
var _4f5=_4f4?"style=\""+_4f4+"\"":"";
_4f3.push("<tr datagrid-row-index=\""+i+"\" "+cls+" "+_4f5+">");
_4f3.push(this.renderRow.call(this,_4ef,_4f2,_4f1,i,rows[i]));
_4f3.push("</tr>");
}
_4f3.push("</tbody></table>");
$(_4f0).html(_4f3.join(""));
},renderFooter:function(_4f6,_4f7,_4f8){
var opts=$.data(_4f6,"datagrid").options;
var rows=$.data(_4f6,"datagrid").footer||[];
var _4f9=$(_4f6).datagrid("getColumnFields",_4f8);
var _4fa=["<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<rows.length;i++){
_4fa.push("<tr datagrid-row-index=\""+i+"\">");
_4fa.push(this.renderRow.call(this,_4f6,_4f9,_4f8,i,rows[i]));
_4fa.push("</tr>");
}
_4fa.push("</tbody></table>");
$(_4f7).html(_4fa.join(""));
},renderRow:function(_4fb,_4fc,_4fd,_4fe,_4ff){
var opts=$.data(_4fb,"datagrid").options;
var cc=[];
if(_4fd&&opts.rownumbers){
var _500=_4fe+1;
if(opts.pagination){
_500+=(opts.pageNumber-1)*opts.pageSize;
}
cc.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\">"+_500+"</div></td>");
}
for(var i=0;i<_4fc.length;i++){
var _501=_4fc[i];
var col=$(_4fb).datagrid("getColumnOption",_501);
if(col){
var _502=col.styler?(col.styler(_4ff[_501],_4ff,_4fe)||""):"";
var _503=col.hidden?"style=\"display:none;"+_502+"\"":(_502?"style=\""+_502+"\"":"");
cc.push("<td field=\""+_501+"\" "+_503+">");
var _503="width:"+(col.boxWidth)+"px;";
_503+="text-align:"+(col.align||"left")+";";
_503+=opts.nowrap==false?"white-space:normal;":"";
cc.push("<div style=\""+_503+"\" ");
if(col.checkbox){
...
if(col.formatter){
cc.push(col.formatter(_4ff[_501],_4ff,_4fe));
}else{
cc.push(_4ff[_501]);
}
}
...
return cc.join("");
},refreshRow:function(_504,_505){
var opts=$.data(_504,"datagrid").options;
var _506=$(_504).datagrid("getPanel");
var rows=$(_504).datagrid("getRows");
var _507=opts.rowStyler?opts.rowStyler.call(_504,_505,rows[_505]):"";
var tr=_506.find("div.datagrid-body tr[datagrid-row-index="+_505+"]");
tr.attr("style",_507||"");
tr.children("td").each(function(){
var td=$(this);
var cell=td.find("div.datagrid-cell");
var _508=td.attr("field");
var col=$(_504).datagrid("getColumnOption",_508);
if(col){
var _509=col.styler?col.styler(rows[_505][_508],rows[_505],_505):"";
td.attr("style",_509||"");
if(col.hidden){
td.hide();
}
if(col.formatter){
cell.html(col.formatter(rows[_505][_508],rows[_505],_505));
}else{
cell.html(rows[_505][_508]);
}
}
});
$(_504).datagrid("fixRowHeight",_505);
},insertRow:function(_50a,_50b,row){
...
if(_50b==undefined||_50b==null){
_50b=data.rows.length;
}
if(_50b>data.rows.length){
_50b=data.rows.length;
}
for(var i=data.rows.length-1;i>=_50b;i--){
...
var _50e=$(_50a).datagrid("getColumnFields",true);
var _50f=$(_50a).datagrid("getColumnFields",false);
var tr1="<tr datagrid-row-index=\""+_50b+"\">"+this.renderRow.call(this,_50a,_50e,true,_50b,row)+"</tr>";
var tr2="<tr datagrid-row-index=\""+_50b+"\">"+this.renderRow.call(this,_50a,_50f,false,_50b,row)+"</tr>";
if(_50b>=data.rows.length){
var _510=_50c.children("div.datagrid-body").children("div.datagrid-body-inner");
var _511=_50d.children("div.datagrid-body");
if(data.rows.length){
_510.find("tr:last[datagrid-row-index]").after(tr1);
_511.find("tr:last[datagrid-row-index]").after(tr2);
}else{
_510.html("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"+tr1+"</tbody></table>");
_511.html("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"+tr2+"</tbody></table>");
}
}else{
_50c.children("div.datagrid-body").find("tr[datagrid-row-index="+(_50b+1)+"]").before(tr1);
_50d.children("div.datagrid-body").find("tr[datagrid-row-index="+(_50b+1)+"]").before(tr2);
}
data.total+=1;
data.rows.splice(_50b,0,row);
this.refreshRow.call(this,_50a,_50b);
},deleteRow:function(_512,_513){
var opts=$.data(_512,"datagrid").options;
var data=$.data(_512,"datagrid").data;
var view=$(_512).datagrid("getPanel").children("div.datagrid-view");
var _514=view.children("div.datagrid-view1");
var _515=view.children("div.datagrid-view2");
_514.children("div.datagrid-body").find("tr[datagrid-row-index="+_513+"]").remove();
_515.children("div.datagrid-body").find("tr[datagrid-row-index="+_513+"]").remove();
for(var i=_513+1;i<data.rows.length;i++){
_515.children("div.datagrid-body").find("tr[datagrid-row-index="+i+"]").attr("datagrid-row-index",i-1);
var tr=_514.children("div.datagrid-body").find("tr[datagrid-row-index="+i+"]").attr("datagrid-row-index",i-1);
if(opts.rownumbers){
tr.find("div.datagrid-cell-rownumber").html(i);
}
}
data.total-=1;
data.rows.splice(_513,1);
},onBeforeRender:function(_516,rows){
},onAfterRender:function(_517){
var opts=$.data(_517,"datagrid").options;
if(opts.showFooter){
var _518=$(_517).datagrid("getPanel").find("div.datagrid-footer");
_518.find("div.datagrid-cell-rownumber,div.datagrid-cell-check").css("visibility","hidden");
}
}};
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{frozenColumns:null,columns:null,fitColumns:false,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,loadMsg:"Processing, please wait ...",rownumbers:false,singleSelect:false,pagination:false,pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowStyler:function(_519,_51a){
...
},editors:_485,editConfig:{getTr:function(_51b,_51c){
return $(_51b).datagrid("getPanel").find("div.datagrid-body tr[datagrid-row-index="+_51c+"]");
},getRow:function(_51d,_51e){
return $.data(_51d,"datagrid").data.rows[_51e];
}},view:_4ee,onBeforeLoad:function(_51f){
},onLoadSuccess:function(){
},onLoadError:function(){
},onClickRow:function(_520,_521){
},onDblClickRow:function(_522,_523){
},onClickCell:function(_524,_525,_526){
},onDblClickCell:function(_527,_528,_529){
},onSortColumn:function(sort,_52a){
},onResizeColumn:function(_52b,_52c){
},onSelect:function(_52d,_52e){
},onUnselect:function(_52f,_530){
},onSelectAll:function(rows){
},onUnselectAll:function(rows){
},onBeforeEdit:function(_531,_532){
},onAfterEdit:function(_533,_534,_535){
},onCancelEdit:function(_536,_537){
},onHeaderContextMenu:function(e,_538){
},onRowContextMenu:function(e,_539,_53a){
}});
})(jQuery);
(function($){
function _53b(_53c){
var opts=$.data(_53c,"propertygrid").options;
$(_53c).datagrid($.extend({},opts,{view:(opts.showGroup?_53d:undefined),onClickRow:function(_53e,row){
if(opts.editIndex!=_53e){
var col=$(this).datagrid("getColumnOption","value");
col.editor=row.editor;
_53f(opts.editIndex);
$(this).datagrid("beginEdit",_53e);
$(this).datagrid("getEditors",_53e)[0].target.focus();
opts.editIndex=_53e;
}
opts.onClickRow.call(_53c,_53e,row);
}}));
$(_53c).datagrid("getPanel").panel("panel").addClass("propertygrid");
$(_53c).datagrid("getPanel").find("div.datagrid-body").unbind(".propertygrid").bind("mousedown.propertygrid",function(e){
e.stopPropagation();
});
...
var t=$(_53c);
if(t.datagrid("validateRow",_540)){
t.datagrid("endEdit",_540);
}else{
t.datagrid("cancelEdit",_540);
}
};
};
$.fn.propertygrid=function(_541,_542){
if(typeof _541=="string"){
var _543=$.fn.propertygrid.methods[_541];
if(_543){
return _543(this,_542);
}else{
return this.datagrid(_541,_542);
}
}
_541=_541||{};
return this.each(function(){
var _544=$.data(this,"propertygrid");
if(_544){
$.extend(_544.options,_541);
}else{
$.data(this,"propertygrid",{options:$.extend({},$.fn.propertygrid.defaults,$.fn.propertygrid.parseOptions(this),_541)});
}
_53b(this);
});
};
$.fn.propertygrid.methods={};
$.fn.propertygrid.parseOptions=function(_545){
var t=$(_545);
return $.extend({},$.fn.datagrid.parseOptions(_545),{showGroup:(t.attr("showGroup")?t.attr("showGroup")=="true":undefined)});
};
var _53d=$.extend({},$.fn.datagrid.defaults.view,{render:function(_546,_547,_548){
var opts=$.data(_546,"datagrid").options;
var rows=$.data(_546,"datagrid").data.rows;
var _549=$(_546).datagrid("getColumnFields",_548);
var _54a=[];
var _54b=0;
var _54c=this.groups;
for(var i=0;i<_54c.length;i++){
var _54d=_54c[i];
_54a.push("<div class=\"datagrid-group\" group-index="+i+">");
_54a.push("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" style=\"height:100%\"><tbody>");
_54a.push("<tr>");
_54a.push("<td style=\"border:0;\">");
if(!_548){
_54a.push("<span>");
_54a.push(opts.groupFormatter.call(_546,_54d.fvalue,_54d.rows));
_54a.push("</span>");
}
_54a.push("</td>");
_54a.push("</tr>");
_54a.push("</tbody></table>");
_54a.push("</div>");
_54a.push("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>");
for(var j=0;j<_54d.rows.length;j++){
var cls=(_54b%2&&opts.striped)?"class=\"datagrid-row-alt\"":"";
var _54e=opts.rowStyler?opts.rowStyler.call(_546,_54b,_54d.rows[j]):"";
var _54f=_54e?"style=\""+_54e+"\"":"";
_54a.push("<tr datagrid-row-index=\""+_54b+"\" "+cls+" "+_54f+">");
_54a.push(this.renderRow.call(this,_546,_549,_548,_54b,_54d.rows[j]));
_54a.push("</tr>");
_54b++;
}
_54a.push("</tbody></table>");
...
var view=$(_550).datagrid("getPanel").find("div.datagrid-view");
var _551=view.children("div.datagrid-view1");
var _552=view.children("div.datagrid-view2");
$.fn.datagrid.defaults.view.onAfterRender.call(this,_550);
if(opts.rownumbers||opts.frozenColumns.length){
var _553=_551.find("div.datagrid-group");
}else{
var _553=_552.find("div.datagrid-group");
}
$("<td style=\"border:0\"><div class=\"datagrid-row-expander datagrid-row-collapse\" style=\"width:25px;height:16px;cursor:pointer\"></div></td>").insertBefore(_553.find("td"));
view.find("div.datagrid-group").each(function(){
var _554=$(this).attr("group-index");
$(this).find("div.datagrid-row-expander").bind("click",{groupIndex:_554},function(e){
var _555=view.find("div.datagrid-group[group-index="+e.data.groupIndex+"]");
if($(this).hasClass("datagrid-row-collapse")){
$(this).removeClass("datagrid-row-collapse").addClass("datagrid-row-expand");
_555.next("table").hide();
}else{
$(this).removeClass("datagrid-row-expand").addClass("datagrid-row-collapse");
_555.next("table").show();
}
$(_550).datagrid("fixRowHeight");
});
});
},onBeforeRender:function(_556,rows){
var opts=$.data(_556,"datagrid").options;
var _557=[];
for(var i=0;i<rows.length;i++){
var row=rows[i];
var _558=_559(row[opts.groupField]);
if(!_558){
_558={fvalue:row[opts.groupField],rows:[row],startRow:i};
_557.push(_558);
}else{
_558.rows.push(row);
}
...
for(var i=0;i<_557.length;i++){
var _558=_557[i];
for(var j=0;j<_558.rows.length;j++){
_55c.push(_558.rows[j]);
}
}
$.data(_556,"datagrid").data.rows=_55c;
}});
$.fn.propertygrid.defaults=$.extend({},$.fn.datagrid.defaults,{singleSelect:true,remoteSort:false,fitColumns:true,loadMsg:"",frozenColumns:[[{field:"f",width:16,resizable:false}]],columns:[[{field:"name",title:"Name",width:100,sortable:true},{field:"value",title:"Value",width:100,resizable:false}]],showGroup:false,groupField:"group",groupFormatter:function(_55d){
return _55d;
}});
})(jQuery);
(function($){
...
$(_55f).datagrid($.extend({},opts,{url:null,onLoadSuccess:function(){
},onResizeColumn:function(_560,_561){
_56a(_55f);
opts.onResizeColumn.call(_55f,_560,_561);
},onBeforeEdit:function(_562,row){
if(opts.onBeforeEdit.call(_55f,row)==false){
return false;
}
},onAfterEdit:function(_563,row,_564){
_57b(_55f);
opts.onAfterEdit.call(_55f,row,_564);
},onCancelEdit:function(_565,row){
_57b(_55f);
opts.onCancelEdit.call(_55f,row);
}}));
if(opts.pagination){
var _566=$(_55f).datagrid("getPager");
_566.pagination({pageNumber:opts.pageNumber,pageSize:opts.pageSize,pageList:opts.pageList,onSelectPage:function(_567,_568){
opts.pageNumber=_567;
opts.pageSize=_568;
_569(_55f);
}});
opts.pageSize=_566.pagination("options").pageSize;
}
};
function _56a(_56b,_56c){
var opts=$.data(_56b,"datagrid").options;
var _56d=$.data(_56b,"datagrid").panel;
var view=_56d.children("div.datagrid-view");
var _56e=view.children("div.datagrid-view1");
var _56f=view.children("div.datagrid-view2");
if(opts.rownumbers||(opts.frozenColumns&&opts.frozenColumns.length>0)){
if(_56c){
_570(_56c);
_56f.find("tr[node-id="+_56c+"]").next("tr.treegrid-tr-tree").find("tr[node-id]").each(function(){
_570($(this).attr("node-id"));
});
}else{
_56f.find("tr[node-id]").each(function(){
_570($(this).attr("node-id"));
});
if(opts.showFooter){
var _571=$.data(_56b,"datagrid").footer||[];
for(var i=0;i<_571.length;i++){
_570(_571[i][opts.idField]);
}
$(_56b).datagrid("resize");
}
}
}
if(opts.height=="auto"){
var _572=_56e.children("div.datagrid-body");
var _573=_56f.children("div.datagrid-body");
var _574=0;
var _575=0;
_573.children().each(function(){
var c=$(this);
if(c.is(":visible")){
_574+=c.outerHeight();
if(_575<c.outerWidth()){
_575=c.outerWidth();
}
}
});
...
_572.height(_574);
_573.height(_574);
view.height(_56f.height());
}
_56f.children("div.datagrid-body").triggerHandler("scroll");
function _570(_576){
var tr1=_56e.find("tr[node-id="+_576+"]");
var tr2=_56f.find("tr[node-id="+_576+"]");
tr1.css("height","");
tr2.css("height","");
var _577=Math.max(tr1.height(),tr2.height());
tr1.css("height",_577);
tr2.css("height",_577);
};
};
function _578(_579){
var opts=$.data(_579,"treegrid").options;
if(!opts.rownumbers){
return;
}
$(_579).datagrid("getPanel").find("div.datagrid-view1 div.datagrid-body div.datagrid-cell-rownumber").each(function(i){
var _57a=i+1;
$(this).html(_57a);
});
};
...
var _57d=$(_57c).datagrid("getPanel");
var body=_57d.find("div.datagrid-body");
...
opts.onClickRow.call(_57c,find(_57c,id));
}).bind("dblclick.treegrid",function(){
var id=$(this).attr("node-id");
opts.onDblClickRow.call(_57c,find(_57c,id));
}).bind("contextmenu.treegrid",function(e){
var id=$(this).attr("node-id");
opts.onContextMenu.call(_57c,e,find(_57c,id));
});
...
var _57e=_57d.find("div.datagrid-header");
_57e.find("input[type=checkbox]").unbind().bind("click.treegrid",function(){
if(opts.singleSelect){
return false;
}
if($(this).attr("checked")){
...
var view=$(_582).datagrid("getPanel").children("div.datagrid-view");
var _584=view.children("div.datagrid-view1");
var _585=view.children("div.datagrid-view2");
var tr1=_584.children("div.datagrid-body").find("tr[node-id="+_583+"]");
var tr2=_585.children("div.datagrid-body").find("tr[node-id="+_583+"]");
var _586=$(_582).datagrid("getColumnFields",true).length+(opts.rownumbers?1:0);
var _587=$(_582).datagrid("getColumnFields",false).length;
_588(tr1,_586);
_588(tr2,_587);
function _588(tr,_589){
$("<tr class=\"treegrid-tr-tree\">"+"<td style=\"border:0px\" colspan=\""+_589+"\">"+"<div></div>"+"</td>"+"</tr>").insertAfter(tr);
};
};
function _58a(_58b,_58c,data,_58d){
var opts=$.data(_58b,"treegrid").options;
var wrap=$.data(_58b,"datagrid").panel;
var view=wrap.children("div.datagrid-view");
var _58e=view.children("div.datagrid-view1");
var _58f=view.children("div.datagrid-view2");
var node=find(_58b,_58c);
if(node){
var _590=_58e.children("div.datagrid-body").find("tr[node-id="+_58c+"]");
var _591=_58f.children("div.datagrid-body").find("tr[node-id="+_58c+"]");
var cc1=_590.next("tr.treegrid-tr-tree").children("td").children("div");
var cc2=_591.next("tr.treegrid-tr-tree").children("td").children("div");
}else{
var cc1=_58e.children("div.datagrid-body").children("div.datagrid-body-inner");
var cc2=_58f.children("div.datagrid-body");
}
if(!_58d){
$.data(_58b,"treegrid").data=[];
cc1.empty();
cc2.empty();
}
if(opts.view.onBeforeRender){
opts.view.onBeforeRender.call(opts.view,_58b,_58c,data);
}
opts.view.render.call(opts.view,_58b,cc1,true);
opts.view.render.call(opts.view,_58b,cc2,false);
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,_58b,_58e.find("div.datagrid-footer-inner"),true);
opts.view.renderFooter.call(opts.view,_58b,_58f.find("div.datagrid-footer-inner"),false);
}
if(opts.view.onAfterRender){
opts.view.onAfterRender.call(opts.view,_58b);
}
opts.onLoadSuccess.call(_58b,node,data);
if(!_58c&&opts.pagination){
var _592=$(_58b).datagrid("getPager");
if(_592.pagination("options").total!=data.total){
_592.pagination({total:data.total});
}
}
_56a(_58b);
_578(_58b);
...
_57b(_58b);
function _593(){
var _594=view.find("div.datagrid-header");
var body=view.find("div.datagrid-body");
var _595=_594.find("div.datagrid-header-check");
if(_595.length){
var ck=body.find("div.datagrid-cell-check");
if($.boxModel){
ck.width(_595.width());
ck.height(_595.height());
}else{
ck.width(_595.outerWidth());
ck.height(_595.outerHeight());
}
}
};
};
function _569(_596,_597,_598,_599,_59a){
var opts=$.data(_596,"treegrid").options;
var body=$(_596).datagrid("getPanel").find("div.datagrid-body");
if(_598){
opts.queryParams=_598;
}
var _59b=$.extend({},opts.queryParams);
var row=find(_596,_597);
if(opts.onBeforeLoad.call(_596,row,_59b)==false){
return;
}
if(!opts.url){
return;
}
var _59c=body.find("tr[node-id="+_597+"] span.tree-folder");
_59c.addClass("tree-loading");
$(_596).treegrid("loading");
$.ajax({type:opts.method,url:opts.url,data:_59b,dataType:"json",success:function(data){
_59c.removeClass("tree-loading");
$(_596).treegrid("loaded");
_58a(_596,_597,data,_599);
if(_59a){
_59a();
}
},error:function(){
_59c.removeClass("tree-loading");
$(_596).treegrid("loaded");
opts.onLoadError.apply(_596,arguments);
if(_59a){
_59a();
}
}});
...
function _59f(_5a0){
return $.data(_5a0,"treegrid").data;
};
function _5a1(_5a2,_5a3){
var row=find(_5a2,_5a3);
if(row._parentId){
return find(_5a2,row._parentId);
}else{
return null;
}
};
...
var body=$(_5a5).datagrid("getPanel").find("div.datagrid-view2 div.datagrid-body");
var _5a7=[];
if(_5a6){
_5a8(_5a6);
}else{
...
_5a7.push(_5a9[i]);
_5a8(_5a9[i][opts.idField]);
}
}
function _5a8(_5aa){
var _5ab=find(_5a5,_5aa);
if(_5ab&&_5ab.children){
for(var i=0,len=_5ab.children.length;i<len;i++){
var _5ac=_5ab.children[i];
_5a7.push(_5ac);
_5a8(_5ac[opts.idField]);
}
}
};
return _5a7;
...
function _5af(_5b0){
var rows=[];
var _5b1=$(_5b0).datagrid("getPanel");
_5b1.find("div.datagrid-view2 div.datagrid-body tr.datagrid-row-selected").each(function(){
var id=$(this).attr("node-id");
rows.push(find(_5b0,id));
});
return rows;
};
...
var view=$(_5b3).datagrid("getPanel").children("div.datagrid-view");
var node=view.find("div.datagrid-body tr[node-id="+_5b4+"]").children("td[field="+opts.treeField+"]");
return node.find("span.tree-indent,span.tree-hit").length;
};
function find(_5b5,_5b6){
var opts=$.data(_5b5,"treegrid").options;
var data=$.data(_5b5,"treegrid").data;
var cc=[data];
while(cc.length){
var c=cc.shift();
for(var i=0;i<c.length;i++){
var node=c[i];
if(node[opts.idField]==_5b6){
return node;
}else{
if(node["children"]){
...
var body=$(_5bb).datagrid("getPanel").find("div.datagrid-body");
var tr=body.find("tr[node-id="+_5bc+"]");
tr.removeClass("datagrid-row-selected");
tr.find("div.datagrid-cell-check input[type=checkbox]").attr("checked",false);
};
function _57f(_5bd){
var tr=$(_5bd).datagrid("getPanel").find("div.datagrid-body tr[node-id]");
tr.addClass("datagrid-row-selected");
tr.find("div.datagrid-cell-check input[type=checkbox]").attr("checked",true);
};
function _580(_5be){
var tr=$(_5be).datagrid("getPanel").find("div.datagrid-body tr[node-id]");
tr.removeClass("datagrid-row-selected");
tr.find("div.datagrid-cell-check input[type=checkbox]").attr("checked",false);
};
function _5bf(_5c0,_5c1){
var opts=$.data(_5c0,"treegrid").options;
var body=$(_5c0).datagrid("getPanel").find("div.datagrid-body");
var row=find(_5c0,_5c1);
var tr=body.find("tr[node-id="+_5c1+"]");
...
if(opts.onBeforeCollapse.call(_5c0,row)==false){
return;
}
hit.removeClass("tree-expanded tree-expanded-hover").addClass("tree-collapsed");
hit.next().removeClass("tree-folder-open");
...
var tr=body.find("tr[node-id="+_5c4+"]");
var hit=tr.find("span.tree-hit");
var row=find(_5c3,_5c4);
if(hit.length==0){
return;
}
if(hit.hasClass("tree-expanded")){
...
if(opts.onBeforeExpand.call(_5c3,row)==false){
return;
}
hit.removeClass("tree-collapsed tree-collapsed-hover").addClass("tree-expanded");
hit.next().addClass("tree-folder-open");
var _5c5=tr.next("tr.treegrid-tr-tree");
if(_5c5.length){
var cc=_5c5.children("td").children("div");
_5c6(cc);
}else{
_581(_5c3,row[opts.idField]);
var _5c5=tr.next("tr.treegrid-tr-tree");
var cc=_5c5.children("td").children("div");
cc.hide();
_569(_5c3,row[opts.idField],{id:row[opts.idField]},true,function(){
_5c6(cc);
});
}
function _5c6(cc){
...
var body=$(_5c8).datagrid("getPanel").find("div.datagrid-body");
var tr=body.find("tr[node-id="+_5c9+"]");
var hit=tr.find("span.tree-hit");
if(hit.hasClass("tree-expanded")){
_5bf(_5c8,_5c9);
}else{
...
function _5ca(_5cb,_5cc){
var opts=$.data(_5cb,"treegrid").options;
var _5cd=_5a4(_5cb,_5cc);
if(_5cc){
_5cd.unshift(find(_5cb,_5cc));
}
for(var i=0;i<_5cd.length;i++){
_5bf(_5cb,_5cd[i][opts.idField]);
}
};
function _5ce(_5cf,_5d0){
var opts=$.data(_5cf,"treegrid").options;
var _5d1=_5a4(_5cf,_5d0);
if(_5d0){
_5d1.unshift(find(_5cf,_5d0));
}
for(var i=0;i<_5d1.length;i++){
_5c2(_5cf,_5d1[i][opts.idField]);
}
};
function _5d2(_5d3,_5d4){
var opts=$.data(_5d3,"treegrid").options;
var ids=[];
var p=_5a1(_5d3,_5d4);
while(p){
...
var tr=body.find("tr[node-id="+_5d7.parent+"]");
if(tr.next("tr.treegrid-tr-tree").length==0){
_581(_5d6,_5d7.parent);
}
var cell=tr.children("td[field="+opts.treeField+"]").children("div.datagrid-cell");
var _5d8=cell.children("span.tree-icon");
if(_5d8.hasClass("tree-file")){
_5d8.removeClass("tree-file").addClass("tree-folder");
var hit=$("<span class=\"tree-hit tree-expanded\"></span>").insertBefore(_5d8);
if(hit.prev().length){
hit.prev().remove();
}
}
}
_58a(_5d6,_5d7.parent,_5d7.data,true);
};
function _5d9(_5da,_5db){
var opts=$.data(_5da,"treegrid").options;
var body=$(_5da).datagrid("getPanel").find("div.datagrid-body");
var tr=body.find("tr[node-id="+_5db+"]");
tr.next("tr.treegrid-tr-tree").remove();
tr.remove();
var _5dc=del(_5db);
if(_5dc){
if(_5dc.children.length==0){
tr=body.find("tr[node-id="+_5dc[opts.treeField]+"]");
var cell=tr.children("td[field="+opts.treeField+"]").children("div.datagrid-cell");
...
function del(id){
var cc;
var _5dd=_5a1(_5da,_5db);
if(_5dd){
cc=_5dd.children;
}else{
cc=$(_5da).treegrid("getData");
}
for(var i=0;i<cc.length;i++){
...
$.fn.treegrid=function(_5de,_5df){
if(typeof _5de=="string"){
var _5e0=$.fn.treegrid.methods[_5de];
if(_5e0){
return _5e0(this,_5df);
}else{
return this.datagrid(_5de,_5df);
}
}
_5de=_5de||{};
return this.each(function(){
var _5e1=$.data(this,"treegrid");
if(_5e1){
$.extend(_5e1.options,_5de);
}else{
$.data(this,"treegrid",{options:$.extend({},$.fn.treegrid.defaults,$.fn.treegrid.parseOptions(this),_5de),data:[]});
}
_55e(this);
_569(this);
});
...
},resize:function(jq,_5e2){
return jq.each(function(){
$(this).datagrid("resize",_5e2);
});
},fixRowHeight:function(jq,_5e3){
return jq.each(function(){
_56a(this,_5e3);
});
},loadData:function(jq,data){
...
},reloadFooter:function(jq,_5e4){
return jq.each(function(){
var opts=$.data(this,"treegrid").options;
var view=$(this).datagrid("getPanel").children("div.datagrid-view");
var _5e5=view.children("div.datagrid-view1");
var _5e6=view.children("div.datagrid-view2");
if(_5e4){
$.data(this,"treegrid").footer=_5e4;
}
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,this,_5e5.find("div.datagrid-footer-inner"),true);
opts.view.renderFooter.call(opts.view,this,_5e6.find("div.datagrid-footer-inner"),false);
if(opts.view.onAfterRender){
opts.view.onAfterRender.call(opts.view,this);
}
...
$.fn.treegrid.parseOptions=function(_5e8){
var t=$(_5e8);
return $.extend({},$.fn.datagrid.parseOptions(_5e8),{treeField:t.attr("treeField"),animate:(t.attr("animate")?t.attr("animate")=="true":undefined)});
};
var _5e9=$.extend({},$.fn.datagrid.defaults.view,{render:function(_5ea,_5eb,_5ec){
var opts=$.data(_5ea,"treegrid").options;
var _5ed=$(_5ea).datagrid("getColumnFields",_5ec);
var view=this;
var _5ee=_5ef(_5ec,this.treeLevel,this.treeNodes);
$(_5eb).append(_5ee.join(""));
function _5ef(_5f0,_5f1,_5f2){
var _5f3=["<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<_5f2.length;i++){
var row=_5f2[i];
if(row.state!="open"&&row.state!="closed"){
row.state="open";
}
var _5f4=opts.rowStyler?opts.rowStyler.call(_5ea,row):"";
var _5f5=_5f4?"style=\""+_5f4+"\"":"";
_5f3.push("<tr node-id="+row[opts.idField]+" "+_5f5+">");
_5f3=_5f3.concat(view.renderRow.call(view,_5ea,_5ed,_5f0,_5f1,row));
_5f3.push("</tr>");
if(row.children&&row.children.length){
var tt=_5ef(_5f0,_5f1+1,row.children);
var v=row.state=="closed"?"none":"block";
_5f3.push("<tr class=\"treegrid-tr-tree\"><td style=\"border:0px\" colspan="+(_5ed.length+(opts.rownumbers?1:0))+"><div style=\"display:"+v+"\">");
_5f3=_5f3.concat(tt);
_5f3.push("</div></td></tr>");
}
}
_5f3.push("</tbody></table>");
return _5f3;
};
},renderFooter:function(_5f6,_5f7,_5f8){
var opts=$.data(_5f6,"treegrid").options;
var rows=$.data(_5f6,"treegrid").footer||[];
var _5f9=$(_5f6).datagrid("getColumnFields",_5f8);
var _5fa=["<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<rows.length;i++){
var row=rows[i];
row[opts.idField]=row[opts.idField]||("foot-row-id"+i);
_5fa.push("<tr node-id="+row[opts.idField]+">");
_5fa.push(this.renderRow.call(this,_5f6,_5f9,_5f8,0,row));
_5fa.push("</tr>");
}
_5fa.push("</tbody></table>");
$(_5f7).html(_5fa.join(""));
},renderRow:function(_5fb,_5fc,_5fd,_5fe,row){
var opts=$.data(_5fb,"treegrid").options;
var cc=[];
if(_5fd&&opts.rownumbers){
cc.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\">0</div></td>");
}
for(var i=0;i<_5fc.length;i++){
var _5ff=_5fc[i];
var col=$(_5fb).datagrid("getColumnOption",_5ff);
if(col){
var _600=col.styler?(col.styler(row[_5ff],row)||""):"";
var _601=col.hidden?"style=\"display:none;"+_600+"\"":(_600?"style=\""+_600+"\"":"");
cc.push("<td field=\""+_5ff+"\" "+_601+">");
var _601="width:"+(col.boxWidth)+"px;";
_601+="text-align:"+(col.align||"left")+";";
_601+=opts.nowrap==false?"white-space:normal;":"";
cc.push("<div style=\""+_601+"\" ");
if(col.checkbox){
cc.push("class=\"datagrid-cell-check ");
}else{
cc.push("class=\"datagrid-cell ");
...
var val=null;
if(col.formatter){
val=col.formatter(row[_5ff],row);
}else{
val=row[_5ff]||"&nbsp;";
}
if(_5ff==opts.treeField){
for(var j=0;j<_5fe;j++){
...
return cc.join("");
},refreshRow:function(_602,id){
var row=$(_602).treegrid("find",id);
var opts=$.data(_602,"treegrid").options;
var body=$(_602).datagrid("getPanel").find("div.datagrid-body");
var _603=opts.rowStyler?opts.rowStyler.call(_602,row):"";
var _604=_603?"style=\""+_603+"\"":"";
var tr=body.find("tr[node-id="+id+"]");
tr.attr("style",_604);
tr.children("td").each(function(){
var cell=$(this).find("div.datagrid-cell");
var _605=$(this).attr("field");
var col=$(_602).datagrid("getColumnOption",_605);
if(col){
var _606=col.styler?(col.styler(row[_605],row)||""):"";
var _607=col.hidden?"style=\"display:none;"+_606+"\"":(_606?"style=\""+_606+"\"":"");
$(this).attr("style",_607);
var val=null;
if(col.formatter){
val=col.formatter(row[_605],row);
}else{
val=row[_605]||"&nbsp;";
}
if(_605==opts.treeField){
...
$(_602).treegrid("fixRowHeight",id);
},onBeforeRender:function(_608,_609,data){
var opts=$.data(_608,"treegrid").options;
if(data.length==undefined){
if(data.footer){
$.data(_608,"treegrid").footer=data.footer;
}
data=this.transfer(_608,_609,data.rows);
}else{
...
row._parentId=_60c;
if(row.children&&row.children.length){
_60a(row.children,row[opts.idField]);
}
}
};
_60a(data,_609);
}
var node=find(_608,_609);
if(node){
if(node.children){
...
$.data(_608,"treegrid").data=$.data(_608,"treegrid").data.concat(data);
}
this.treeNodes=data;
this.treeLevel=$(_608).treegrid("getLevel",_609);
},transfer:function(_60d,_60e,data){
...
$.fn.treegrid.defaults=$.extend({},$.fn.datagrid.defaults,{treeField:null,animate:false,singleSelect:true,view:_5e9,editConfig:{getTr:function(_610,id){
return $(_610).datagrid("getPanel").find("div.datagrid-body tr[node-id="+id+"]");
},getRow:function(_611,id){
return $(_611).treegrid("find",id);
}},onBeforeLoad:function(row,_612){
...
},onAfterEdit:function(row,_613){
},onCancelEdit:function(row){
}});
})(jQuery);
(function($){
function _614(_615,_616){
var opts=$.data(_615,"combo").options;
var _617=$.data(_615,"combo").combo;
var _618=$.data(_615,"combo").panel;
if(_616){
opts.width=_616;
}
_617.appendTo("body");
if(isNaN(opts.width)){
opts.width=_617.find("input.combo-text").outerWidth();
}
var _619=0;
if(opts.hasDownArrow){
_619=_617.find(".combo-arrow").outerWidth();
}
var _616=opts.width-_619;
if($.boxModel==true){
_616-=_617.outerWidth()-_617.width();
}
_617.find("input.combo-text").width(_616);
_618.panel("resize",{width:(opts.panelWidth?opts.panelWidth:_617.outerWidth()),height:opts.panelHeight});
_617.insertAfter(_615);
};
function _61a(_61b){
var opts=$.data(_61b,"combo").options;
var _61c=$.data(_61b,"combo").combo;
if(opts.hasDownArrow){
_61c.find(".combo-arrow").show();
}else{
_61c.find(".combo-arrow").hide();
}
};
function init(_61d){
$(_61d).addClass("combo-f").hide();
var span=$("<span class=\"combo\"></span>").insertAfter(_61d);
var _61e=$("<input type=\"text\" class=\"combo-text\">").appendTo(span);
$("<span><span class=\"combo-arrow\"></span></span>").appendTo(span);
$("<input type=\"hidden\" class=\"combo-value\">").appendTo(span);
var _61f=$("<div class=\"combo-panel\"></div>").appendTo("body");
_61f.panel({doSize:false,closed:true,style:{position:"absolute",zIndex:10},onOpen:function(){
$(this).panel("resize");
}});
var name=$(_61d).attr("name");
if(name){
span.find("input.combo-value").attr("name",name);
$(_61d).removeAttr("name").attr("comboName",name);
}
_61e.attr("autocomplete","off");
return {combo:span,panel:_61f};
};
function _620(_621){
var _622=$.data(_621,"combo").combo.find("input.combo-text");
_622.validatebox("destroy");
$.data(_621,"combo").panel.panel("destroy");
$.data(_621,"combo").combo.remove();
$(_621).remove();
};
function _623(_624){
var opts=$.data(_624,"combo").options;
var _625=$.data(_624,"combo").combo;
var _626=$.data(_624,"combo").panel;
var _627=_625.find(".combo-text");
var _628=_625.find(".combo-arrow");
...
_626.bind("mousedown.combo",function(e){
return false;
});
_627.bind("mousedown.combo",function(e){
e.stopPropagation();
}).bind("keydown.combo",function(e){
switch(e.keyCode){
case 38:
opts.keyHandler.up.call(_624);
break;
case 40:
opts.keyHandler.down.call(_624);
break;
case 13:
e.preventDefault();
opts.keyHandler.enter.call(_624);
return false;
case 9:
case 27:
_62e(_624);
...
setTimeout(function(){
var q=_627.val();
if($.data(_624,"combo").previousValue!=q){
$.data(_624,"combo").previousValue=q;
_629(_624);
opts.keyHandler.query.call(_624,_627.val());
_631(_624,true);
}
},10);
}
...
_628.bind("click.combo",function(){
_627.focus();
_629(_624);
...
function _629(_62a){
var opts=$.data(_62a,"combo").options;
var _62b=$.data(_62a,"combo").combo;
var _62c=$.data(_62a,"combo").panel;
if($.fn.window){
_62c.panel("panel").css("z-index",$.fn.window.defaults.zIndex++);
}
_62c.panel("move",{left:_62b.offset().left,top:_62d()});
_62c.panel("open");
opts.onShowPanel.call(_62a);
(function(){
if(_62c.is(":visible")){
_62c.panel("move",{left:_62b.offset().left,top:_62d()});
setTimeout(arguments.callee,200);
...
function _62d(){
var top=_62b.offset().top+_62b.outerHeight();
if(top+_62c.outerHeight()>$(window).height()+$(document).scrollTop()){
top=_62b.offset().top-_62c.outerHeight();
}
if(top<$(document).scrollTop()){
top=_62b.offset().top+_62b.outerHeight();
}
return top;
};
};
function _62e(_62f){
var opts=$.data(_62f,"combo").options;
var _630=$.data(_62f,"combo").panel;
_630.panel("close");
opts.onHidePanel.call(_62f);
};
function _631(_632,doit){
var opts=$.data(_632,"combo").options;
var _633=$.data(_632,"combo").combo.find("input.combo-text");
_633.validatebox(opts);
if(doit){
_633.validatebox("validate");
_633.trigger("mouseleave");
}
};
...
if(_636){
opts.disabled=true;
$(_635).attr("disabled",true);
_637.find(".combo-value").attr("disabled",true);
_637.find(".combo-text").attr("disabled",true);
}else{
opts.disabled=false;
$(_635).removeAttr("disabled");
_637.find(".combo-value").removeAttr("disabled");
_637.find(".combo-text").removeAttr("disabled");
}
};
function _638(_639){
var opts=$.data(_639,"combo").options;
var _63a=$.data(_639,"combo").combo;
if(opts.multiple){
_63a.find("input.combo-value").remove();
}else{
_63a.find("input.combo-value").val("");
}
_63a.find("input.combo-text").val("");
};
function _63b(_63c){
var _63d=$.data(_63c,"combo").combo;
return _63d.find("input.combo-text").val();
};
function _63e(_63f,text){
var _640=$.data(_63f,"combo").combo;
_640.find("input.combo-text").val(text);
_631(_63f,true);
$.data(_63f,"combo").previousValue=text;
};
function _641(_642){
var _643=[];
var _644=$.data(_642,"combo").combo;
_644.find("input.combo-value").each(function(){
_643.push($(this).val());
});
return _643;
};
function _645(_646,_647){
var opts=$.data(_646,"combo").options;
var _648=_641(_646);
var _649=$.data(_646,"combo").combo;
_649.find("input.combo-value").remove();
var name=$(_646).attr("comboName");
for(var i=0;i<_647.length;i++){
var _64a=$("<input type=\"hidden\" class=\"combo-value\">").appendTo(_649);
if(name){
_64a.attr("name",name);
}
_64a.val(_647[i]);
...
if(aa.length!=_647.length||_647.length!=_648.length){
if(opts.multiple){
opts.onChange.call(_646,_647,_648);
}else{
opts.onChange.call(_646,_647[0],_648[0]);
}
}
};
function _64b(_64c){
...
_645(_652,opts.value);
}else{
_64e(_652,opts.value);
}
}else{
_645(_652,[]);
}
...
$.fn.combo=function(_653,_654){
if(typeof _653=="string"){
return $.fn.combo.methods[_653](this,_654);
}
_653=_653||{};
return this.each(function(){
var _655=$.data(this,"combo");
if(_655){
$.extend(_655.options,_653);
}else{
var r=init(this);
_655=$.data(this,"combo",{options:$.extend({},$.fn.combo.defaults,$.fn.combo.parseOptions(this),_653),combo:r.combo,panel:r.panel,previousValue:null});
$(this).removeAttr("disabled");
}
$("input.combo-text",_655.combo).attr("readonly",!_655.options.editable);
_61a(this);
_634(this,_655.options.disabled);
_614(this);
_623(this);
_631(this);
_651(this);
...
var _657=$.data(jq[0],"combo").combo.find("input.combo-text");
return _657.validatebox("isValid");
},clear:function(jq){
return jq.each(function(){
_638(this);
});
...
},onChange:function(_65b,_65c){
}});
})(jQuery);
(function($){
function _65d(_65e,_65f){
var _660=$(_65e).combo("panel");
var item=_660.find("div.combobox-item[value="+_65f+"]");
if(item.length){
if(item.position().top<=0){
var h=_660.scrollTop()+item.position().top;
_660.scrollTop(h);
}else{
if(item.position().top+item.outerHeight()>_660.height()){
var h=_660.scrollTop()+item.position().top+item.outerHeight()-_660.height();
_660.scrollTop(h);
}
}
}
...
function _661(_662){
var _663=$(_662).combo("panel");
var _664=$(_662).combo("getValues");
var item=_663.find("div.combobox-item[value="+_664.pop()+"]");
if(item.length){
...
item=_663.find("div.combobox-item:visible:last");
}
var _665=item.attr("value");
_666(_662,[_665]);
_65d(_662,_665);
};
function _667(_668){
var _669=$(_668).combo("panel");
var _66a=$(_668).combo("getValues");
var item=_669.find("div.combobox-item[value="+_66a.pop()+"]");
if(item.length){
...
item=_669.find("div.combobox-item:visible:first");
}
var _66b=item.attr("value");
_666(_668,[_66b]);
_65d(_668,_66b);
};
function _66c(_66d,_66e){
var opts=$.data(_66d,"combobox").options;
var data=$.data(_66d,"combobox").data;
if(opts.multiple){
var _66f=$(_66d).combo("getValues");
...
for(var i=0;i<data.length;i++){
if(data[i][opts.valueField]==_66e){
opts.onSelect.call(_66d,data[i]);
return;
}
}
};
function _670(_671,_672){
var opts=$.data(_671,"combobox").options;
var data=$.data(_671,"combobox").data;
var _673=$(_671).combo("getValues");
...
for(var i=0;i<data.length;i++){
if(data[i][opts.valueField]==_672){
opts.onUnselect.call(_671,data[i]);
return;
}
}
};
function _666(_674,_675,_676){
var opts=$.data(_674,"combobox").options;
var data=$.data(_674,"combobox").data;
var _677=$(_674).combo("panel");
_677.find("div.combobox-item-selected").removeClass("combobox-item-selected");
var vv=[],ss=[];
...
vv.push(v);
ss.push(s);
_677.find("div.combobox-item[value="+v+"]").addClass("combobox-item-selected");
}
$(_674).combo("setValues",vv);
if(!_676){
$(_674).combo("setText",ss.join(opts.separator));
}
};
function _678(_679){
var opts=$.data(_679,"combobox").options;
var data=[];
$(">option",_679).each(function(){
var item={};
...
function _67a(_67b,data,_67c){
var opts=$.data(_67b,"combobox").options;
var _67d=$(_67b).combo("panel");
$.data(_67b,"combobox").data=data;
var _67e=$(_67b).combobox("getValues");
_67d.empty();
for(var i=0;i<data.length;i++){
var v=data[i][opts.valueField];
var s=data[i][opts.textField];
var item=$("<div class=\"combobox-item\"></div>").appendTo(_67d);
item.attr("value",v);
if(opts.formatter){
item.html(opts.formatter.call(_67b,data[i]));
}else{
item.html(s);
}
if(data[i]["selected"]){
...
if(_67e.length){
_666(_67b,[_67e[_67e.length-1]],_67c);
}else{
_666(_67b,[],_67c);
}
}
opts.onLoadSuccess.call(_67b,data);
$(".combobox-item",_67d).hover(function(){
...
_670(_67b,item.attr("value"));
}else{
_66c(_67b,item.attr("value"));
}
}else{
_66c(_67b,item.attr("value"));
...
function _67f(_680,url,_681,_682){
var opts=$.data(_680,"combobox").options;
if(url){
opts.url=url;
}
if(!opts.url){
...
_681=_681||{};
$.ajax({type:opts.method,url:opts.url,dataType:"json",data:_681,success:function(data){
_67a(_680,data,_682);
},error:function(){
opts.onLoadError.apply(this,arguments);
}});
};
function _683(_684,q){
var opts=$.data(_684,"combobox").options;
if(opts.multiple&&!q){
_666(_684,[],true);
}else{
_666(_684,[q],true);
...
if(opts.mode=="remote"){
_67f(_684,null,{q:q},true);
}else{
var _685=$(_684).combo("panel");
_685.find("div.combobox-item").hide();
var data=$.data(_684,"combobox").data;
for(var i=0;i<data.length;i++){
if(opts.filter.call(_684,q,data[i])){
var v=data[i][opts.valueField];
var s=data[i][opts.textField];
var item=_685.find("div.combobox-item[value="+v+"]");
item.show();
if(s==q){
_666(_684,[v],true);
...
function _686(_687){
var opts=$.data(_687,"combobox").options;
$(_687).addClass("combobox-f");
$(_687).combo($.extend({},opts,{onShowPanel:function(){
$(_687).combo("panel").find("div.combobox-item").show();
_65d(_687,$(_687).combobox("getValue"));
opts.onShowPanel.call(_687);
}}));
};
$.fn.combobox=function(_688,_689){
if(typeof _688=="string"){
var _68a=$.fn.combobox.methods[_688];
if(_68a){
return _68a(this,_689);
}else{
return this.combo(_688,_689);
}
}
_688=_688||{};
return this.each(function(){
var _68b=$.data(this,"combobox");
if(_68b){
$.extend(_68b.options,_688);
_686(this);
}else{
_68b=$.data(this,"combobox",{options:$.extend({},$.fn.combobox.defaults,$.fn.combobox.parseOptions(this),_688)});
_686(this);
_67a(this,_678(this));
}
if(_68b.options.data){
_67a(this,_68b.options.data);
}
_67f(this);
});
};
...
},setValues:function(jq,_68c){
return jq.each(function(){
_666(this,_68c);
});
},setValue:function(jq,_68d){
return jq.each(function(){
_666(this,[_68d]);
});
},clear:function(jq){
return jq.each(function(){
$(this).combo("clear");
var _68e=$(this).combo("panel");
_68e.find("div.combobox-item-selected").removeClass("combobox-item-selected");
});
},loadData:function(jq,data){
return jq.each(function(){
_67a(this,data);
...
},select:function(jq,_68f){
return jq.each(function(){
_66c(this,_68f);
});
},unselect:function(jq,_690){
return jq.each(function(){
_670(this,_690);
});
}};
$.fn.combobox.parseOptions=function(_691){
var t=$(_691);
return $.extend({},$.fn.combo.parseOptions(_691),{valueField:t.attr("valueField"),textField:t.attr("textField"),mode:t.attr("mode"),method:(t.attr("method")?t.attr("method"):undefined),url:t.attr("url")});
};
...
var _692=$(this).combobox("getValues");
$(this).combobox("setValues",_692);
...
},onSelect:function(_693){
},onUnselect:function(_694){
}});
})(jQuery);
(function($){
function _695(_696){
var opts=$.data(_696,"combotree").options;
var tree=$.data(_696,"combotree").tree;
$(_696).addClass("combotree-f");
$(_696).combo(opts);
var _697=$(_696).combo("panel");
if(!tree){
tree=$("<ul></ul>").appendTo(_697);
$.data(_696,"combotree").tree=tree;
}
tree.tree($.extend({},opts,{checkbox:opts.multiple,onLoadSuccess:function(node,data){
var _698=$(_696).combotree("getValues");
if(opts.multiple){
var _699=tree.tree("getChecked");
...
$(_696).combotree("setValues",_698);
opts.onLoadSuccess.call(this,node,data);
},onClick:function(node){
_69b(_696);
$(_696).combo("hidePanel");
opts.onClick.call(this,node);
},onCheck:function(node,_69a){
_69b(_696);
opts.onCheck.call(this,node,_69a);
}}));
};
function _69b(_69c){
var opts=$.data(_69c,"combotree").options;
var tree=$.data(_69c,"combotree").tree;
var vv=[],ss=[];
if(opts.multiple){
var _69d=tree.tree("getChecked");
...
$(_69c).combo("setValues",vv).combo("setText",ss.join(opts.separator));
};
function _69e(_69f,_6a0){
var opts=$.data(_69f,"combotree").options;
var tree=$.data(_69f,"combotree").tree;
...
$(_69f).combo("setValues",vv).combo("setText",ss.join(opts.separator));
};
$.fn.combotree=function(_6a1,_6a2){
if(typeof _6a1=="string"){
var _6a3=$.fn.combotree.methods[_6a1];
if(_6a3){
return _6a3(this,_6a2);
}else{
return this.combo(_6a1,_6a2);
}
}
_6a1=_6a1||{};
return this.each(function(){
var _6a4=$.data(this,"combotree");
if(_6a4){
$.extend(_6a4.options,_6a1);
}else{
$.data(this,"combotree",{options:$.extend({},$.fn.combotree.defaults,$.fn.combotree.parseOptions(this),_6a1)});
}
_695(this);
});
};
...
},setValues:function(jq,_6a5){
return jq.each(function(){
_69e(this,_6a5);
});
},setValue:function(jq,_6a6){
return jq.each(function(){
_69e(this,[_6a6]);
});
},clear:function(jq){
...
$.fn.combotree.parseOptions=function(_6a7){
return $.extend({},$.fn.combo.parseOptions(_6a7),$.fn.tree.parseOptions(_6a7));
};
$.fn.combotree.defaults=$.extend({},$.fn.combo.defaults,$.fn.tree.defaults,{editable:false});
})(jQuery);
(function($){
function _6a8(_6a9){
var opts=$.data(_6a9,"combogrid").options;
var grid=$.data(_6a9,"combogrid").grid;
$(_6a9).addClass("combogrid-f");
$(_6a9).combo(opts);
var _6aa=$(_6a9).combo("panel");
if(!grid){
grid=$("<table></table>").appendTo(_6aa);
$.data(_6a9,"combogrid").grid=grid;
}
grid.datagrid($.extend({},opts,{border:false,fit:true,singleSelect:(!opts.multiple),onLoadSuccess:function(data){
var _6ab=$.data(_6a9,"combogrid").remainText;
var _6ac=$(_6a9).combo("getValues");
_6b8(_6a9,_6ac,_6ab);
$.data(_6a9,"combogrid").remainText=false;
opts.onLoadSuccess.apply(this,arguments);
},onClickRow:_6ad,onSelect:function(_6ae,row){
_6af();
opts.onSelect.call(this,_6ae,row);
},onUnselect:function(_6b0,row){
_6af();
opts.onUnselect.call(this,_6b0,row);
},onSelectAll:function(rows){
_6af();
...
function _6ad(_6b1,row){
$.data(_6a9,"combogrid").remainText=false;
_6af();
if(!opts.multiple){
$(_6a9).combo("hidePanel");
}
opts.onClickRow.call(this,_6b1,row);
};
function _6af(){
var _6b2=$.data(_6a9,"combogrid").remainText;
...
if(!opts.multiple){
$(_6a9).combo("setValues",(vv.length?vv:[""]));
}else{
$(_6a9).combo("setValues",vv);
}
if(!_6b2){
$(_6a9).combo("setText",ss.join(opts.separator));
}
};
};
function _6b3(_6b4,step){
var opts=$.data(_6b4,"combogrid").options;
var grid=$.data(_6b4,"combogrid").grid;
var _6b5=grid.datagrid("getRows").length;
$.data(_6b4,"combogrid").remainText=false;
var _6b6;
var _6b7=grid.datagrid("getSelections");
if(_6b7.length){
_6b6=grid.datagrid("getRowIndex",_6b7[_6b7.length-1][opts.idField]);
_6b6+=step;
if(_6b6<0){
_6b6=0;
}
...
grid.datagrid("selectRow",_6b6);
}
};
function _6b8(_6b9,_6ba,_6bb){
var opts=$.data(_6b9,"combogrid").options;
var grid=$.data(_6b9,"combogrid").grid;
var rows=grid.datagrid("getRows");
var ss=[];
for(var i=0;i<_6ba.length;i++){
var _6bc=grid.datagrid("getRowIndex",_6ba[i]);
if(_6bc>=0){
grid.datagrid("selectRow",_6bc);
ss.push(rows[_6bc][opts.textField]);
}else{
ss.push(_6ba[i]);
}
}
$(_6b9).combo("setValues",_6ba);
if(!_6bb){
$(_6b9).combo("setText",ss.join(opts.separator));
}
};
function _6bd(_6be,q){
var opts=$.data(_6be,"combogrid").options;
var grid=$.data(_6be,"combogrid").grid;
$.data(_6be,"combogrid").remainText=true;
if(opts.multiple&&!q){
_6b8(_6be,[],true);
}else{
_6b8(_6be,[q],true);
...
var rows=grid.datagrid("getRows");
for(var i=0;i<rows.length;i++){
if(opts.filter.call(_6be,q,rows[i])){
grid.datagrid("clearSelections");
...
$.fn.combogrid=function(_6bf,_6c0){
if(typeof _6bf=="string"){
var _6c1=$.fn.combogrid.methods[_6bf];
if(_6c1){
return _6c1(this,_6c0);
}else{
return $.fn.combo.methods[_6bf](this,_6c0);
}
}
_6bf=_6bf||{};
return this.each(function(){
var _6c2=$.data(this,"combogrid");
if(_6c2){
$.extend(_6c2.options,_6bf);
}else{
_6c2=$.data(this,"combogrid",{options:$.extend({},$.fn.combogrid.defaults,$.fn.combogrid.parseOptions(this),_6bf)});
}
_6a8(this);
});
};
...
},setValues:function(jq,_6c3){
return jq.each(function(){
_6b8(this,_6c3);
});
},setValue:function(jq,_6c4){
return jq.each(function(){
_6b8(this,[_6c4]);
});
},clear:function(jq){
...
$.fn.combogrid.parseOptions=function(_6c5){
var t=$(_6c5);
return $.extend({},$.fn.combo.parseOptions(_6c5),$.fn.datagrid.parseOptions(_6c5),{idField:(t.attr("idField")||undefined),textField:(t.attr("textField")||undefined),mode:t.attr("mode")});
};
...
(function($){
function _6c6(_6c7){
var _6c8=$.data(_6c7,"datebox");
var opts=_6c8.options;
$(_6c7).addClass("datebox-f");
$(_6c7).combo($.extend({},opts,{onShowPanel:function(){
_6c8.calendar.calendar("resize");
opts.onShowPanel.call(_6c7);
}}));
$(_6c7).combo("textbox").parent().addClass("datebox");
if(!_6c8.calendar){
_6c9();
}
function _6c9(){
var _6ca=$(_6c7).combo("panel");
_6c8.calendar=$("<div></div>").appendTo(_6ca).wrap("<div class=\"datebox-calendar-inner\"></div>");
_6c8.calendar.calendar({fit:true,border:false,onSelect:function(date){
var _6cb=opts.formatter(date);
_6cf(_6c7,_6cb);
$(_6c7).combo("hidePanel");
opts.onSelect.call(_6c7,date);
}});
_6cf(_6c7,opts.value);
var _6cc=$("<div class=\"datebox-button\"></div>").appendTo(_6ca);
$("<a href=\"javascript:void(0)\" class=\"datebox-current\"></a>").html(opts.currentText).appendTo(_6cc);
$("<a href=\"javascript:void(0)\" class=\"datebox-close\"></a>").html(opts.closeText).appendTo(_6cc);
_6cc.find(".datebox-current,.datebox-close").hover(function(){
$(this).addClass("datebox-button-hover");
},function(){
$(this).removeClass("datebox-button-hover");
});
_6cc.find(".datebox-current").click(function(){
_6c8.calendar.calendar({year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date()});
});
_6cc.find(".datebox-close").click(function(){
$(_6c7).combo("hidePanel");
});
};
};
...
function _6d0(_6d1){
var opts=$.data(_6d1,"datebox").options;
var c=$.data(_6d1,"datebox").calendar;
var _6d2=opts.formatter(c.calendar("options").current);
_6cf(_6d1,_6d2);
$(_6d1).combo("hidePanel");
};
function _6cf(_6d3,_6d4){
var _6d5=$.data(_6d3,"datebox");
var opts=_6d5.options;
$(_6d3).combo("setValue",_6d4).combo("setText",_6d4);
_6d5.calendar.calendar("moveTo",opts.parser(_6d4));
};
$.fn.datebox=function(_6d6,_6d7){
if(typeof _6d6=="string"){
var _6d8=$.fn.datebox.methods[_6d6];
if(_6d8){
return _6d8(this,_6d7);
}else{
return this.combo(_6d6,_6d7);
}
}
_6d6=_6d6||{};
return this.each(function(){
var _6d9=$.data(this,"datebox");
if(_6d9){
$.extend(_6d9.options,_6d6);
}else{
$.data(this,"datebox",{options:$.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_6d6)});
}
_6c6(this);
});
};
...
},setValue:function(jq,_6da){
return jq.each(function(){
_6cf(this,_6da);
});
}};
$.fn.datebox.parseOptions=function(_6db){
var t=$(_6db);
...
(function($){
function _6dc(_6dd){
var _6de=$.data(_6dd,"datetimebox");
var opts=_6de.options;
$(_6dd).datebox($.extend({},opts,{onShowPanel:function(){
var _6df=$(_6dd).datetimebox("getValue");
_6e7(_6dd,_6df,true);
opts.onShowPanel.call(_6dd);
}}));
$(_6dd).removeClass("datebox-f").addClass("datetimebox-f");
$(_6dd).datebox("calendar").calendar({onSelect:function(date){
opts.onSelect.call(_6dd,date);
}});
var _6e0=$(_6dd).datebox("panel");
if(!_6de.spinner){
var p=$("<div style=\"padding:2px\"><input style=\"width:80px\"></div>").insertAfter(_6e0.children("div.datebox-calendar-inner"));
_6de.spinner=p.children("input");
_6de.spinner.timespinner({showSeconds:true}).bind("mousedown",function(e){
e.stopPropagation();
});
_6e7(_6dd,opts.value);
var _6e1=_6e0.children("div.datebox-button");
var ok=$("<a href=\"javascript:void(0)\" class=\"datebox-ok\"></a>").html(opts.okText).appendTo(_6e1);
ok.hover(function(){
$(this).addClass("datebox-button-hover");
},function(){
$(this).removeClass("datebox-button-hover");
...
function _6e3(_6e4){
var c=$(_6e4).datetimebox("calendar");
var t=$(_6e4).datetimebox("spinner");
var date=c.calendar("options").current;
return new Date(date.getFullYear(),date.getMonth(),date.getDate(),t.timespinner("getHours"),t.timespinner("getMinutes"),t.timespinner("getSeconds"));
};
function _6e5(_6e6,q){
_6e7(_6e6,q,true);
};
function _6e2(_6e8){
var opts=$.data(_6e8,"datetimebox").options;
var date=_6e3(_6e8);
_6e7(_6e8,opts.formatter(date));
$(_6e8).combo("hidePanel");
};
function _6e7(_6e9,_6ea,_6eb){
var opts=$.data(_6e9,"datetimebox").options;
$(_6e9).combo("setValue",_6ea);
if(!_6eb){
if(_6ea){
var date=opts.parser(_6ea);
$(_6e9).combo("setValue",opts.formatter(date));
$(_6e9).combo("setText",opts.formatter(date));
}else{
$(_6e9).combo("setText",_6ea);
}
}
var date=opts.parser(_6ea);
$(_6e9).datetimebox("calendar").calendar("moveTo",opts.parser(_6ea));
$(_6e9).datetimebox("spinner").timespinner("setValue",_6ec(date));
function _6ec(date){
function _6ed(_6ee){
return (_6ee<10?"0":"")+_6ee;
};
var tt=[_6ed(date.getHours()),_6ed(date.getMinutes())];
if(opts.showSeconds){
tt.push(_6ed(date.getSeconds()));
}
return tt.join($(_6e9).datetimebox("spinner").timespinner("options").separator);
};
};
$.fn.datetimebox=function(_6ef,_6f0){
if(typeof _6ef=="string"){
var _6f1=$.fn.datetimebox.methods[_6ef];
if(_6f1){
return _6f1(this,_6f0);
}else{
return this.datebox(_6ef,_6f0);
}
}
_6ef=_6ef||{};
return this.each(function(){
var _6f2=$.data(this,"datetimebox");
if(_6f2){
$.extend(_6f2.options,_6ef);
}else{
$.data(this,"datetimebox",{options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_6ef)});
}
_6dc(this);
});
};
...
},setValue:function(jq,_6f3){
return jq.each(function(){
_6e7(this,_6f3);
});
}};
$.fn.datetimebox.parseOptions=function(_6f4){
var t=$(_6f4);
return $.extend({},$.fn.datebox.parseOptions(_6f4),{});
};
...
return $.fn.datebox.defaults.formatter(date)+" "+_6f5(h)+":"+_6f5(M)+":"+_6f5(s);
},parser:function(s){
if($.trim(s)==""){
return new Date();
}
...
var _6f7=parseInt(tt[1],10);
var _6f8=parseInt(tt[2],10);
return new Date(d.getFullYear(),d.getMonth(),d.getDate(),hour,_6f7,_6f8);
}});
})(jQuery);
