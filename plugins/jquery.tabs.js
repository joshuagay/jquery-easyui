...
var _42=!tab.panel("options").closed;
...
var _43=$(">div.tabs-header .tabs-wrap",_3e);
var pos=Math.min(_43.scrollLeft(),_1(_3e));
_43.animate({scrollLeft:pos},_40.scrollDuration);
}
};
function _41(_44,_45,_46){
