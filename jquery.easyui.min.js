...
_681=_681||{};
$.ajax({url:opts.url,dataType:"json",data:_681,success:function(data){
_67a(_680,data,_682);
},error:function(){
...
var t=$(_691);
return $.extend({},$.fn.combo.parseOptions(_691),{valueField:t.attr("valueField"),textField:t.attr("textField"),mode:t.attr("mode"),url:t.attr("url")});
};
