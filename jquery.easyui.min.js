...
function _475(){
_473.children("div.datagrid-pager").pagination("loading");
if(opts.loadMsg){
var wrap=_473;
...
function _477(){
_473.find("div.datagrid-pager").pagination("loaded");
_473.find("div.datagrid-mask-msg").remove();
_473.find("div.datagrid-mask").remove();
};
};
function _478(_479,_47a){
var rows=$.data(_479,"datagrid").data.rows;
var _47b=$.data(_479,"datagrid").panel;
_47a.rowspan=_47a.rowspan||1;
_47a.colspan=_47a.colspan||1;
if(_47a.index<0||_47a.index>=rows.length){
return;
}
if(_47a.rowspan==1&&_47a.colspan==1){
return;
}
var _47c=rows[_47a.index][_47a.field];
var tr=_47b.find("div.datagrid-body tr[datagrid-row-index="+_47a.index+"]");
var td=tr.find("td[field="+_47a.field+"]");
td.attr("rowspan",_47a.rowspan).attr("colspan",_47a.colspan);
td.addClass("datagrid-td-merged");
for(var i=1;i<_47a.colspan;i++){
td=td.next();
td.hide();
rows[_47a.index][td.attr("field")]=_47c;
}
for(var i=1;i<_47a.rowspan;i++){
tr=tr.next();
var td=tr.find("td[field="+_47a.field+"]").hide();
rows[_47a.index+i][td.attr("field")]=_47c;
for(var j=1;j<_47a.colspan;j++){
td=td.next();
td.hide();
rows[_47a.index+i][td.attr("field")]=_47c;
}
...
$.fn.datagrid=function(_47d,_47e){
if(typeof _47d=="string"){
return $.fn.datagrid.methods[_47d](this,_47e);
}
_47d=_47d||{};
return this.each(function(){
var _47f=$.data(this,"datagrid");
var opts;
if(_47f){
opts=$.extend(_47f.options,_47d);
_47f.options=opts;
}else{
opts=$.extend({},$.fn.datagrid.defaults,$.fn.datagrid.parseOptions(this),_47d);
$(this).css("width","").css("height","");
var _480=_3a3(this,opts.rownumbers);
if(!opts.columns){
opts.columns=_480.columns;
}
if(!opts.frozenColumns){
opts.frozenColumns=_480.frozenColumns;
}
$.data(this,"datagrid",{options:opts,panel:_480.panel,selectedRows:[],data:{total:0,rows:[]},originalRows:[],updatedRows:[],insertedRows:[],deletedRows:[]});
}
_3b2(this);
if(!_47f){
var data=_3ae(this);
...
var _481={text:{init:function(_482,_483){
var _484=$("<input type=\"text\" class=\"datagrid-editable-input\">").appendTo(_482);
return _484;
},getValue:function(_485){
return $(_485).val();
},setValue:function(_486,_487){
$(_486).val(_487);
},resize:function(_488,_489){
var _48a=$(_488);
if($.boxModel==true){
_48a.width(_489-(_48a.outerWidth()-_48a.width()));
}else{
_48a.width(_489);
}
}},textarea:{init:function(_48b,_48c){
var _48d=$("<textarea class=\"datagrid-editable-input\"></textarea>").appendTo(_48b);
return _48d;
},getValue:function(_48e){
return $(_48e).val();
},setValue:function(_48f,_490){
$(_48f).val(_490);
},resize:function(_491,_492){
var _493=$(_491);
if($.boxModel==true){
_493.width(_492-(_493.outerWidth()-_493.width()));
}else{
_493.width(_492);
}
}},checkbox:{init:function(_494,_495){
var _496=$("<input type=\"checkbox\">").appendTo(_494);
_496.val(_495.on);
_496.attr("offval",_495.off);
return _496;
},getValue:function(_497){
if($(_497).attr("checked")){
return $(_497).val();
}else{
return $(_497).attr("offval");
}
},setValue:function(_498,_499){
if($(_498).val()==_499){
$(_498).attr("checked",true);
}else{
$(_498).attr("checked",false);
}
}},numberbox:{init:function(_49a,_49b){
var _49c=$("<input type=\"text\" class=\"datagrid-editable-input\">").appendTo(_49a);
_49c.numberbox(_49b);
return _49c;
},destroy:function(_49d){
$(_49d).numberbox("destroy");
},getValue:function(_49e){
return $(_49e).val();
},setValue:function(_49f,_4a0){
$(_49f).val(_4a0);
},resize:function(_4a1,_4a2){
var _4a3=$(_4a1);
if($.boxModel==true){
_4a3.width(_4a2-(_4a3.outerWidth()-_4a3.width()));
}else{
_4a3.width(_4a2);
}
}},validatebox:{init:function(_4a4,_4a5){
var _4a6=$("<input type=\"text\" class=\"datagrid-editable-input\">").appendTo(_4a4);
_4a6.validatebox(_4a5);
return _4a6;
},destroy:function(_4a7){
$(_4a7).validatebox("destroy");
...
}},datebox:{init:function(_4ae,_4af){
var _4b0=$("<input type=\"text\">").appendTo(_4ae);
_4b0.datebox(_4af);
return _4b0;
},destroy:function(_4b1){
$(_4b1).datebox("destroy");
},getValue:function(_4b2){
return $(_4b2).datebox("getValue");
},setValue:function(_4b3,_4b4){
$(_4b3).datebox("setValue",_4b4);
},resize:function(_4b5,_4b6){
$(_4b5).datebox("resize",_4b6);
}},combobox:{init:function(_4b7,_4b8){
var _4b9=$("<input type=\"text\">").appendTo(_4b7);
_4b9.combobox(_4b8||{});
return _4b9;
},destroy:function(_4ba){
$(_4ba).combobox("destroy");
},getValue:function(_4bb){
return $(_4bb).combobox("getValue");
},setValue:function(_4bc,_4bd){
$(_4bc).combobox("setValue",_4bd);
},resize:function(_4be,_4bf){
$(_4be).combobox("resize",_4bf);
}},combotree:{init:function(_4c0,_4c1){
var _4c2=$("<input type=\"text\">").appendTo(_4c0);
_4c2.combotree(_4c1);
return _4c2;
},destroy:function(_4c3){
$(_4c3).combotree("destroy");
},getValue:function(_4c4){
return $(_4c4).combotree("getValue");
},setValue:function(_4c5,_4c6){
$(_4c5).combotree("setValue",_4c6);
},resize:function(_4c7,_4c8){
$(_4c7).combotree("resize",_4c8);
}}};
$.fn.datagrid.methods={options:function(jq){
var _4c9=$.data(jq[0],"datagrid").options;
var _4ca=$.data(jq[0],"datagrid").panel.panel("options");
var opts=$.extend(_4c9,{width:_4ca.width,height:_4ca.height,closed:_4ca.closed,collapsed:_4ca.collapsed,minimized:_4ca.minimized,maximized:_4ca.maximized});
var _4cb=jq.datagrid("getPager");
if(_4cb.length){
var _4cc=_4cb.pagination("options");
$.extend(opts,{pageNumber:_4cc.pageNumber,pageSize:_4cc.pageSize});
}
return opts;
...
},getColumnFields:function(jq,_4cd){
return _3b1(jq[0],_4cd);
},getColumnOption:function(jq,_4ce){
return _3d9(jq[0],_4ce);
},resize:function(jq,_4cf){
return jq.each(function(){
_385(this,_4cf);
});
},load:function(jq,_4d0){
return jq.each(function(){
var opts=$(this).datagrid("options");
opts.pageNumber=1;
var _4d1=$(this).datagrid("getPager");
_4d1.pagination({pageNumber:1});
_470(this,_4d0);
});
},reload:function(jq,_4d2){
return jq.each(function(){
_470(this,_4d2);
});
},reloadFooter:function(jq,_4d3){
return jq.each(function(){
var opts=$.data(this,"datagrid").options;
var view=$(this).datagrid("getPanel").children("div.datagrid-view");
var _4d4=view.children("div.datagrid-view1");
var _4d5=view.children("div.datagrid-view2");
if(_4d3){
$.data(this,"datagrid").footer=_4d3;
}
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,this,_4d5.find("div.datagrid-footer-inner"),false);
opts.view.renderFooter.call(opts.view,this,_4d4.find("div.datagrid-footer-inner"),true);
if(opts.view.onAfterRender){
...
},unselectRow:function(jq,_4d8){
return jq.each(function(){
_3cd(this,_4d8);
});
},beginEdit:function(jq,_4d9){
return jq.each(function(){
_429(this,_4d9);
});
},endEdit:function(jq,_4da){
return jq.each(function(){
_42f(this,_4da,false);
});
},cancelEdit:function(jq,_4db){
return jq.each(function(){
_42f(this,_4db,true);
});
},getEditors:function(jq,_4dc){
return _43a(jq[0],_4dc);
},getEditor:function(jq,_4dd){
return _43f(jq[0],_4dd);
},refreshRow:function(jq,_4de){
return jq.each(function(){
var opts=$.data(this,"datagrid").options;
opts.view.refreshRow.call(opts.view,this,_4de);
});
},validateRow:function(jq,_4df){
return _42e(jq[0],_4df);
},appendRow:function(jq,row){
return jq.each(function(){
_461(this,row);
});
},insertRow:function(jq,_4e0){
return jq.each(function(){
_45d(this,_4e0);
});
},deleteRow:function(jq,_4e1){
return jq.each(function(){
_457(this,_4e1);
});
},getChanges:function(jq,_4e2){
return _451(jq[0],_4e2);
...
},mergeCells:function(jq,_4e3){
return jq.each(function(){
_478(this,_4e3);
});
},showColumn:function(jq,_4e4){
return jq.each(function(){
var _4e5=$(this).datagrid("getPanel");
_4e5.find("td[field="+_4e4+"]").show();
$(this).datagrid("getColumnOption",_4e4).hidden=false;
$(this).datagrid("fitColumns");
});
},hideColumn:function(jq,_4e6){
return jq.each(function(){
var _4e7=$(this).datagrid("getPanel");
_4e7.find("td[field="+_4e6+"]").hide();
$(this).datagrid("getColumnOption",_4e6).hidden=true;
$(this).datagrid("fitColumns");
});
}};
$.fn.datagrid.parseOptions=function(_4e8){
var t=$(_4e8);
return $.extend({},$.fn.panel.parseOptions(_4e8),{fitColumns:(t.attr("fitColumns")?t.attr("fitColumns")=="true":undefined),striped:(t.attr("striped")?t.attr("striped")=="true":undefined),nowrap:(t.attr("nowrap")?t.attr("nowrap")=="true":undefined),rownumbers:(t.attr("rownumbers")?t.attr("rownumbers")=="true":undefined),singleSelect:(t.attr("singleSelect")?t.attr("singleSelect")=="true":undefined),pagination:(t.attr("pagination")?t.attr("pagination")=="true":undefined),pageSize:(t.attr("pageSize")?parseInt(t.attr("pageSize")):undefined),pageList:(t.attr("pageList")?eval(t.attr("pageList")):undefined),remoteSort:(t.attr("remoteSort")?t.attr("remoteSort")=="true":undefined),showHeader:(t.attr("showHeader")?t.attr("showHeader")=="true":undefined),showFooter:(t.attr("showFooter")?t.attr("showFooter")=="true":undefined),scrollbarSize:(t.attr("scrollbarSize")?parseInt(t.attr("scrollbarSize")):undefined),loadMsg:(t.attr("loadMsg")!=undefined?t.attr("loadMsg"):undefined),idField:t.attr("idField"),url:t.attr("url")});
};
var _4e9={render:function(_4ea,_4eb,_4ec){
var opts=$.data(_4ea,"datagrid").options;
var rows=$.data(_4ea,"datagrid").data.rows;
var _4ed=$(_4ea).datagrid("getColumnFields",_4ec);
if(_4ec){
if(!(opts.rownumbers||(opts.frozenColumns&&opts.frozenColumns.length))){
return;
}
}
var _4ee=["<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<rows.length;i++){
var cls=(i%2&&opts.striped)?"class=\"datagrid-row-alt\"":"";
var _4ef=opts.rowStyler?opts.rowStyler.call(_4ea,i,rows[i]):"";
var _4f0=_4ef?"style=\""+_4ef+"\"":"";
_4ee.push("<tr datagrid-row-index=\""+i+"\" "+cls+" "+_4f0+">");
_4ee.push(this.renderRow.call(this,_4ea,_4ed,_4ec,i,rows[i]));
_4ee.push("</tr>");
}
_4ee.push("</tbody></table>");
$(_4eb).html(_4ee.join(""));
},renderFooter:function(_4f1,_4f2,_4f3){
var opts=$.data(_4f1,"datagrid").options;
var rows=$.data(_4f1,"datagrid").footer||[];
var _4f4=$(_4f1).datagrid("getColumnFields",_4f3);
var _4f5=["<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<rows.length;i++){
_4f5.push("<tr datagrid-row-index=\""+i+"\">");
_4f5.push(this.renderRow.call(this,_4f1,_4f4,_4f3,i,rows[i]));
_4f5.push("</tr>");
}
_4f5.push("</tbody></table>");
$(_4f2).html(_4f5.join(""));
},renderRow:function(_4f6,_4f7,_4f8,_4f9,_4fa){
var opts=$.data(_4f6,"datagrid").options;
var cc=[];
if(_4f8&&opts.rownumbers){
var _4fb=_4f9+1;
if(opts.pagination){
_4fb+=(opts.pageNumber-1)*opts.pageSize;
}
cc.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\">"+_4fb+"</div></td>");
}
for(var i=0;i<_4f7.length;i++){
var _4fc=_4f7[i];
var col=$(_4f6).datagrid("getColumnOption",_4fc);
if(col){
var _4fd=col.styler?(col.styler(_4fa[_4fc],_4fa,_4f9)||""):"";
var _4fe=col.hidden?"style=\"display:none;"+_4fd+"\"":(_4fd?"style=\""+_4fd+"\"":"");
cc.push("<td field=\""+_4fc+"\" "+_4fe+">");
var _4fe="width:"+(col.boxWidth)+"px;";
_4fe+="text-align:"+(col.align||"left")+";";
_4fe+=opts.nowrap==false?"white-space:normal;":"";
cc.push("<div style=\""+_4fe+"\" ");
if(col.checkbox){
...
if(col.formatter){
cc.push(col.formatter(_4fa[_4fc],_4fa,_4f9));
}else{
cc.push(_4fa[_4fc]);
}
}
...
return cc.join("");
},refreshRow:function(_4ff,_500){
var opts=$.data(_4ff,"datagrid").options;
var _501=$(_4ff).datagrid("getPanel");
var rows=$(_4ff).datagrid("getRows");
var _502=opts.rowStyler?opts.rowStyler.call(_4ff,_500,rows[_500]):"";
var tr=_501.find("div.datagrid-body tr[datagrid-row-index="+_500+"]");
tr.attr("style",_502||"");
tr.children("td").each(function(){
var td=$(this);
var cell=td.find("div.datagrid-cell");
var _503=td.attr("field");
var col=$(_4ff).datagrid("getColumnOption",_503);
if(col){
var _504=col.styler?col.styler(rows[_500][_503],rows[_500],_500):"";
td.attr("style",_504||"");
if(col.hidden){
td.hide();
}
if(col.formatter){
cell.html(col.formatter(rows[_500][_503],rows[_500],_500));
}else{
cell.html(rows[_500][_503]);
}
}
});
$(_4ff).datagrid("fixRowHeight",_500);
},insertRow:function(_505,_506,row){
var opts=$.data(_505,"datagrid").options;
var data=$.data(_505,"datagrid").data;
var view=$(_505).datagrid("getPanel").children("div.datagrid-view");
var _507=view.children("div.datagrid-view1");
var _508=view.children("div.datagrid-view2");
if(_506==undefined||_506==null){
_506=data.rows.length;
}
if(_506>data.rows.length){
_506=data.rows.length;
}
for(var i=data.rows.length-1;i>=_506;i--){
_508.children("div.datagrid-body").find("tr[datagrid-row-index="+i+"]").attr("datagrid-row-index",i+1);
var tr=_507.children("div.datagrid-body").find("tr[datagrid-row-index="+i+"]").attr("datagrid-row-index",i+1);
if(opts.rownumbers){
tr.find("div.datagrid-cell-rownumber").html(i+2);
}
}
var _509=$(_505).datagrid("getColumnFields",true);
var _50a=$(_505).datagrid("getColumnFields",false);
var tr1="<tr datagrid-row-index=\""+_506+"\">"+this.renderRow.call(this,_505,_509,true,_506,row)+"</tr>";
var tr2="<tr datagrid-row-index=\""+_506+"\">"+this.renderRow.call(this,_505,_50a,false,_506,row)+"</tr>";
if(_506>=data.rows.length){
var _50b=_507.children("div.datagrid-body").children("div.datagrid-body-inner");
var _50c=_508.children("div.datagrid-body");
if(data.rows.length){
_50b.find("tr:last[datagrid-row-index]").after(tr1);
_50c.find("tr:last[datagrid-row-index]").after(tr2);
}else{
_50b.html("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"+tr1+"</tbody></table>");
_50c.html("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"+tr2+"</tbody></table>");
}
}else{
_507.children("div.datagrid-body").find("tr[datagrid-row-index="+(_506+1)+"]").before(tr1);
_508.children("div.datagrid-body").find("tr[datagrid-row-index="+(_506+1)+"]").before(tr2);
}
data.total+=1;
data.rows.splice(_506,0,row);
this.refreshRow.call(this,_505,_506);
},deleteRow:function(_50d,_50e){
var opts=$.data(_50d,"datagrid").options;
var data=$.data(_50d,"datagrid").data;
var view=$(_50d).datagrid("getPanel").children("div.datagrid-view");
var _50f=view.children("div.datagrid-view1");
var _510=view.children("div.datagrid-view2");
_50f.children("div.datagrid-body").find("tr[datagrid-row-index="+_50e+"]").remove();
_510.children("div.datagrid-body").find("tr[datagrid-row-index="+_50e+"]").remove();
for(var i=_50e+1;i<data.rows.length;i++){
_510.children("div.datagrid-body").find("tr[datagrid-row-index="+i+"]").attr("datagrid-row-index",i-1);
var tr=_50f.children("div.datagrid-body").find("tr[datagrid-row-index="+i+"]").attr("datagrid-row-index",i-1);
if(opts.rownumbers){
tr.find("div.datagrid-cell-rownumber").html(i);
}
}
data.total-=1;
data.rows.splice(_50e,1);
},onBeforeRender:function(_511,rows){
},onAfterRender:function(_512){
var opts=$.data(_512,"datagrid").options;
if(opts.showFooter){
var _513=$(_512).datagrid("getPanel").find("div.datagrid-footer");
_513.find("div.datagrid-cell-rownumber,div.datagrid-cell-check").css("visibility","hidden");
}
}};
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{frozenColumns:null,columns:null,fitColumns:false,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,loadMsg:"Processing, please wait ...",rownumbers:false,singleSelect:false,pagination:false,pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowStyler:function(_514,_515){
},editors:_481,editConfig:{getTr:function(_516,_517){
return $(_516).datagrid("getPanel").find("div.datagrid-body tr[datagrid-row-index="+_517+"]");
},getRow:function(_518,_519){
return $.data(_518,"datagrid").data.rows[_519];
}},view:_4e9,onBeforeLoad:function(_51a){
},onLoadSuccess:function(){
},onLoadError:function(){
},onClickRow:function(_51b,_51c){
},onDblClickRow:function(_51d,_51e){
},onSortColumn:function(sort,_51f){
},onResizeColumn:function(_520,_521){
},onSelect:function(_522,_523){
},onUnselect:function(_524,_525){
},onSelectAll:function(rows){
},onUnselectAll:function(rows){
},onBeforeEdit:function(_526,_527){
},onAfterEdit:function(_528,_529,_52a){
},onCancelEdit:function(_52b,_52c){
},onHeaderContextMenu:function(e,_52d){
},onRowContextMenu:function(e,_52e,_52f){
}});
})(jQuery);
(function($){
function _530(_531){
var opts=$.data(_531,"propertygrid").options;
$(_531).datagrid($.extend({},opts,{view:(opts.showGroup?_532:undefined),onClickRow:function(_533,row){
if(opts.editIndex!=_533){
var col=$(this).datagrid("getColumnOption","value");
col.editor=row.editor;
_534(opts.editIndex);
$(this).datagrid("beginEdit",_533);
$(this).datagrid("getEditors",_533)[0].target.focus();
opts.editIndex=_533;
}
opts.onClickRow.call(_531,_533,row);
}}));
$(_531).datagrid("getPanel").panel("panel").addClass("propertygrid");
$(_531).datagrid("getPanel").find("div.datagrid-body").unbind(".propertygrid").bind("mousedown.propertygrid",function(e){
e.stopPropagation();
});
...
var t=$(_531);
if(t.datagrid("validateRow",_535)){
t.datagrid("endEdit",_535);
}else{
t.datagrid("cancelEdit",_535);
}
};
};
$.fn.propertygrid=function(_536,_537){
if(typeof _536=="string"){
var _538=$.fn.propertygrid.methods[_536];
if(_538){
return _538(this,_537);
}else{
return this.datagrid(_536,_537);
}
}
_536=_536||{};
return this.each(function(){
var _539=$.data(this,"propertygrid");
if(_539){
$.extend(_539.options,_536);
}else{
$.data(this,"propertygrid",{options:$.extend({},$.fn.propertygrid.defaults,$.fn.propertygrid.parseOptions(this),_536)});
}
_530(this);
});
};
$.fn.propertygrid.methods={};
$.fn.propertygrid.parseOptions=function(_53a){
var t=$(_53a);
return $.extend({},$.fn.datagrid.parseOptions(_53a),{showGroup:(t.attr("showGroup")?t.attr("showGroup")=="true":undefined)});
};
var _532=$.extend({},$.fn.datagrid.defaults.view,{render:function(_53b,_53c,_53d){
var opts=$.data(_53b,"datagrid").options;
var rows=$.data(_53b,"datagrid").data.rows;
var _53e=$(_53b).datagrid("getColumnFields",_53d);
var _53f=[];
var _540=0;
var _541=this.groups;
for(var i=0;i<_541.length;i++){
var _542=_541[i];
_53f.push("<div class=\"datagrid-group\" group-index="+i+">");
_53f.push("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" style=\"height:100%\"><tbody>");
_53f.push("<tr>");
_53f.push("<td style=\"border:0;\">");
if(!_53d){
_53f.push("<span>");
_53f.push(opts.groupFormatter.call(_53b,_542.fvalue,_542.rows));
_53f.push("</span>");
}
_53f.push("</td>");
_53f.push("</tr>");
_53f.push("</tbody></table>");
_53f.push("</div>");
_53f.push("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>");
for(var j=0;j<_542.rows.length;j++){
var cls=(_540%2&&opts.striped)?"class=\"datagrid-row-alt\"":"";
var _543=opts.rowStyler?opts.rowStyler.call(_53b,_540,_542.rows[j]):"";
var _544=_543?"style=\""+_543+"\"":"";
_53f.push("<tr datagrid-row-index=\""+_540+"\" "+cls+" "+_544+">");
_53f.push(this.renderRow.call(this,_53b,_53e,_53d,_540,_542.rows[j]));
_53f.push("</tr>");
_540++;
}
_53f.push("</tbody></table>");
...
$(_53c).html(_53f.join(""));
},onAfterRender:function(_545){
var opts=$.data(_545,"datagrid").options;
var view=$(_545).datagrid("getPanel").find("div.datagrid-view");
var _546=view.children("div.datagrid-view1");
var _547=view.children("div.datagrid-view2");
$.fn.datagrid.defaults.view.onAfterRender.call(this,_545);
if(opts.rownumbers||opts.frozenColumns.length){
var _548=_546.find("div.datagrid-group");
}else{
var _548=_547.find("div.datagrid-group");
}
$("<td style=\"border:0\"><div class=\"datagrid-row-expander datagrid-row-collapse\" style=\"width:25px;height:16px;cursor:pointer\"></div></td>").insertBefore(_548.find("td"));
view.find("div.datagrid-group").each(function(){
var _549=$(this).attr("group-index");
$(this).find("div.datagrid-row-expander").bind("click",{groupIndex:_549},function(e){
var _54a=view.find("div.datagrid-group[group-index="+e.data.groupIndex+"]");
if($(this).hasClass("datagrid-row-collapse")){
$(this).removeClass("datagrid-row-collapse").addClass("datagrid-row-expand");
_54a.next("table").hide();
}else{
$(this).removeClass("datagrid-row-expand").addClass("datagrid-row-collapse");
_54a.next("table").show();
}
$(_545).datagrid("fixRowHeight");
});
});
},onBeforeRender:function(_54b,rows){
var opts=$.data(_54b,"datagrid").options;
var _54c=[];
for(var i=0;i<rows.length;i++){
var row=rows[i];
var _54d=_54e(row[opts.groupField]);
if(!_54d){
_54d={fvalue:row[opts.groupField],rows:[row],startRow:i};
_54c.push(_54d);
}else{
_54d.rows.push(row);
}
...
for(var i=0;i<_54c.length;i++){
var _54d=_54c[i];
for(var j=0;j<_54d.rows.length;j++){
_551.push(_54d.rows[j]);
}
}
$.data(_54b,"datagrid").data.rows=_551;
}});
$.fn.propertygrid.defaults=$.extend({},$.fn.datagrid.defaults,{singleSelect:true,remoteSort:false,fitColumns:true,loadMsg:"",frozenColumns:[[{field:"f",width:16,resizable:false}]],columns:[[{field:"name",title:"Name",width:100,sortable:true},{field:"value",title:"Value",width:100,resizable:false}]],showGroup:false,groupField:"group",groupFormatter:function(_552){
return _552;
}});
})(jQuery);
(function($){
function _553(_554){
var opts=$.data(_554,"treegrid").options;
$(_554).datagrid($.extend({},opts,{url:null,onLoadSuccess:function(){
},onResizeColumn:function(_555,_556){
_55c(_554);
opts.onResizeColumn.call(_554,_555,_556);
},onBeforeEdit:function(_557,row){
if(opts.onBeforeEdit.call(_554,row)==false){
return false;
}
},onAfterEdit:function(_558,row,_559){
_55b(_554);
opts.onAfterEdit.call(_554,row,_559);
},onCancelEdit:function(_55a,row){
_55b(_554);
opts.onCancelEdit.call(_554,row);
}}));
};
function _55c(_55d,_55e){
var opts=$.data(_55d,"datagrid").options;
var _55f=$.data(_55d,"datagrid").panel;
var view=_55f.children("div.datagrid-view");
...
if(_55e){
_562(_55e);
_561.find("tr[node-id="+_55e+"]").next("tr.treegrid-tr-tree").find("tr[node-id]").each(function(){
_562($(this).attr("node-id"));
});
}else{
_561.find("tr[node-id]").each(function(){
_562($(this).attr("node-id"));
});
if(opts.showFooter){
var _563=$.data(_55d,"datagrid").footer||[];
for(var i=0;i<_563.length;i++){
_562(_563[i][opts.idField]);
}
$(_55d).datagrid("resize");
}
}
}
if(opts.height=="auto"){
var _564=_560.children("div.datagrid-body");
var _565=_561.children("div.datagrid-body");
var _566=0;
var _567=0;
_565.children().each(function(){
var c=$(this);
if(c.is(":visible")){
_566+=c.outerHeight();
if(_567<c.outerWidth()){
_567=c.outerWidth();
}
}
});
...
_564.height(_566);
_565.height(_566);
view.height(_561.height());
}
_561.children("div.datagrid-body").triggerHandler("scroll");
function _562(_568){
var tr1=_560.find("tr[node-id="+_568+"]");
var tr2=_561.find("tr[node-id="+_568+"]");
tr1.css("height","");
tr2.css("height","");
var _569=Math.max(tr1.height(),tr2.height());
tr1.css("height",_569);
tr2.css("height",_569);
};
};
function _56a(_56b){
var opts=$.data(_56b,"treegrid").options;
if(!opts.rownumbers){
return;
}
$(_56b).datagrid("getPanel").find("div.datagrid-view1 div.datagrid-body div.datagrid-cell-rownumber").each(function(i){
$(this).html(i+1);
});
};
function _55b(_56c){
var opts=$.data(_56c,"treegrid").options;
var _56d=$(_56c).datagrid("getPanel");
var body=_56d.find("div.datagrid-body");
...
opts.onClickRow.call(_56c,find(_56c,id));
}).bind("dblclick.treegrid",function(){
var id=$(this).attr("node-id");
opts.onDblClickRow.call(_56c,find(_56c,id));
}).bind("contextmenu.treegrid",function(e){
var id=$(this).attr("node-id");
opts.onContextMenu.call(_56c,e,find(_56c,id));
});
...
var _56e=_56d.find("div.datagrid-header");
_56e.find("input[type=checkbox]").unbind().bind("click.treegrid",function(){
if(opts.singleSelect){
return false;
}
if($(this).attr("checked")){
...
var opts=$.data(_572,"treegrid").options;
var view=$(_572).datagrid("getPanel").children("div.datagrid-view");
var _574=view.children("div.datagrid-view1");
var _575=view.children("div.datagrid-view2");
var tr1=_574.children("div.datagrid-body").find("tr[node-id="+_573+"]");
var tr2=_575.children("div.datagrid-body").find("tr[node-id="+_573+"]");
var _576=$(_572).datagrid("getColumnFields",true).length+(opts.rownumbers?1:0);
var _577=$(_572).datagrid("getColumnFields",false).length;
_578(tr1,_576);
_578(tr2,_577);
function _578(tr,_579){
$("<tr class=\"treegrid-tr-tree\">"+"<td style=\"border:0px\" colspan=\""+_579+"\">"+"<div></div>"+"</td>"+"</tr>").insertAfter(tr);
};
};
function _57a(_57b,_57c,data,_57d){
var opts=$.data(_57b,"treegrid").options;
var wrap=$.data(_57b,"datagrid").panel;
var view=wrap.children("div.datagrid-view");
var _57e=view.children("div.datagrid-view1");
var _57f=view.children("div.datagrid-view2");
var node=find(_57b,_57c);
if(node){
var _580=_57e.children("div.datagrid-body").find("tr[node-id="+_57c+"]");
var _581=_57f.children("div.datagrid-body").find("tr[node-id="+_57c+"]");
var cc1=_580.next("tr.treegrid-tr-tree").children("td").children("div");
var cc2=_581.next("tr.treegrid-tr-tree").children("td").children("div");
}else{
var cc1=_57e.children("div.datagrid-body").children("div.datagrid-body-inner");
var cc2=_57f.children("div.datagrid-body");
}
if(!_57d){
$.data(_57b,"treegrid").data=[];
cc1.empty();
cc2.empty();
}
if(opts.view.onBeforeRender){
opts.view.onBeforeRender.call(opts.view,_57b,_57c,data);
}
opts.view.render.call(opts.view,_57b,cc1,true);
opts.view.render.call(opts.view,_57b,cc2,false);
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,_57b,_57e.find("div.datagrid-footer-inner"),true);
opts.view.renderFooter.call(opts.view,_57b,_57f.find("div.datagrid-footer-inner"),false);
}
if(opts.view.onAfterRender){
opts.view.onAfterRender.call(opts.view,_57b);
}
opts.onLoadSuccess.call(_57b,node,data);
_55c(_57b);
_56a(_57b);
_582();
_55b(_57b);
function _582(){
var _583=view.find("div.datagrid-header");
var body=view.find("div.datagrid-body");
var _584=_583.find("div.datagrid-header-check");
if(_584.length){
var ck=body.find("div.datagrid-cell-check");
if($.boxModel){
ck.width(_584.width());
ck.height(_584.height());
}else{
ck.width(_584.outerWidth());
ck.height(_584.outerHeight());
}
}
};
};
function _585(_586,_587,_588,_589,_58a){
var opts=$.data(_586,"treegrid").options;
var body=$(_586).datagrid("getPanel").find("div.datagrid-body");
if(_588){
opts.queryParams=_588;
}
var _58b=$.extend({},opts.queryParams);
var row=find(_586,_587);
if(opts.onBeforeLoad.call(_586,row,_58b)==false){
return;
}
if(!opts.url){
return;
}
var _58c=body.find("tr[node-id="+_587+"] span.tree-folder");
_58c.addClass("tree-loading");
$.ajax({type:opts.method,url:opts.url,data:_58b,dataType:"json",success:function(data){
_58c.removeClass("tree-loading");
_57a(_586,_587,data,_589);
if(_58a){
_58a();
}
},error:function(){
_58c.removeClass("tree-loading");
opts.onLoadError.apply(_586,arguments);
if(_58a){
_58a();
}
}});
...
function _58f(_590){
return $.data(_590,"treegrid").data;
};
function _591(_592,_593){
var row=find(_592,_593);
if(row._parentId){
return find(_592,row._parentId);
}else{
return null;
}
};
...
var body=$(_595).datagrid("getPanel").find("div.datagrid-view2 div.datagrid-body");
var _597=[];
if(_596){
_598(_596);
}else{
...
_597.push(_599[i]);
_598(_599[i][opts.idField]);
}
}
function _598(_59a){
var _59b=find(_595,_59a);
if(_59b&&_59b.children){
for(var i=0,len=_59b.children.length;i<len;i++){
var _59c=_59b.children[i];
_597.push(_59c);
_598(_59c[opts.idField]);
}
}
};
return _597;
...
function _59f(_5a0){
var rows=[];
var _5a1=$(_5a0).datagrid("getPanel");
_5a1.find("div.datagrid-view2 div.datagrid-body tr.datagrid-row-selected").each(function(){
var id=$(this).attr("node-id");
rows.push(find(_5a0,id));
});
return rows;
};
...
var view=$(_5a3).datagrid("getPanel").children("div.datagrid-view");
var node=view.find("div.datagrid-body tr[node-id="+_5a4+"]").children("td[field="+opts.treeField+"]");
return node.find("span.tree-indent,span.tree-hit").length;
};
function find(_5a5,_5a6){
var opts=$.data(_5a5,"treegrid").options;
var data=$.data(_5a5,"treegrid").data;
var cc=[data];
while(cc.length){
var c=cc.shift();
for(var i=0;i<c.length;i++){
var node=c[i];
if(node[opts.idField]==_5a6){
return node;
}else{
if(node["children"]){
...
var tr=body.find("tr[node-id="+_5ac+"]");
tr.removeClass("datagrid-row-selected");
tr.find("div.datagrid-cell-check input[type=checkbox]").attr("checked",false);
};
function _56f(_5ad){
var tr=$(_5ad).datagrid("getPanel").find("div.datagrid-body tr[node-id]");
tr.addClass("datagrid-row-selected");
tr.find("div.datagrid-cell-check input[type=checkbox]").attr("checked",true);
};
function _570(_5ae){
var tr=$(_5ae).datagrid("getPanel").find("div.datagrid-body tr[node-id]");
tr.removeClass("datagrid-row-selected");
tr.find("div.datagrid-cell-check input[type=checkbox]").attr("checked",false);
};
...
if(opts.onBeforeCollapse.call(_5b0,row)==false){
return;
}
hit.removeClass("tree-expanded tree-expanded-hover").addClass("tree-collapsed");
hit.next().removeClass("tree-folder-open");
...
if(opts.onBeforeExpand.call(_5b3,row)==false){
return;
}
hit.removeClass("tree-collapsed tree-collapsed-hover").addClass("tree-expanded");
hit.next().addClass("tree-folder-open");
var _5b5=tr.next("tr.treegrid-tr-tree");
if(_5b5.length){
var cc=_5b5.children("td").children("div");
_5b6(cc);
}else{
_571(_5b3,row[opts.idField]);
var _5b5=tr.next("tr.treegrid-tr-tree");
var cc=_5b5.children("td").children("div");
cc.hide();
_585(_5b3,row[opts.idField],{id:row[opts.idField]},true,function(){
_5b6(cc);
});
}
function _5b6(cc){
...
var body=$(_5b8).datagrid("getPanel").find("div.datagrid-body");
var tr=body.find("tr[node-id="+_5b9+"]");
var hit=tr.find("span.tree-hit");
if(hit.hasClass("tree-expanded")){
_5af(_5b8,_5b9);
}else{
...
var opts=$.data(_5c6,"treegrid").options;
if(_5c7.parent){
var body=$(_5c6).datagrid("getPanel").find("div.datagrid-body");
var tr=body.find("tr[node-id="+_5c7.parent+"]");
if(tr.next("tr.treegrid-tr-tree").length==0){
_571(_5c6,_5c7.parent);
}
var cell=tr.children("td[field="+opts.treeField+"]").children("div.datagrid-cell");
var _5c8=cell.children("span.tree-icon");
if(_5c8.hasClass("tree-file")){
_5c8.removeClass("tree-file").addClass("tree-folder");
var hit=$("<span class=\"tree-hit tree-expanded\"></span>").insertBefore(_5c8);
if(hit.prev().length){
hit.prev().remove();
}
}
}
_57a(_5c6,_5c7.parent,_5c7.data,true);
};
...
var _5cc=del(_5cb);
if(_5cc){
if(_5cc.children.length==0){
tr=body.find("tr[node-id="+_5cc[opts.treeField]+"]");
var cell=tr.children("td[field="+opts.treeField+"]").children("div.datagrid-cell");
...
function del(id){
var cc;
var _5cd=_591(_5ca,_5cb);
if(_5cd){
cc=_5cd.children;
}else{
cc=$(_5ca).treegrid("getData");
}
for(var i=0;i<cc.length;i++){
...
$.fn.treegrid=function(_5ce,_5cf){
if(typeof _5ce=="string"){
return $.fn.treegrid.methods[_5ce](this,_5cf);
}
_5ce=_5ce||{};
return this.each(function(){
var _5d0=$.data(this,"treegrid");
if(_5d0){
$.extend(_5d0.options,_5ce);
}else{
$.data(this,"treegrid",{options:$.extend({},$.fn.treegrid.defaults,$.fn.treegrid.parseOptions(this),_5ce),data:[]});
}
_553(this);
_585(this);
});
...
},resize:function(jq,_5d1){
return jq.each(function(){
$(this).datagrid("resize",_5d1);
});
},fixRowHeight:function(jq,_5d2){
return jq.each(function(){
_55c(this,_5d2);
});
},loadData:function(jq,data){
...
},reloadFooter:function(jq,_5d3){
return jq.each(function(){
var opts=$.data(this,"treegrid").options;
var view=$(this).datagrid("getPanel").children("div.datagrid-view");
var _5d4=view.children("div.datagrid-view1");
var _5d5=view.children("div.datagrid-view2");
if(_5d3){
$.data(this,"treegrid").footer=_5d3;
}
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,this,_5d4.find("div.datagrid-footer-inner"),true);
opts.view.renderFooter.call(opts.view,this,_5d5.find("div.datagrid-footer-inner"),false);
if(opts.view.onAfterRender){
opts.view.onAfterRender.call(opts.view,this);
}
...
$.fn.treegrid.parseOptions=function(_5d7){
var t=$(_5d7);
return $.extend({},$.fn.datagrid.parseOptions(_5d7),{treeField:t.attr("treeField"),animate:(t.attr("animate")?t.attr("animate")=="true":undefined)});
};
var _5d8=$.extend({},$.fn.datagrid.defaults.view,{render:function(_5d9,_5da,_5db){
var opts=$.data(_5d9,"treegrid").options;
var _5dc=$(_5d9).datagrid("getColumnFields",_5db);
var view=this;
var _5dd=_5de(_5db,this.treeLevel,this.treeNodes);
$(_5da).append(_5dd.join(""));
function _5de(_5df,_5e0,_5e1){
var _5e2=["<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<_5e1.length;i++){
var row=_5e1[i];
if(row.state!="open"&&row.state!="closed"){
row.state="open";
}
var _5e3=opts.rowStyler?opts.rowStyler.call(_5d9,row):"";
var _5e4=_5e3?"style=\""+_5e3+"\"":"";
_5e2.push("<tr node-id="+row[opts.idField]+" "+_5e4+">");
_5e2=_5e2.concat(view.renderRow.call(view,_5d9,_5dc,_5df,_5e0,row));
_5e2.push("</tr>");
if(row.children&&row.children.length){
var tt=_5de(_5df,_5e0+1,row.children);
var v=row.state=="closed"?"none":"block";
_5e2.push("<tr class=\"treegrid-tr-tree\"><td style=\"border:0px\" colspan="+(_5dc.length+(opts.rownumbers?1:0))+"><div style=\"display:"+v+"\">");
_5e2=_5e2.concat(tt);
_5e2.push("</div></td></tr>");
}
}
_5e2.push("</tbody></table>");
return _5e2;
};
},renderFooter:function(_5e5,_5e6,_5e7){
var opts=$.data(_5e5,"treegrid").options;
var rows=$.data(_5e5,"treegrid").footer||[];
var _5e8=$(_5e5).datagrid("getColumnFields",_5e7);
var _5e9=["<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<rows.length;i++){
var row=rows[i];
row[opts.idField]=row[opts.idField]||("foot-row-id"+i);
_5e9.push("<tr node-id="+row[opts.idField]+">");
_5e9.push(this.renderRow.call(this,_5e5,_5e8,_5e7,0,row));
_5e9.push("</tr>");
}
_5e9.push("</tbody></table>");
$(_5e6).html(_5e9.join(""));
},renderRow:function(_5ea,_5eb,_5ec,_5ed,row){
var opts=$.data(_5ea,"treegrid").options;
var cc=[];
if(_5ec&&opts.rownumbers){
cc.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\">0</div></td>");
}
for(var i=0;i<_5eb.length;i++){
var _5ee=_5eb[i];
var col=$(_5ea).datagrid("getColumnOption",_5ee);
if(col){
var _5ef=col.styler?(col.styler(row[_5ee],row)||""):"";
var _5f0=col.hidden?"style=\"display:none;"+_5ef+"\"":(_5ef?"style=\""+_5ef+"\"":"");
cc.push("<td field=\""+_5ee+"\" "+_5f0+">");
var _5f0="width:"+(col.boxWidth)+"px;";
_5f0+="text-align:"+(col.align||"left")+";";
_5f0+=opts.nowrap==false?"white-space:normal;":"";
cc.push("<div style=\""+_5f0+"\" ");
if(col.checkbox){
cc.push("class=\"datagrid-cell-check ");
}else{
cc.push("class=\"datagrid-cell ");
...
var val=null;
if(col.formatter){
val=col.formatter(row[_5ee],row);
}else{
val=row[_5ee]||"&nbsp;";
}
if(_5ee==opts.treeField){
for(var j=0;j<_5ed;j++){
...
return cc.join("");
},refreshRow:function(_5f1,id){
var row=$(_5f1).treegrid("find",id);
var opts=$.data(_5f1,"treegrid").options;
var body=$(_5f1).datagrid("getPanel").find("div.datagrid-body");
var _5f2=opts.rowStyler?opts.rowStyler.call(_5f1,row):"";
var _5f3=_5f2?"style=\""+_5f2+"\"":"";
var tr=body.find("tr[node-id="+id+"]");
tr.attr("style",_5f3);
tr.children("td").each(function(){
var cell=$(this).find("div.datagrid-cell");
var _5f4=$(this).attr("field");
var col=$(_5f1).datagrid("getColumnOption",_5f4);
if(col){
var _5f5=col.styler?(col.styler(row[_5f4],row)||""):"";
var _5f6=col.hidden?"style=\"display:none;"+_5f5+"\"":(_5f5?"style=\""+_5f5+"\"":"");
$(this).attr("style",_5f6);
var val=null;
if(col.formatter){
val=col.formatter(row[_5f4],row);
}else{
val=row[_5f4]||"&nbsp;";
}
if(_5f4==opts.treeField){
...
$(_5f1).treegrid("fixRowHeight",id);
},onBeforeRender:function(_5f7,_5f8,data){
var opts=$.data(_5f7,"treegrid").options;
if(data.length==undefined){
if(data.footer){
$.data(_5f7,"treegrid").footer=data.footer;
}
data=this.transfer(_5f7,_5f8,data.rows);
}else{
...
row._parentId=_5fb;
if(row.children&&row.children.length){
_5f9(row.children,row[opts.idField]);
}
}
};
_5f9(data,_5f8);
}
var node=find(_5f7,_5f8);
if(node){
if(node.children){
...
$.data(_5f7,"treegrid").data=$.data(_5f7,"treegrid").data.concat(data);
}
this.treeNodes=data;
this.treeLevel=$(_5f7).treegrid("getLevel",_5f8);
},transfer:function(_5fc,_5fd,data){
...
$.fn.treegrid.defaults=$.extend({},$.fn.datagrid.defaults,{treeField:null,animate:false,singleSelect:true,view:_5d8,editConfig:{getTr:function(_5ff,id){
return $(_5ff).datagrid("getPanel").find("div.datagrid-body tr[node-id="+id+"]");
},getRow:function(_600,id){
return $(_600).treegrid("find",id);
}},onBeforeLoad:function(row,_601){
...
},onAfterEdit:function(row,_602){
},onCancelEdit:function(row){
}});
})(jQuery);
(function($){
function _603(_604,_605){
var opts=$.data(_604,"combo").options;
var _606=$.data(_604,"combo").combo;
var _607=$.data(_604,"combo").panel;
if(_605){
opts.width=_605;
}
_606.appendTo("body");
if(isNaN(opts.width)){
opts.width=_606.find("input.combo-text").outerWidth();
}
var _608=0;
if(opts.hasDownArrow){
_608=_606.find(".combo-arrow").outerWidth();
}
var _605=opts.width-_608;
if($.boxModel==true){
_605-=_606.outerWidth()-_606.width();
}
_606.find("input.combo-text").width(_605);
_607.panel("resize",{width:(opts.panelWidth?opts.panelWidth:_606.outerWidth()),height:opts.panelHeight});
_606.insertAfter(_604);
};
function _609(_60a){
var opts=$.data(_60a,"combo").options;
var _60b=$.data(_60a,"combo").combo;
if(opts.hasDownArrow){
_60b.find(".combo-arrow").show();
}else{
_60b.find(".combo-arrow").hide();
}
};
function init(_60c){
$(_60c).addClass("combo-f").hide();
var span=$("<span class=\"combo\"></span>").insertAfter(_60c);
var _60d=$("<input type=\"text\" class=\"combo-text\">").appendTo(span);
$("<span><span class=\"combo-arrow\"></span></span>").appendTo(span);
$("<input type=\"hidden\" class=\"combo-value\">").appendTo(span);
var _60e=$("<div class=\"combo-panel\"></div>").appendTo("body");
_60e.panel({doSize:false,closed:true,style:{position:"absolute",zIndex:10},onOpen:function(){
$(this).panel("resize");
}});
var name=$(_60c).attr("name");
if(name){
span.find("input.combo-value").attr("name",name);
$(_60c).removeAttr("name").attr("comboName",name);
}
_60d.attr("autocomplete","off");
return {combo:span,panel:_60e};
};
function _60f(_610){
var _611=$.data(_610,"combo").combo.find("input.combo-text");
_611.validatebox("destroy");
$.data(_610,"combo").panel.panel("destroy");
$.data(_610,"combo").combo.remove();
$(_610).remove();
};
function _612(_613){
var opts=$.data(_613,"combo").options;
var _614=$.data(_613,"combo").combo;
var _615=$.data(_613,"combo").panel;
var _616=_614.find(".combo-text");
var _617=_614.find(".combo-arrow");
...
_615.bind("mousedown.combo",function(e){
return false;
});
_616.bind("mousedown.combo",function(e){
e.stopPropagation();
}).bind("keydown.combo",function(e){
switch(e.keyCode){
case 38:
opts.keyHandler.up.call(_613);
break;
case 40:
opts.keyHandler.down.call(_613);
break;
case 13:
e.preventDefault();
opts.keyHandler.enter.call(_613);
return false;
case 9:
case 27:
_61d(_613);
...
setTimeout(function(){
var q=_616.val();
if($.data(_613,"combo").previousValue!=q){
$.data(_613,"combo").previousValue=q;
_618(_613);
opts.keyHandler.query.call(_613,_616.val());
_620(_613,true);
}
},10);
}
...
_617.bind("click.combo",function(){
_616.focus();
_618(_613);
...
function _618(_619){
var opts=$.data(_619,"combo").options;
var _61a=$.data(_619,"combo").combo;
var _61b=$.data(_619,"combo").panel;
if($.fn.window){
_61b.panel("panel").css("z-index",$.fn.window.defaults.zIndex++);
}
_61b.panel("move",{left:_61a.offset().left,top:_61c()});
_61b.panel("open");
opts.onShowPanel.call(_619);
(function(){
if(_61b.is(":visible")){
_61b.panel("move",{left:_61a.offset().left,top:_61c()});
setTimeout(arguments.callee,200);
...
function _61c(){
var top=_61a.offset().top+_61a.outerHeight();
if(top+_61b.outerHeight()>$(window).height()+$(document).scrollTop()){
top=_61a.offset().top-_61b.outerHeight();
}
if(top<$(document).scrollTop()){
top=_61a.offset().top+_61a.outerHeight();
}
return top;
};
};
...
var _61f=$.data(_61e,"combo").panel;
_61f.panel("close");
opts.onHidePanel.call(_61e);
};
function _620(_621,doit){
var opts=$.data(_621,"combo").options;
var _622=$.data(_621,"combo").combo.find("input.combo-text");
_622.validatebox(opts);
if(doit){
_622.validatebox("validate");
_622.trigger("mouseleave");
}
};
function _623(_624,_625){
var opts=$.data(_624,"combo").options;
var _626=$.data(_624,"combo").combo;
if(_625){
opts.disabled=true;
$(_624).attr("disabled",true);
_626.find(".combo-value").attr("disabled",true);
_626.find(".combo-text").attr("disabled",true);
}else{
opts.disabled=false;
$(_624).removeAttr("disabled");
_626.find(".combo-value").removeAttr("disabled");
_626.find(".combo-text").removeAttr("disabled");
}
};
function _627(_628){
...
if(opts.multiple){
_629.find("input.combo-value").remove();
}else{
_629.find("input.combo-value").val("");
}
_629.find("input.combo-text").val("");
};
function _62a(_62b){
var _62c=$.data(_62b,"combo").combo;
return _62c.find("input.combo-text").val();
};
function _62d(_62e,text){
var _62f=$.data(_62e,"combo").combo;
_62f.find("input.combo-text").val(text);
_620(_62e,true);
$.data(_62e,"combo").previousValue=text;
};
function _630(_631){
var _632=[];
var _633=$.data(_631,"combo").combo;
_633.find("input.combo-value").each(function(){
_632.push($(this).val());
});
return _632;
};
function _634(_635,_636){
var opts=$.data(_635,"combo").options;
var _637=_630(_635);
var _638=$.data(_635,"combo").combo;
_638.find("input.combo-value").remove();
var name=$(_635).attr("comboName");
for(var i=0;i<_636.length;i++){
var _639=$("<input type=\"hidden\" class=\"combo-value\">").appendTo(_638);
if(name){
_639.attr("name",name);
}
_639.val(_636[i]);
...
if(aa.length!=_636.length||_636.length!=_637.length){
if(opts.multiple){
opts.onChange.call(_635,_636,_637);
}else{
opts.onChange.call(_635,_636[0],_637[0]);
}
}
};
function _63a(_63b){
...
function _640(_641){
var opts=$.data(_641,"combo").options;
...
_634(_641,opts.value);
}else{
_63d(_641,opts.value);
}
}else{
_634(_641,[]);
}
...
$.fn.combo=function(_642,_643){
if(typeof _642=="string"){
return $.fn.combo.methods[_642](this,_643);
}
_642=_642||{};
return this.each(function(){
var _644=$.data(this,"combo");
if(_644){
$.extend(_644.options,_642);
}else{
var r=init(this);
_644=$.data(this,"combo",{options:$.extend({},$.fn.combo.defaults,$.fn.combo.parseOptions(this),_642),combo:r.combo,panel:r.panel,previousValue:null});
$(this).removeAttr("disabled");
}
$("input.combo-text",_644.combo).attr("readonly",!_644.options.editable);
_609(this);
_623(this,_644.options.disabled);
_603(this);
_612(this);
_620(this);
_640(this);
...
var _646=$.data(jq[0],"combo").combo.find("input.combo-text");
return _646.validatebox("isValid");
},clear:function(jq){
return jq.each(function(){
_627(this);
});
...
},onChange:function(_64a,_64b){
}});
})(jQuery);
(function($){
function _64c(_64d,_64e){
var _64f=$(_64d).combo("panel");
var item=_64f.find("div.combobox-item[value="+_64e+"]");
if(item.length){
if(item.position().top<=0){
var h=_64f.scrollTop()+item.position().top;
_64f.scrollTop(h);
}else{
if(item.position().top+item.outerHeight()>_64f.height()){
var h=_64f.scrollTop()+item.position().top+item.outerHeight()-_64f.height();
_64f.scrollTop(h);
}
}
}
...
var _653=$(_651).combo("getValues");
var item=_652.find("div.combobox-item[value="+_653.pop()+"]");
if(item.length){
...
item=_652.find("div.combobox-item:visible:last");
}
var _654=item.attr("value");
_655(_651,[_654]);
_64c(_651,_654);
};
function _656(_657){
var _658=$(_657).combo("panel");
var _659=$(_657).combo("getValues");
var item=_658.find("div.combobox-item[value="+_659.pop()+"]");
if(item.length){
...
item=_658.find("div.combobox-item:visible:first");
}
var _65a=item.attr("value");
_655(_657,[_65a]);
_64c(_657,_65a);
};
function _65b(_65c,_65d){
var opts=$.data(_65c,"combobox").options;
var data=$.data(_65c,"combobox").data;
if(opts.multiple){
var _65e=$(_65c).combo("getValues");
...
for(var i=0;i<data.length;i++){
if(data[i][opts.valueField]==_65d){
opts.onSelect.call(_65c,data[i]);
return;
}
}
};
...
opts.onUnselect.call(_660,data[i]);
return;
}
}
};
function _655(_663,_664,_665){
var opts=$.data(_663,"combobox").options;
var data=$.data(_663,"combobox").data;
var _666=$(_663).combo("panel");
_666.find("div.combobox-item-selected").removeClass("combobox-item-selected");
var vv=[],ss=[];
...
vv.push(v);
ss.push(s);
_666.find("div.combobox-item[value="+v+"]").addClass("combobox-item-selected");
}
$(_663).combo("setValues",vv);
if(!_665){
$(_663).combo("setText",ss.join(opts.separator));
}
};
function _667(_668){
var opts=$.data(_668,"combobox").options;
var data=[];
$(">option",_668).each(function(){
var item={};
...
function _669(_66a,data,_66b){
var opts=$.data(_66a,"combobox").options;
var _66c=$(_66a).combo("panel");
$.data(_66a,"combobox").data=data;
var _66d=$(_66a).combobox("getValues");
_66c.empty();
for(var i=0;i<data.length;i++){
var v=data[i][opts.valueField];
var s=data[i][opts.textField];
var item=$("<div class=\"combobox-item\"></div>").appendTo(_66c);
item.attr("value",v);
if(opts.formatter){
item.html(opts.formatter.call(_66a,data[i]));
}else{
item.html(s);
}
if(data[i]["selected"]){
...
if(_66d.length){
_655(_66a,[_66d[_66d.length-1]],_66b);
}else{
_655(_66a,[],_66b);
}
}
opts.onLoadSuccess.call(_66a,data);
$(".combobox-item",_66c).hover(function(){
...
_65f(_66a,item.attr("value"));
}else{
_65b(_66a,item.attr("value"));
}
}else{
_65b(_66a,item.attr("value"));
$(_66a).combo("hidePanel");
}
});
};
function _66e(_66f,url,_670,_671){
...
_670=_670||{};
$.ajax({url:opts.url,dataType:"json",data:_670,success:function(data){
_669(_66f,data,_671);
},error:function(){
opts.onLoadError.apply(this,arguments);
}});
};
function _672(_673,q){
...
if(opts.mode=="remote"){
_66e(_673,null,{q:q},true);
}else{
var _674=$(_673).combo("panel");
_674.find("div.combobox-item").hide();
var data=$.data(_673,"combobox").data;
for(var i=0;i<data.length;i++){
if(opts.filter.call(_673,q,data[i])){
var v=data[i][opts.valueField];
var s=data[i][opts.textField];
var item=_674.find("div.combobox-item[value="+v+"]");
item.show();
if(s==q){
_655(_673,[v],true);
...
$(_676).addClass("combobox-f");
$(_676).combo($.extend({},opts,{onShowPanel:function(){
$(_676).combo("panel").find("div.combobox-item").show();
_64c(_676,$(_676).combobox("getValue"));
opts.onShowPanel.call(_676);
}}));
};
$.fn.combobox=function(_677,_678){
if(typeof _677=="string"){
var _679=$.fn.combobox.methods[_677];
if(_679){
return _679(this,_678);
}else{
return this.combo(_677,_678);
}
}
_677=_677||{};
return this.each(function(){
var _67a=$.data(this,"combobox");
if(_67a){
$.extend(_67a.options,_677);
_675(this);
}else{
_67a=$.data(this,"combobox",{options:$.extend({},$.fn.combobox.defaults,$.fn.combobox.parseOptions(this),_677)});
_675(this);
_669(this,_667(this));
}
if(_67a.options.data){
_669(this,_67a.options.data);
}
_66e(this);
});
};
...
return jq.each(function(){
$(this).combo("clear");
var _67d=$(this).combo("panel");
_67d.find("div.combobox-item-selected").removeClass("combobox-item-selected");
});
},loadData:function(jq,data){
return jq.each(function(){
_669(this,data);
...
},select:function(jq,_67e){
return jq.each(function(){
_65b(this,_67e);
});
},unselect:function(jq,_67f){
return jq.each(function(){
_65f(this,_67f);
});
}};
$.fn.combobox.parseOptions=function(_680){
var t=$(_680);
return $.extend({},$.fn.combo.parseOptions(_680),{valueField:t.attr("valueField"),textField:t.attr("textField"),mode:t.attr("mode"),url:t.attr("url")});
};
...
var _681=$(this).combobox("getValues");
$(this).combobox("setValues",_681);
...
},onSelect:function(_682){
},onUnselect:function(_683){
}});
})(jQuery);
(function($){
function _684(_685){
var opts=$.data(_685,"combotree").options;
var tree=$.data(_685,"combotree").tree;
$(_685).addClass("combotree-f");
$(_685).combo(opts);
var _686=$(_685).combo("panel");
if(!tree){
tree=$("<ul></ul>").appendTo(_686);
$.data(_685,"combotree").tree=tree;
}
tree.tree($.extend({},opts,{checkbox:opts.multiple,onLoadSuccess:function(node,data){
var _687=$(_685).combotree("getValues");
if(opts.multiple){
var _688=tree.tree("getChecked");
...
$(_685).combotree("setValues",_687);
opts.onLoadSuccess.call(this,node,data);
},onClick:function(node){
_68a(_685);
$(_685).combo("hidePanel");
opts.onClick.call(this,node);
},onCheck:function(node,_689){
_68a(_685);
opts.onCheck.call(this,node,_689);
}}));
};
function _68a(_68b){
...
var opts=$.data(_68e,"combotree").options;
var tree=$.data(_68e,"combotree").tree;
...
$(_68e).combo("setValues",vv).combo("setText",ss.join(opts.separator));
};
$.fn.combotree=function(_690,_691){
if(typeof _690=="string"){
var _692=$.fn.combotree.methods[_690];
if(_692){
return _692(this,_691);
}else{
return this.combo(_690,_691);
}
}
_690=_690||{};
return this.each(function(){
var _693=$.data(this,"combotree");
if(_693){
$.extend(_693.options,_690);
}else{
$.data(this,"combotree",{options:$.extend({},$.fn.combotree.defaults,$.fn.combotree.parseOptions(this),_690)});
}
_684(this);
});
};
...
},setValues:function(jq,_694){
return jq.each(function(){
_68d(this,_694);
});
},setValue:function(jq,_695){
return jq.each(function(){
_68d(this,[_695]);
});
},clear:function(jq){
...
$.fn.combotree.parseOptions=function(_696){
return $.extend({},$.fn.combo.parseOptions(_696),$.fn.tree.parseOptions(_696));
};
$.fn.combotree.defaults=$.extend({},$.fn.combo.defaults,$.fn.tree.defaults,{editable:false});
})(jQuery);
(function($){
function _697(_698){
var opts=$.data(_698,"combogrid").options;
var grid=$.data(_698,"combogrid").grid;
$(_698).addClass("combogrid-f");
$(_698).combo(opts);
var _699=$(_698).combo("panel");
if(!grid){
grid=$("<table></table>").appendTo(_699);
$.data(_698,"combogrid").grid=grid;
}
grid.datagrid($.extend({},opts,{border:false,fit:true,singleSelect:(!opts.multiple),onLoadSuccess:function(data){
var _69a=$.data(_698,"combogrid").remainText;
var _69b=$(_698).combo("getValues");
_6a7(_698,_69b,_69a);
$.data(_698,"combogrid").remainText=false;
opts.onLoadSuccess.apply(this,arguments);
},onClickRow:_69c,onSelect:function(_69d,row){
_69e();
opts.onSelect.call(this,_69d,row);
},onUnselect:function(_69f,row){
_69e();
opts.onUnselect.call(this,_69f,row);
},onSelectAll:function(rows){
_69e();
...
function _69c(_6a0,row){
$.data(_698,"combogrid").remainText=false;
_69e();
if(!opts.multiple){
$(_698).combo("hidePanel");
}
opts.onClickRow.call(this,_6a0,row);
};
function _69e(){
var _6a1=$.data(_698,"combogrid").remainText;
...
if(!opts.multiple){
$(_698).combo("setValues",(vv.length?vv:[""]));
}else{
$(_698).combo("setValues",vv);
}
if(!_6a1){
$(_698).combo("setText",ss.join(opts.separator));
}
};
};
function _6a2(_6a3,step){
var opts=$.data(_6a3,"combogrid").options;
var grid=$.data(_6a3,"combogrid").grid;
var _6a4=grid.datagrid("getRows").length;
$.data(_6a3,"combogrid").remainText=false;
var _6a5;
var _6a6=grid.datagrid("getSelections");
if(_6a6.length){
_6a5=grid.datagrid("getRowIndex",_6a6[_6a6.length-1][opts.idField]);
_6a5+=step;
if(_6a5<0){
_6a5=0;
}
...
grid.datagrid("selectRow",_6a5);
}
};
function _6a7(_6a8,_6a9,_6aa){
var opts=$.data(_6a8,"combogrid").options;
var grid=$.data(_6a8,"combogrid").grid;
var rows=grid.datagrid("getRows");
var ss=[];
for(var i=0;i<_6a9.length;i++){
var _6ab=grid.datagrid("getRowIndex",_6a9[i]);
if(_6ab>=0){
grid.datagrid("selectRow",_6ab);
ss.push(rows[_6ab][opts.textField]);
}else{
ss.push(_6a9[i]);
}
}
$(_6a8).combo("setValues",_6a9);
if(!_6aa){
$(_6a8).combo("setText",ss.join(opts.separator));
}
};
function _6ac(_6ad,q){
var opts=$.data(_6ad,"combogrid").options;
var grid=$.data(_6ad,"combogrid").grid;
$.data(_6ad,"combogrid").remainText=true;
if(opts.multiple&&!q){
_6a7(_6ad,[],true);
}else{
_6a7(_6ad,[q],true);
...
var rows=grid.datagrid("getRows");
for(var i=0;i<rows.length;i++){
if(opts.filter.call(_6ad,q,rows[i])){
grid.datagrid("clearSelections");
...
$.fn.combogrid=function(_6ae,_6af){
if(typeof _6ae=="string"){
var _6b0=$.fn.combogrid.methods[_6ae];
if(_6b0){
return _6b0(this,_6af);
}else{
return $.fn.combo.methods[_6ae](this,_6af);
}
}
_6ae=_6ae||{};
return this.each(function(){
var _6b1=$.data(this,"combogrid");
if(_6b1){
$.extend(_6b1.options,_6ae);
}else{
_6b1=$.data(this,"combogrid",{options:$.extend({},$.fn.combogrid.defaults,$.fn.combogrid.parseOptions(this),_6ae)});
}
_697(this);
});
};
...
},setValues:function(jq,_6b2){
return jq.each(function(){
_6a7(this,_6b2);
});
},setValue:function(jq,_6b3){
return jq.each(function(){
_6a7(this,[_6b3]);
});
},clear:function(jq){
...
$.fn.combogrid.parseOptions=function(_6b4){
var t=$(_6b4);
return $.extend({},$.fn.combo.parseOptions(_6b4),$.fn.datagrid.parseOptions(_6b4),{idField:(t.attr("idField")||undefined),textField:(t.attr("textField")||undefined),mode:t.attr("mode")});
};
...
(function($){
function _6b5(_6b6){
var _6b7=$.data(_6b6,"datebox");
var opts=_6b7.options;
$(_6b6).addClass("datebox-f");
$(_6b6).combo($.extend({},opts,{onShowPanel:function(){
_6b7.calendar.calendar("resize");
opts.onShowPanel.call(_6b6);
}}));
$(_6b6).combo("textbox").parent().addClass("datebox");
if(!_6b7.calendar){
_6b8();
}
function _6b8(){
var _6b9=$(_6b6).combo("panel");
_6b7.calendar=$("<div></div>").appendTo(_6b9).wrap("<div class=\"datebox-calendar-inner\"></div>");
_6b7.calendar.calendar({fit:true,border:false,onSelect:function(date){
var _6ba=opts.formatter(date);
_6be(_6b6,_6ba);
$(_6b6).combo("hidePanel");
opts.onSelect.call(_6b6,date);
}});
_6be(_6b6,opts.value);
var _6bb=$("<div class=\"datebox-button\"></div>").appendTo(_6b9);
$("<a href=\"javascript:void(0)\" class=\"datebox-current\"></a>").html(opts.currentText).appendTo(_6bb);
$("<a href=\"javascript:void(0)\" class=\"datebox-close\"></a>").html(opts.closeText).appendTo(_6bb);
_6bb.find(".datebox-current,.datebox-close").hover(function(){
$(this).addClass("datebox-button-hover");
},function(){
$(this).removeClass("datebox-button-hover");
});
_6bb.find(".datebox-current").click(function(){
_6b7.calendar.calendar({year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date()});
});
_6bb.find(".datebox-close").click(function(){
$(_6b6).combo("hidePanel");
});
};
};
function _6bc(_6bd,q){
_6be(_6bd,q);
};
function _6bf(_6c0){
var opts=$.data(_6c0,"datebox").options;
var c=$.data(_6c0,"datebox").calendar;
var _6c1=opts.formatter(c.calendar("options").current);
_6be(_6c0,_6c1);
$(_6c0).combo("hidePanel");
};
function _6be(_6c2,_6c3){
var _6c4=$.data(_6c2,"datebox");
var opts=_6c4.options;
$(_6c2).combo("setValue",_6c3).combo("setText",_6c3);
_6c4.calendar.calendar("moveTo",opts.parser(_6c3));
};
$.fn.datebox=function(_6c5,_6c6){
if(typeof _6c5=="string"){
var _6c7=$.fn.datebox.methods[_6c5];
if(_6c7){
return _6c7(this,_6c6);
}else{
return this.combo(_6c5,_6c6);
}
}
_6c5=_6c5||{};
return this.each(function(){
var _6c8=$.data(this,"datebox");
if(_6c8){
$.extend(_6c8.options,_6c5);
}else{
$.data(this,"datebox",{options:$.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_6c5)});
}
_6b5(this);
});
};
...
$.fn.datebox.parseOptions=function(_6ca){
var t=$(_6ca);
return $.extend({},$.fn.combo.parseOptions(_6ca),{});
};
...
(function($){
function _6cb(_6cc){
var _6cd=$.data(_6cc,"datetimebox");
var opts=_6cd.options;
$(_6cc).datebox($.extend({},opts,{onShowPanel:function(){
var _6ce=$(_6cc).datetimebox("getValue");
_6d6(_6cc,_6ce,true);
opts.onShowPanel.call(_6cc);
}}));
$(_6cc).removeClass("datebox-f").addClass("datetimebox-f");
$(_6cc).datebox("calendar").calendar({onSelect:function(date){
opts.onSelect.call(_6cc,date);
}});
var _6cf=$(_6cc).datebox("panel");
if(!_6cd.spinner){
var p=$("<div style=\"padding:2px\"><input style=\"width:80px\"></div>").insertAfter(_6cf.children("div.datebox-calendar-inner"));
_6cd.spinner=p.children("input");
_6cd.spinner.timespinner({showSeconds:true}).bind("mousedown",function(e){
e.stopPropagation();
});
_6d6(_6cc,opts.value);
var _6d0=_6cf.children("div.datebox-button");
var ok=$("<a href=\"javascript:void(0)\" class=\"datebox-ok\"></a>").html(opts.okText).appendTo(_6d0);
ok.hover(function(){
$(this).addClass("datebox-button-hover");
},function(){
$(this).removeClass("datebox-button-hover");
...
function _6d2(_6d3){
var c=$(_6d3).datetimebox("calendar");
var t=$(_6d3).datetimebox("spinner");
var date=c.calendar("options").current;
return new Date(date.getFullYear(),date.getMonth(),date.getDate(),t.timespinner("getHours"),t.timespinner("getMinutes"),t.timespinner("getSeconds"));
};
function _6d4(_6d5,q){
_6d6(_6d5,q,true);
};
function _6d1(_6d7){
var opts=$.data(_6d7,"datetimebox").options;
var date=_6d2(_6d7);
_6d6(_6d7,opts.formatter(date));
$(_6d7).combo("hidePanel");
};
function _6d6(_6d8,_6d9,_6da){
var opts=$.data(_6d8,"datetimebox").options;
$(_6d8).combo("setValue",_6d9);
if(!_6da){
if(_6d9){
var date=opts.parser(_6d9);
$(_6d8).combo("setValue",opts.formatter(date));
$(_6d8).combo("setText",opts.formatter(date));
}else{
$(_6d8).combo("setText",_6d9);
}
}
var date=opts.parser(_6d9);
$(_6d8).datetimebox("calendar").calendar("moveTo",opts.parser(_6d9));
$(_6d8).datetimebox("spinner").timespinner("setValue",_6db(date));
function _6db(date){
function _6dc(_6dd){
return (_6dd<10?"0":"")+_6dd;
};
var tt=[_6dc(date.getHours()),_6dc(date.getMinutes())];
if(opts.showSeconds){
tt.push(_6dc(date.getSeconds()));
}
return tt.join($(_6d8).datetimebox("spinner").timespinner("options").separator);
};
};
$.fn.datetimebox=function(_6de,_6df){
if(typeof _6de=="string"){
var _6e0=$.fn.datetimebox.methods[_6de];
if(_6e0){
return _6e0(this,_6df);
}else{
return this.datebox(_6de,_6df);
}
}
_6de=_6de||{};
return this.each(function(){
var _6e1=$.data(this,"datetimebox");
if(_6e1){
$.extend(_6e1.options,_6de);
}else{
$.data(this,"datetimebox",{options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_6de)});
}
_6cb(this);
});
};
...
$.fn.datetimebox.parseOptions=function(_6e3){
var t=$(_6e3);
return $.extend({},$.fn.datebox.parseOptions(_6e3),{});
};
...
return $.fn.datebox.defaults.formatter(date)+" "+_6e4(h)+":"+_6e4(M)+":"+_6e4(s);
},parser:function(s){
if($.trim(s)==""){
return new Date();
}
...
var _6e6=parseInt(tt[1],10);
var _6e7=parseInt(tt[2],10);
return new Date(d.getFullYear(),d.getMonth(),d.getDate(),hour,_6e6,_6e7);
}});
})(jQuery);
