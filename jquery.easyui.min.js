...
var _14a=_149.find(">div.panel-header");
var _14b=_149.find(">div.panel-body");
if(_148){
if(_148.width){
...
_149.css(opts.style);
_149.addClass(opts.cls);
_14a.addClass(opts.headerCls);
_14b.addClass(opts.bodyCls);
if(!isNaN(opts.width)){
if($.boxModel==true){
...
var t=$(_1ad);
return $.extend({},$.fn.panel.parseOptions(_1ad),{draggable:(t.attr("draggable")!=undefined?(t.attr("draggable")==true||t.attr("draggable")=="true"):undefined),resizable:(t.attr("resizable")?t.attr("resizable")=="true":undefined),shadow:(t.attr("shadow")?t.attr("shadow")=="true":undefined),modal:(t.attr("modal")?t.attr("modal")=="true":undefined)});
};
...
$.fn.tabs.defaults={width:"auto",height:"auto",plain:false,fit:false,border:true,scrollIncrement:100,scrollDuration:400,onLoad:function(_264){
...
var _4c8=jq.datagrid("getPager").pagination("options");
return $.extend(_4c6,{width:_4c7.width,height:_4c7.height,closed:_4c7.closed,collapsed:_4c7.collapsed,minimized:_4c7.minimized,maximized:_4c7.maximized,pageNumber:_4c8.pageNumber,pageSize:_4c8.pageSize});
},getPanel:function(jq){
return $.data(jq[0],"datagrid").panel;
},getPager:function(jq){
return $.data(jq[0],"datagrid").panel.find("div.datagrid-pager");
},getColumnFields:function(jq,_4c9){
return _39a(jq[0],_4c9);
},getColumnOption:function(jq,_4ca){
return _3c4(jq[0],_4ca);
...
return _42f(jq[0],_4d3);
},getEditor:function(jq,_4d4){
return _434(jq[0],_4d4);
...
for(var i=0;i<rows.length;i++){
if(i%2&&opts.striped){
_4e4.push("<tr datagrid-row-index=\""+i+"\" class=\"datagrid-row-alt\">");
}else{
_4e4.push("<tr datagrid-row-index=\""+i+"\">");
}
...
$(_4e1).html(_4e4.join(""));
},renderRow:function(_4e5,_4e6,_4e7,_4e8,_4e9){
var opts=$.data(_4e5,"datagrid").options;
var cc=[];
if(_4e7&&opts.rownumbers){
var _4ea=_4e8+1;
if(opts.pagination){
_4ea+=(opts.pageNumber-1)*opts.pageSize;
}
cc.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\">"+_4ea+"</div></td>");
}
for(var i=0;i<_4e6.length;i++){
var _4eb=_4e6[i];
var col=$(_4e5).datagrid("getColumnOption",_4eb);
if(col){
var _4ec="width:"+(col.boxWidth)+"px;";
_4ec+="text-align:"+(col.align||"left")+";";
_4ec+=opts.nowrap==false?"white-space:normal;":"";
if(col.hidden){
cc.push("<td field=\""+_4eb+"\" style=\"display:none;\">");
}else{
cc.push("<td field=\""+_4eb+"\">");
}
cc.push("<div style=\""+_4ec+"\" ");
if(col.checkbox){
...
if(col.formatter){
cc.push(col.formatter(_4e9[_4eb],_4e9,_4e8));
}else{
cc.push(_4e9[_4eb]);
}
}
...
return cc.join("");
},refreshRow:function(_4ed,_4ee){
var _4ef=$(_4ed).datagrid("getPanel");
var rows=$(_4ed).datagrid("getRows");
_4ef.find("div.datagrid-body tr[datagrid-row-index="+_4ee+"] td").each(function(){
var cell=$(this).find("div.datagrid-cell");
var _4f0=$(this).attr("field");
var col=$(_4ed).datagrid("getColumnOption",_4f0);
if(col){
if(col.formatter){
cell.html(col.formatter(rows[_4ee][_4f0],rows[_4ee],_4ee));
}else{
cell.html(rows[_4ee][_4f0]);
}
}
});
$(_4ed).datagrid("fixRowHeight",_4ee);
},onBeforeRender:function(_4f1,rows){
},onAfterRender:function(_4f2){
}};
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{frozenColumns:null,columns:null,fitColumns:false,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,loadMsg:"Processing, please wait ...",rownumbers:false,singleSelect:false,pagination:false,pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",remoteSort:true,editors:_47e,view:_4df,onBeforeLoad:function(_4f3){
},onLoadSuccess:function(){
},onLoadError:function(){
},onClickRow:function(_4f4,_4f5){
},onDblClickRow:function(_4f6,_4f7){
},onSortColumn:function(sort,_4f8){
},onResizeColumn:function(_4f9,_4fa){
},onSelect:function(_4fb,_4fc){
},onUnselect:function(_4fd,_4fe){
},onSelectAll:function(rows){
},onUnselectAll:function(rows){
},onBeforeEdit:function(_4ff,_500){
},onAfterEdit:function(_501,_502,_503){
},onCancelEdit:function(_504,_505){
},onHeaderContextMenu:function(e,_506){
},onRowContextMenu:function(e,_507,_508){
}});
})(jQuery);
(function($){
function _509(_50a){
var opts=$.data(_50a,"treegrid").options;
$(_50a).datagrid($.extend({},opts,{url:null,onLoadSuccess:function(){
},onResizeColumn:function(_50b,_50c){
_50d(_50a);
opts.onResizeColumn.call(_50a,_50b,_50c);
}}));
};
function _50d(_50e,_50f){
var opts=$.data(_50e,"datagrid").options;
var _510=$.data(_50e,"datagrid").panel;
var view=_510.children("div.datagrid-view");
...
if(_50f){
_513(_50f);
_512.find("tr[node-id="+_50f+"]").next("tr.treegrid-tr-tree").find("tr[node-id]").each(function(){
_513($(this).attr("node-id"));
});
}else{
_512.find("tr[node-id]").each(function(){
_513($(this).attr("node-id"));
});
}
}
if(opts.height=="auto"){
var _514=_512.find("div.datagrid-body table").height()+18;
_511.find("div.datagrid-body").height(_514);
_512.find("div.datagrid-body").height(_514);
view.height(_512.height());
}
function _513(_515){
var tr1=_511.find("tr[node-id="+_515+"]");
var tr2=_512.find("tr[node-id="+_515+"]");
tr1.css("height",null);
tr2.css("height",null);
var _516=Math.max(tr1.height(),tr2.height());
tr1.css("height",_516);
tr2.css("height",_516);
};
};
...
$(_518).datagrid("getPanel").find("div.datagrid-view1 div.datagrid-body div.datagrid-cell-rownumber").each(function(i){
$(this).html(i+1);
});
};
function _519(_51a){
var opts=$.data(_51a,"treegrid").options;
var _51b=$(_51a).datagrid("getPanel");
var body=_51b.find("div.datagrid-body");
...
opts.onClickRow.call(_51a,find(_51a,id));
return false;
}).bind("dblclick.treegrid",function(){
var id=$(this).attr("node-id");
opts.onDblClickRow.call(_51a,find(_51a,id));
return false;
}).bind("contextmenu.treegrid",function(e){
var id=$(this).attr("node-id");
opts.onContextMenu.call(_51a,e,find(_51a,id));
});
...
var _51c=_51b.find("div.datagrid-header");
_51c.find("input[type=checkbox]").unbind().bind("click.treegrid",function(){
if(opts.singleSelect){
return false;
}
if($(this).attr("checked")){
...
var view=$(_520).datagrid("getPanel").children("div.datagrid-view");
var _522=view.children("div.datagrid-view1");
var _523=view.children("div.datagrid-view2");
var tr1=_522.children("div.datagrid-body").find("tr[node-id="+_521+"]");
var tr2=_523.children("div.datagrid-body").find("tr[node-id="+_521+"]");
var _524=tr1.next("tr.treegrid-tr-tree");
var _525=tr2.next("tr.treegrid-tr-tree");
var div1=_524.children("td").find("div");
var div2=_525.children("td").find("div");
var td1=tr1.find("td[field="+opts.treeField+"]");
var td2=tr2.find("td[field="+opts.treeField+"]");
var _526=td1.find("span.tree-indent,span.tree-hit").length+td2.find("span.tree-indent,span.tree-hit").length;
return [div1,div2,_526];
};
...
var _52c=$(_528).datagrid("getColumnFields",true).length+(opts.rownumbers?1:0);
var _52d=$(_528).datagrid("getColumnFields",false).length;
_52e(tr1,_52c);
_52e(tr2,_52d);
function _52e(tr,_52f){
$("<tr class=\"treegrid-tr-tree\">"+"<td style=\"border:0px\" colspan=\""+_52f+"\">"+"<div></div>"+"</td>"+"</tr>").insertAfter(tr);
};
};
function _530(_531,_532,data,_533){
var opts=$.data(_531,"treegrid").options;
var wrap=$.data(_531,"datagrid").panel;
var view=wrap.children("div.datagrid-view");
var _534=view.children("div.datagrid-view1");
var _535=view.children("div.datagrid-view2");
var _536=$(_531).datagrid("getColumnFields",true);
var _537=$(_531).datagrid("getColumnFields",false);
_538(data,_532);
var node=find(_531,_532);
if(node){
if(node.children){
...
var _539=_51f(_531,_532);
var cc1=_539[0];
var cc2=_539[1];
var _53a=_539[2];
}else{
$.data(_531,"treegrid").data=$.data(_531,"treegrid").data.concat(data);
var cc1=_534.children("div.datagrid-body").children("div.datagrid-body-inner");
var cc2=_535.children("div.datagrid-body");
var _53a=0;
}
if(!_533){
$.data(_531,"treegrid").data=data;
cc1.empty();
cc2.empty();
}
var _53b=_53c(data,_53a);
cc1.html(cc1.html()+_53b[0].join(""));
cc2.html(cc2.html()+_53b[1].join(""));
opts.onLoadSuccess.call(_531,node,data);
_50d(_531);
_517(_531);
_53d();
_519(_531);
function _538(_53e,_53f){
for(var i=0;i<_53e.length;i++){
var row=_53e[i];
row._parentId=_53f;
if(row.children&&row.children.length){
_538(row.children,row[opts.idField]);
}
}
};
function _53c(_540,_541){
var _542=["<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
...
_544[0]=_544[0].concat(_545(row,_536,_541,opts.rownumbers));
_544[1]=_544[1].concat(_545(row,_537,_541));
if(row.children&&row.children.length){
var tt=_53c(row.children,_541+1);
var v=row.state=="closed"?"none":"block";
_544[0].push("<tr class=\"treegrid-tr-tree\"><td style=\"border:0px\" colspan="+(_536.length+(opts.rownumbers?1:0))+"><div style=\"display:"+v+"\">");
_544[0]=_544[0].concat(tt[0]);
_544[0].push("</div></td></tr>");
_544[1].push("<tr class=\"treegrid-tr-tree\"><td style=\"border:0px\" colspan="+_537.length+"><div style=\"display:"+v+"\">");
_544[1]=_544[1].concat(tt[1]);
_544[1].push("</div></td></tr>");
}
}
_544[0].push("</tbody></table>");
_544[1].push("</tbody></table>");
return _544;
};
function _545(row,_546,_547,_548){
var _549=["<tr node-id="+row[opts.idField]+">"];
if(_548){
_549.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\">0</div></td>");
}
for(var i=0;i<_546.length;i++){
var _54a=_546[i];
var col=$(_531).datagrid("getColumnOption",_54a);
if(col){
var _54b="width:"+(col.width)+"px;";
_54b+="text-align:"+(col.align||"left")+";";
_54b+=opts.nowrap==false?"white-space:normal;":"";
_549.push("<td field=\""+_54a+"\">");
_549.push("<div style=\""+_54b+"\" ");
if(col.checkbox){
_549.push("class=\"datagrid-cell-check ");
}else{
_549.push("class=\"datagrid-cell ");
}
_549.push("\">");
if(col.checkbox){
if(row.checked){
_549.push("<input type=\"checkbox\" checked=\"checked\"/>");
}else{
_549.push("<input type=\"checkbox\"/>");
}
}
var val=null;
if(col.formatter){
val=col.formatter(row[_54a],row);
}else{
val=row[_54a]||"&nbsp;";
}
if(_54a==opts.treeField){
for(var j=0;j<_547;j++){
_549.push("<span class=\"tree-indent\"></span>");
}
if(row.state=="closed"){
_549.push("<span class=\"tree-hit tree-collapsed\"></span>");
_549.push("<span class=\"tree-icon tree-folder "+(row.iconCls?row.iconCls:"")+"\"></span>");
}else{
if(row.children&&row.children.length){
_549.push("<span class=\"tree-hit tree-expanded\"></span>");
_549.push("<span class=\"tree-icon tree-folder tree-folder-open "+(row.iconCls?row.iconCls:"")+"\"></span>");
}else{
_549.push("<span class=\"tree-indent\"></span>");
_549.push("<span class=\"tree-icon tree-file "+(row.iconCls?row.iconCls:"")+"\"></span>");
}
}
_549.push("<span class=\"tree-title\">"+val+"</span>");
}else{
_549.push(val);
}
_549.push("</div>");
...
function _53d(){
var _54c=view.find("div.datagrid-header");
var body=view.find("div.datagrid-body");
var _54d=_54c.find("div.datagrid-header-check");
if(_54d.length){
var ck=body.find("div.datagrid-cell-check");
if($.boxModel){
ck.width(_54d.width());
ck.height(_54d.height());
}else{
ck.width(_54d.outerWidth());
ck.height(_54d.outerHeight());
}
}
};
};
function _54e(_54f,_550,_551,_552,_553){
var opts=$.data(_54f,"treegrid").options;
var body=$(_54f).datagrid("getPanel").find("div.datagrid-body");
if(_551){
opts.queryParams=_551;
}
var _554=$.extend({},opts.queryParams);
var row=find(_54f,_550);
if(opts.onBeforeLoad.call(_54f,row,_554)==false){
return;
}
if(!opts.url){
return;
}
var _555=body.find("tr[node-id="+_550+"] span.tree-folder");
_555.addClass("tree-loading");
$.ajax({type:opts.method,url:opts.url,data:_554,dataType:"json",success:function(data){
_555.removeClass("tree-loading");
_530(_54f,_550,data,_552);
if(_553){
_553();
}
},error:function(){
_555.removeClass("tree-loading");
opts.onLoadError.apply(_54f,arguments);
if(_553){
_553();
}
}});
...
function _558(_559){
return $.data(_559,"treegrid").data;
};
function _55a(_55b,_55c){
var row=find(_55b,_55c);
if(row._parentId){
return find(_55b,row._parentId);
}else{
return null;
}
};
function _55d(_55e,_55f){
var opts=$.data(_55e,"treegrid").options;
var body=$(_55e).datagrid("getPanel").find("div.datagrid-view2 div.datagrid-body");
var _560=[];
if(_55f){
_561(_55f);
}else{
...
_560.push(_562[i]);
_561(_562[i][opts.idField]);
}
}
function _561(_563){
var _564=find(_55e,_563);
if(_564&&_564.children){
for(var i=0,len=_564.children.length;i<len;i++){
var _565=_564.children[i];
_560.push(_565);
_561(_565[opts.idField]);
}
}
};
return _560;
...
_56a.find("div.datagrid-view2 div.datagrid-body tr.datagrid-row-selected").each(function(){
var id=$(this).attr("node-id");
rows.push(find(_569,id));
});
return rows;
};
function find(_56b,_56c){
var opts=$.data(_56b,"treegrid").options;
var data=$.data(_56b,"treegrid").data;
var cc=[data];
while(cc.length){
var c=cc.shift();
for(var i=0;i<c.length;i++){
var node=c[i];
if(node[opts.idField]==_56c){
return node;
}else{
if(node["children"]){
...
var tr=body.find("tr[node-id="+_56f+"]");
tr.addClass("datagrid-row-selected");
...
function _51d(_573){
var tr=$(_573).datagrid("getPanel").find("div.datagrid-body tr[node-id]");
tr.addClass("datagrid-row-selected");
tr.find("div.datagrid-cell-check input[type=checkbox]").attr("checked",true);
};
function _51e(_574){
...
if(opts.onBeforeCollapse.call(_576,row)==false){
return;
}
hit.removeClass("tree-expanded tree-expanded-hover").addClass("tree-collapsed");
hit.next().removeClass("tree-folder-open");
...
if(opts.onBeforeExpand.call(_579,row)==false){
return;
}
hit.removeClass("tree-collapsed tree-collapsed-hover").addClass("tree-expanded");
hit.next().addClass("tree-folder-open");
var _57b=tr.next("tr.treegrid-tr-tree");
if(_57b.length){
var cc=_57b.children("td").children("div");
_57c(cc);
}else{
_527(_579,row[opts.idField]);
var _57b=tr.next("tr.treegrid-tr-tree");
var cc=_57b.children("td").children("div");
cc.hide();
_54e(_579,row[opts.idField],{id:row[opts.idField]},true,function(){
_57c(cc);
});
}
function _57c(cc){
...
var opts=$.data(_58c,"treegrid").options;
if(_58d.parent){
var body=$(_58c).datagrid("getPanel").find("div.datagrid-body");
var tr=body.find("tr[node-id="+_58d.parent+"]");
if(tr.next("tr.treegrid-tr-tree").length==0){
_527(_58c,_58d.parent);
}
var cell=tr.children("td[field="+opts.treeField+"]").children("div.datagrid-cell");
var _58e=cell.children("span.tree-icon");
if(_58e.hasClass("tree-file")){
_58e.removeClass("tree-file").addClass("tree-folder");
var hit=$("<span class=\"tree-hit tree-expanded\"></span>").insertBefore(_58e);
if(hit.prev().length){
hit.prev().remove();
}
}
}
_530(_58c,_58d.parent,_58d.data,true);
};
...
var _592=del(_591);
if(_592){
if(_592.children.length==0){
tr=body.find("tr[node-id="+_592[opts.treeField]+"]");
var cell=tr.children("td[field="+opts.treeField+"]").children("div.datagrid-cell");
...
function del(id){
var cc;
var _593=_55a(_590,_591);
if(_593){
cc=_593.children;
}else{
cc=$(_590).treegrid("getData");
}
for(var i=0;i<cc.length;i++){
...
tr.children("td").each(function(){
var cell=$(this).find("div.datagrid-cell");
var _597=$(this).attr("field");
var col=$(_595).datagrid("getColumnOption",_597);
if(col){
var val=null;
if(col.formatter){
val=col.formatter(row[_597],row);
}else{
val=row[_597]||"&nbsp;";
}
if(_597==opts.treeField){
...
$.fn.treegrid=function(_598,_599){
if(typeof _598=="string"){
return $.fn.treegrid.methods[_598](this,_599);
}
_598=_598||{};
return this.each(function(){
var _59a=$.data(this,"treegrid");
if(_59a){
$.extend(_59a.options,_598);
}else{
$.data(this,"treegrid",{options:$.extend({},$.fn.treegrid.defaults,$.fn.treegrid.parseOptions(this),_598),data:[]});
}
_509(this);
_54e(this);
});
...
$.fn.treegrid.parseOptions=function(_59d){
var t=$(_59d);
return $.extend({},$.fn.datagrid.parseOptions(_59d),{treeField:t.attr("treeField"),animate:(t.attr("animate")?t.attr("animate")=="true":undefined)});
};
$.fn.treegrid.defaults=$.extend({},$.fn.datagrid.defaults,{treeField:null,animate:false,singleSelect:true,onBeforeLoad:function(row,_59e){
...
var opts=$.data(_5a0,"combo").options;
var _5a2=$.data(_5a0,"combo").combo;
var _5a3=$.data(_5a0,"combo").panel;
if(_5a1){
opts.width=_5a1;
}
_5a2.appendTo("body");
if(isNaN(opts.width)){
opts.width=_5a2.find("input.combo-text").outerWidth();
}
var _5a4=_5a2.find(".combo-arrow").outerWidth();
var _5a1=opts.width-_5a4;
if($.boxModel==true){
_5a1-=_5a2.outerWidth()-_5a2.width();
}
_5a2.find("input.combo-text").width(_5a1);
_5a3.panel("resize",{width:(opts.panelWidth?opts.panelWidth:_5a2.outerWidth()),height:opts.panelHeight});
_5a2.insertAfter(_5a0);
};
function init(_5a5){
$(_5a5).addClass("combo-f").hide();
var span=$("<span class=\"combo\"></span>").insertAfter(_5a5);
var _5a6=$("<input type=\"text\" class=\"combo-text\">").appendTo(span);
$("<span><span class=\"combo-arrow\"></span></span>").appendTo(span);
$("<input type=\"hidden\" class=\"combo-value\">").appendTo(span);
var _5a7=$("<div class=\"combo-panel\"></div>").appendTo("body");
_5a7.panel({doSize:false,closed:true,style:{position:"absolute"},onOpen:function(){
$(this).panel("resize");
}});
var name=$(_5a5).attr("name");
if(name){
span.find("input.combo-value").attr("name",name);
$(_5a5).removeAttr("name").attr("comboName",name);
}
_5a6.attr("autocomplete","off");
return {combo:span,panel:_5a7};
};
function _5a8(_5a9){
var _5aa=$.data(_5a9,"combo").combo.find("input.combo-text");
_5aa.validatebox("destroy");
$.data(_5a9,"combo").panel.panel("destroy");
$.data(_5a9,"combo").combo.remove();
$(_5a9).remove();
};
function _5ab(_5ac){
var opts=$.data(_5ac,"combo").options;
var _5ad=$.data(_5ac,"combo").combo;
var _5ae=$.data(_5ac,"combo").panel;
var _5af=_5ad.find(".combo-text");
var _5b0=_5ad.find(".combo-arrow");
...
_5ae.bind("mousedown.combo",function(e){
return false;
});
...
switch(e.keyCode){
case 38:
opts.keyHandler.up.call(_5ac);
break;
case 40:
opts.keyHandler.down.call(_5ac);
break;
case 13:
e.preventDefault();
opts.keyHandler.enter.call(_5ac);
return false;
case 9:
case 27:
_5b6(_5ac);
...
setTimeout(function(){
var q=_5af.val();
if($.data(_5ac,"combo").previousValue!=q){
$.data(_5ac,"combo").previousValue=q;
_5b1(_5ac);
opts.keyHandler.query.call(_5ac,_5af.val());
_5b9(_5ac,true);
}
},10);
}
...
_5b0.bind("click.combo",function(){
_5af.focus();
_5b1(_5ac);
...
function _5b1(_5b2){
var opts=$.data(_5b2,"combo").options;
var _5b3=$.data(_5b2,"combo").combo;
var _5b4=$.data(_5b2,"combo").panel;
if($.fn.window){
_5b4.panel("panel").css("z-index",$.fn.window.defaults.zIndex++);
}
_5b4.panel("move",{left:_5b3.offset().left,top:_5b5()});
_5b4.panel("open");
opts.onShowPanel.call(_5b2);
(function(){
if(_5b4.is(":visible")){
_5b4.panel("move",{left:_5b3.offset().left,top:_5b5()});
setTimeout(arguments.callee,200);
...
function _5b5(){
var top=_5b3.offset().top+_5b3.outerHeight();
if(top+_5b4.outerHeight()>$(window).height()+$(document).scrollTop()){
top=_5b3.offset().top-_5b4.outerHeight();
}
if(top<$(document).scrollTop()){
top=_5b3.offset().top+_5b3.outerHeight();
}
return top;
};
};
...
var _5b8=$.data(_5b7,"combo").panel;
_5b8.panel("close");
opts.onHidePanel.call(_5b7);
};
function _5b9(_5ba,doit){
var opts=$.data(_5ba,"combo").options;
var _5bb=$.data(_5ba,"combo").combo.find("input.combo-text");
_5bb.validatebox(opts);
if(doit){
_5bb.validatebox("validate");
_5bb.trigger("mouseleave");
}
};
...
if(_5be){
opts.disabled=true;
$(_5bd).attr("disabled",true);
_5bf.find(".combo-value").attr("disabled",true);
_5bf.find(".combo-text").attr("disabled",true);
}else{
opts.disabled=false;
$(_5bd).removeAttr("disabled");
_5bf.find(".combo-value").removeAttr("disabled");
_5bf.find(".combo-text").removeAttr("disabled");
}
};
function _5c0(_5c1){
var opts=$.data(_5c1,"combo").options;
var _5c2=$.data(_5c1,"combo").combo;
if(opts.multiple){
_5c2.find("input.combo-value").remove();
}else{
_5c2.find("input.combo-value").val("");
}
_5c2.find("input.combo-text").val("");
};
function _5c3(_5c4){
var _5c5=$.data(_5c4,"combo").combo;
return _5c5.find("input.combo-text").val();
};
function _5c6(_5c7,text){
var _5c8=$.data(_5c7,"combo").combo;
_5c8.find("input.combo-text").val(text);
_5b9(_5c7,true);
$.data(_5c7,"combo").previousValue=text;
};
function _5c9(_5ca){
var _5cb=[];
var _5cc=$.data(_5ca,"combo").combo;
_5cc.find("input.combo-value").each(function(){
_5cb.push($(this).val());
});
return _5cb;
};
...
var _5d0=_5c9(_5ce);
var _5d1=$.data(_5ce,"combo").combo;
_5d1.find("input.combo-value").remove();
var name=$(_5ce).attr("comboName");
for(var i=0;i<_5cf.length;i++){
var _5d2=$("<input type=\"hidden\" class=\"combo-value\">").appendTo(_5d1);
if(name){
_5d2.attr("name",name);
}
_5d2.val(_5cf[i]);
...
if(aa.length!=_5cf.length||_5cf.length!=_5d0.length){
if(opts.multiple){
opts.onChange.call(_5ce,_5cf,_5d0);
}else{
opts.onChange.call(_5ce,_5cf[0],_5d0[0]);
}
}
};
function _5d3(_5d4){
...
_5cd(_5da,opts.value);
}else{
_5d6(_5da,opts.value);
}
}else{
_5cd(_5da,[]);
}
...
$.fn.combo=function(_5db,_5dc){
if(typeof _5db=="string"){
return $.fn.combo.methods[_5db](this,_5dc);
}
_5db=_5db||{};
return this.each(function(){
var _5dd=$.data(this,"combo");
if(_5dd){
$.extend(_5dd.options,_5db);
}else{
var r=init(this);
_5dd=$.data(this,"combo",{options:$.extend({},$.fn.combo.defaults,$.fn.combo.parseOptions(this),_5db),combo:r.combo,panel:r.panel,previousValue:null});
$(this).removeAttr("disabled");
}
$("input.combo-text",_5dd.combo).attr("readonly",!_5dd.options.editable);
_5bc(this,_5dd.options.disabled);
_59f(this);
_5ab(this);
_5b9(this);
_5d9(this);
...
var _5df=$.data(jq[0],"combo").combo.find("input.combo-text");
return _5df.validatebox("isValid");
},clear:function(jq){
return jq.each(function(){
_5c0(this);
});
...
return _5c9(jq[0]);
},setValues:function(jq,_5e0){
return jq.each(function(){
_5cd(this,_5e0);
});
},getValue:function(jq){
return _5d3(jq[0]);
},setValue:function(jq,_5e1){
return jq.each(function(){
_5d6(this,_5e1);
});
}};
$.fn.combo.parseOptions=function(_5e2){
var t=$(_5e2);
return $.extend({},$.fn.validatebox.parseOptions(_5e2),{width:(parseInt(_5e2.style.width)||undefined),panelWidth:(parseInt(t.attr("panelWidth"))||undefined),panelHeight:(t.attr("panelHeight")=="auto"?"auto":parseInt(t.attr("panelHeight"))||undefined),separator:(t.attr("separator")||undefined),multiple:(t.attr("multiple")?(t.attr("multiple")=="true"||t.attr("multiple")==true):undefined),editable:(t.attr("editable")?t.attr("editable")=="true":undefined),disabled:(t.attr("disabled")?true:undefined),value:(t.val()||undefined)});
};
...
var _5e8=$(_5e6).combo("panel");
var item=_5e8.find("div.combobox-item[value="+_5e7+"]");
if(item.length){
if(item.position().top<=0){
var h=_5e8.scrollTop()+item.position().top;
_5e8.scrollTop(h);
}else{
if(item.position().top+item.outerHeight()>_5e8.height()){
var h=_5e8.scrollTop()+item.position().top+item.outerHeight()-_5e8.height();
_5e8.scrollTop(h);
}
}
}
...
function _5e9(_5ea){
var _5eb=$(_5ea).combo("panel");
var _5ec=$(_5ea).combo("getValues");
var item=_5eb.find("div.combobox-item[value="+_5ec.pop()+"]");
if(item.length){
...
item=_5eb.find("div.combobox-item:visible:last");
}
var _5ed=item.attr("value");
_5ee(_5ea,[_5ed]);
_5e5(_5ea,_5ed);
};
function _5ef(_5f0){
var _5f1=$(_5f0).combo("panel");
var _5f2=$(_5f0).combo("getValues");
var item=_5f1.find("div.combobox-item[value="+_5f2.pop()+"]");
if(item.length){
...
item=_5f1.find("div.combobox-item:visible:first");
}
var _5f3=item.attr("value");
_5ee(_5f0,[_5f3]);
_5e5(_5f0,_5f3);
};
function _5f4(_5f5,_5f6){
var opts=$.data(_5f5,"combobox").options;
var data=$.data(_5f5,"combobox").data;
if(opts.multiple){
...
if(data[i][opts.valueField]==_5f6){
opts.onSelect.call(_5f5,data[i]);
return;
}
}
};
function _5f8(_5f9,_5fa){
var opts=$.data(_5f9,"combobox").options;
var data=$.data(_5f9,"combobox").data;
var _5fb=$(_5f9).combo("getValues");
...
for(var i=0;i<data.length;i++){
if(data[i][opts.valueField]==_5fa){
opts.onUnselect.call(_5f9,data[i]);
return;
}
}
};
function _5ee(_5fc,_5fd,_5fe){
var opts=$.data(_5fc,"combobox").options;
var data=$.data(_5fc,"combobox").data;
var _5ff=$(_5fc).combo("panel");
_5ff.find("div.combobox-item-selected").removeClass("combobox-item-selected");
var vv=[],ss=[];
...
vv.push(v);
ss.push(s);
_5ff.find("div.combobox-item[value="+v+"]").addClass("combobox-item-selected");
}
$(_5fc).combo("setValues",vv);
if(!_5fe){
$(_5fc).combo("setText",ss.join(opts.separator));
}
};
function _600(_601){
var opts=$.data(_601,"combobox").options;
var data=[];
$(">option",_601).each(function(){
var item={};
...
function _602(_603,data,_604){
var opts=$.data(_603,"combobox").options;
var _605=$(_603).combo("panel");
$.data(_603,"combobox").data=data;
var _606=$(_603).combobox("getValues");
_605.empty();
for(var i=0;i<data.length;i++){
var v=data[i][opts.valueField];
var s=data[i][opts.textField];
var item=$("<div class=\"combobox-item\"></div>").appendTo(_605);
item.attr("value",v);
if(opts.formatter){
item.html(opts.formatter.call(_603,data[i]));
}else{
item.html(s);
}
if(data[i]["selected"]){
...
if(_606.length){
_5ee(_603,[_606[_606.length-1]],_604);
}else{
_5ee(_603,[],_604);
}
}
opts.onLoadSuccess.call(_603,data);
$(".combobox-item",_605).hover(function(){
...
_5f8(_603,item.attr("value"));
}else{
_5f4(_603,item.attr("value"));
}
}else{
_5f4(_603,item.attr("value"));
$(_603).combo("hidePanel");
}
});
};
function _607(_608,url,_609,_60a){
...
_609=_609||{};
$.ajax({url:opts.url,dataType:"json",data:_609,success:function(data){
_602(_608,data,_60a);
},error:function(){
opts.onLoadError.apply(this,arguments);
}});
};
function _60b(_60c,q){
...
if(opts.mode=="remote"){
_607(_60c,null,{q:q},true);
}else{
var _60d=$(_60c).combo("panel");
_60d.find("div.combobox-item").hide();
var data=$.data(_60c,"combobox").data;
for(var i=0;i<data.length;i++){
if(opts.filter.call(_60c,q,data[i])){
var v=data[i][opts.valueField];
var s=data[i][opts.textField];
var item=_60d.find("div.combobox-item[value="+v+"]");
item.show();
if(s==q){
_5ee(_60c,[v],true);
...
$(_60f).addClass("combobox-f");
$(_60f).combo($.extend({},opts,{onShowPanel:function(){
$(_60f).combo("panel").find("div.combobox-item").show();
_5e5(_60f,$(_60f).combobox("getValue"));
opts.onShowPanel.call(_60f);
}}));
};
$.fn.combobox=function(_610,_611){
if(typeof _610=="string"){
var _612=$.fn.combobox.methods[_610];
if(_612){
return _612(this,_611);
}else{
return this.combo(_610,_611);
}
}
_610=_610||{};
return this.each(function(){
var _613=$.data(this,"combobox");
if(_613){
$.extend(_613.options,_610);
_60e(this);
}else{
_613=$.data(this,"combobox",{options:$.extend({},$.fn.combobox.defaults,$.fn.combobox.parseOptions(this),_610)});
_60e(this);
_602(this,_600(this));
}
if(_613.options.data){
_602(this,_613.options.data);
}
_607(this);
});
};
...
},setValues:function(jq,_614){
return jq.each(function(){
_5ee(this,_614);
});
},setValue:function(jq,_615){
return jq.each(function(){
_5ee(this,[_615]);
});
},clear:function(jq){
return jq.each(function(){
$(this).combo("clear");
var _616=$(this).combo("panel");
_616.find("div.combobox-item-selected").removeClass("combobox-item-selected");
});
},loadData:function(jq,data){
return jq.each(function(){
_602(this,data);
...
},select:function(jq,_617){
return jq.each(function(){
_5f4(this,_617);
});
},unselect:function(jq,_618){
return jq.each(function(){
_5f8(this,_618);
});
}};
$.fn.combobox.parseOptions=function(_619){
var t=$(_619);
return $.extend({},$.fn.combo.parseOptions(_619),{valueField:t.attr("valueField"),textField:t.attr("textField"),mode:t.attr("mode"),url:t.attr("url")});
};
...
var _61a=$(this).combobox("getValues");
$(this).combobox("setValues",_61a);
...
},onSelect:function(_61b){
},onUnselect:function(_61c){
}});
})(jQuery);
(function($){
function _61d(_61e){
var opts=$.data(_61e,"combotree").options;
var tree=$.data(_61e,"combotree").tree;
$(_61e).addClass("combotree-f");
$(_61e).combo(opts);
var _61f=$(_61e).combo("panel");
if(!tree){
tree=$("<ul></ul>").appendTo(_61f);
$.data(_61e,"combotree").tree=tree;
}
tree.tree($.extend({},opts,{checkbox:opts.multiple,onLoadSuccess:function(node,data){
var _620=$(_61e).combotree("getValues");
if(opts.multiple){
var _621=tree.tree("getChecked");
...
$(_61e).combotree("setValues",_620);
opts.onLoadSuccess.call(this,node,data);
},onClick:function(node){
_623(_61e);
$(_61e).combo("hidePanel");
opts.onClick.call(this,node);
},onCheck:function(node,_622){
_623(_61e);
opts.onCheck.call(this,node,_622);
}}));
};
function _623(_624){
var opts=$.data(_624,"combotree").options;
var tree=$.data(_624,"combotree").tree;
var vv=[],ss=[];
if(opts.multiple){
var _625=tree.tree("getChecked");
...
$(_624).combo("setValues",vv).combo("setText",ss.join(opts.separator));
};
function _626(_627,_628){
var opts=$.data(_627,"combotree").options;
var tree=$.data(_627,"combotree").tree;
...
$(_627).combo("setValues",vv).combo("setText",ss.join(opts.separator));
};
$.fn.combotree=function(_629,_62a){
if(typeof _629=="string"){
var _62b=$.fn.combotree.methods[_629];
if(_62b){
return _62b(this,_62a);
}else{
return this.combo(_629,_62a);
}
}
_629=_629||{};
return this.each(function(){
var _62c=$.data(this,"combotree");
if(_62c){
$.extend(_62c.options,_629);
}else{
$.data(this,"combotree",{options:$.extend({},$.fn.combotree.defaults,$.fn.combotree.parseOptions(this),_629)});
}
_61d(this);
});
};
...
},setValues:function(jq,_62d){
return jq.each(function(){
_626(this,_62d);
});
},setValue:function(jq,_62e){
return jq.each(function(){
_626(this,[_62e]);
});
},clear:function(jq){
...
$.fn.combotree.parseOptions=function(_62f){
return $.extend({},$.fn.combo.parseOptions(_62f),$.fn.tree.parseOptions(_62f));
};
$.fn.combotree.defaults=$.extend({},$.fn.combo.defaults,$.fn.tree.defaults,{editable:false});
})(jQuery);
(function($){
function _630(_631){
var opts=$.data(_631,"combogrid").options;
var grid=$.data(_631,"combogrid").grid;
$(_631).addClass("combogrid-f");
$(_631).combo(opts);
var _632=$(_631).combo("panel");
if(!grid){
grid=$("<table></table>").appendTo(_632);
$.data(_631,"combogrid").grid=grid;
}
grid.datagrid($.extend({},opts,{border:false,fit:true,singleSelect:(!opts.multiple),onLoadSuccess:function(data){
var _633=$.data(_631,"combogrid").remainText;
var _634=$(_631).combo("getValues");
_640(_631,_634,_633);
$.data(_631,"combogrid").remainText=false;
opts.onLoadSuccess.apply(this,arguments);
},onClickRow:_635,onSelect:function(_636,row){
_637();
opts.onSelect.call(this,_636,row);
},onUnselect:function(_638,row){
_637();
opts.onUnselect.call(this,_638,row);
},onSelectAll:function(rows){
_637();
...
function _635(_639,row){
$.data(_631,"combogrid").remainText=false;
_637();
if(!opts.multiple){
$(_631).combo("hidePanel");
}
opts.onClickRow.call(this,_639,row);
};
function _637(){
var _63a=$.data(_631,"combogrid").remainText;
...
$(_631).combo("setValues",vv);
if(!vv.length&&!opts.multiple){
$(_631).combo("setValues",[""]);
}
if(!_63a){
$(_631).combo("setText",ss.join(opts.separator));
}
};
};
function _63b(_63c,step){
var opts=$.data(_63c,"combogrid").options;
var grid=$.data(_63c,"combogrid").grid;
var _63d=grid.datagrid("getRows").length;
$.data(_63c,"combogrid").remainText=false;
var _63e;
var _63f=grid.datagrid("getSelections");
if(_63f.length){
_63e=grid.datagrid("getRowIndex",_63f[_63f.length-1][opts.idField]);
_63e+=step;
if(_63e<0){
_63e=0;
}
...
grid.datagrid("selectRow",_63e);
}
};
function _640(_641,_642,_643){
var opts=$.data(_641,"combogrid").options;
var grid=$.data(_641,"combogrid").grid;
var rows=grid.datagrid("getRows");
var ss=[];
grid.datagrid("clearSelections");
for(var i=0;i<_642.length;i++){
var _644=grid.datagrid("getRowIndex",_642[i]);
if(_644>=0){
grid.datagrid("selectRow",_644);
ss.push(rows[_644][opts.textField]);
}else{
ss.push(_642[i]);
}
}
$(_641).combo("setValues",_642);
if(!_643){
$(_641).combo("setText",ss.join(opts.separator));
}
};
function _645(_646,q){
var opts=$.data(_646,"combogrid").options;
var grid=$.data(_646,"combogrid").grid;
$.data(_646,"combogrid").remainText=true;
if(opts.multiple&&!q){
_640(_646,[],true);
}else{
_640(_646,[q],true);
...
var rows=grid.datagrid("getRows");
for(var i=0;i<rows.length;i++){
if(opts.filter.call(_646,q,rows[i])){
grid.datagrid("clearSelections");
...
$.fn.combogrid=function(_647,_648){
if(typeof _647=="string"){
var _649=$.fn.combogrid.methods[_647];
if(_649){
return _649(this,_648);
}else{
return $.fn.combo.methods[_647](this,_648);
}
}
_647=_647||{};
return this.each(function(){
var _64a=$.data(this,"combogrid");
if(_64a){
$.extend(_64a.options,_647);
}else{
_64a=$.data(this,"combogrid",{options:$.extend({},$.fn.combogrid.defaults,$.fn.combogrid.parseOptions(this),_647)});
}
_630(this);
});
};
...
$.fn.combogrid.parseOptions=function(_64d){
var t=$(_64d);
return $.extend({},$.fn.combo.parseOptions(_64d),$.fn.datagrid.parseOptions(_64d),{idField:(t.attr("idField")||undefined),textField:(t.attr("textField")||undefined),mode:t.attr("mode")});
};
